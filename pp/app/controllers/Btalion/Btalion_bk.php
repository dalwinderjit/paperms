		...
		*/
		...
		public function pracreport(){
			...
			if(empty($ninfo[0])){
				...
				$data['weapon'] = $this->Btalion_model->fetchinfo('deposit_ammu',array('ammutype' =>'Practice','ibat_id' => $data['ninfo'] ),'weapon');
...
//==========================================================================================================================
		...
		public function issue_vehicle(){
			...
			$this->form_validation->set_rules("Dateofduty", "Date of Duty", "callback_valid_date");
...
//                        die('hi)');
		...
		public function alotedit_quater($id){
			...
			if ($this->form_validation->run()){
				$add_web = $this->Btalion_model->alotedit_quater($id,$Otheradd,$rankss,$regt,$contactno,$posd,$eono,$Otheraddm,$acct,$accts,$tq,$bbatslist,$statelist,$otherinfo,$floor); 	
...
//                        var_dump($a);
                        ...
                        $a = convertDate($a);
//                        var_dump($a);
			$data['msk'] = $this->Btalion_model->mtolist2($data['ninfo'],$a);
//var_dump($data['msk']);
  ...
  //                      die;
                        ...
                        if(count($cat_of_veh)>0){
                            $regs_ = info_fetch_countmtoallinfos2($cat_of_veh,$data['ninfo'],$a,$this->uri->segment(3));
//var_dump($regs_);
                            $ranks_= info_fetch_countmto($cat_of_veh,$data['ninfo']);
//  var_dump($ranks_);                          
                            foreach($ranks_ as $key=>$val){
                            ...
                            //var_dump($reg_no);
                            $poiis_ = fetchoneinfopollistpost_2($reg_no,$a,$data['ninfo']);
                            //var_dump($poiis_);
                            $poiis =[];
...
//                                var_dump($val);die;
		...
		public function cqtrs(){
			...
			$equipmentNameStyle = array(
                        ...
                        $colsName = ['S. No.','Type of Quater','Quater Number','Floor','Detail of Allotte','Mobile No.','Allotment Order','Allotment Date','Place of Posting'];
                        $i=0;
