				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-md-9">
							...
							<button type="button" class="btn btn-primary" onClick="selectParentDuty2()"><span class="glyphicon glyphicon-plus" style="color:white;text-decoration:none;"></span>&nbsp;&nbsp;Select Posting</button><span id="selected_posting_name"><i>&nbsp;&nbsp;&nbsp;&nbsp;No Posting is Selected</i></span><br />
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			if (isset($previous_posting) && !empty($previous_posting)) { ?>
				load_the_postings_in_posting_lists2(<?php echo $previous_posting[0]->id . ',"' . $previous_posting[0]->name . '"'; ?>);
			<?php } else { ?>
