...
<head>
  ...
  <title>Posting Management| Consolidated Deployment Statement</title>
...
.posting-list>ul>li{
			...
			.total_row{/*color: #0e0e0e;*/color:black;}
			.single_posting_total { color:#7d7b7b;color:black;}
			.total_row1{color:#525252;}
			.total_row3{color:#000000;;color:black;}
			...
			<div class="panel-body">
				<div class="row">
					<?php $attributes = array(
						...
						echo form_open_multipart("deployment-statement-consolidated", $attributes); ?>
					<div class="col-md-2"></div>	
					<div class="col-md-3" style="">
						<div class='input-group'>
							<input type='text' name="before_date" class="form-control"  id='datetimepicker1' value="<?php if(null!=$before_date){echo $before_date;}?>" placeholder="Select Date dd/mm/yyyy"/>
					...
					<?php
						echo form_dropdown('battalions[]', $battalions, set_value('battalions',(isset($_POST['battalions'])) ? $_POST['battalions'] : ''),'id="battalions" placeholder="Select Battalion(s)" title="Select Battalion" multiple class="select2"'); 
...
<div class="modal model-lg" tabindex="-1" role="dialog" id="myModal">
