			...
			<div class="panel-body">
				...
				<div class="row"> 
					 <table class="table">
						...
						<tbody>
						<?php $counter = 1; foreach($postings as $k=>$posting){ ?>
							<tr>
								<td> <?php echo $counter; ?> </td>
								<td><?php echo $posting->name; ?>	</td>
								<td><?php echo $posting->parent_name; ?>	</td>
								<td><?php echo $posting->created_date; ?>	</td>
								<td><a href="posting-edit/<?php echo $posting->id; ?>" class="glyphicon glyphicon-pencil" style="color:black;" title="Edit Posting"></a> &nbsp; <a href="posting-delete/<?php echo $posting->id; ?>" class="glyphicon glyphicon-trash" style="color:red;" title="Delete Posting"></a></td>
							</tr>
						<?php $counter++;} ?>
