		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<table style="width:100%;">
					<tbody>
						<tr>
							<td><h3>Add Sanction Strength</h3></td>
			...
			<div class="panel-body">
				...
				<?php 	/*Create HTML form*/
						$attributes = array(
						  ...
						  'autocomplete'    =>'off', 
						  'method' => 'post',
						  'action'=>'Postings/sanctionStrengthAdd',
						 
						  );
						echo form_open_multipart("sanction-strength-add", $attributes); 
						$this->form_validation->set_error_delimiters('<span class="error">', '</span>');
					?>
					<div class="col-md-6">
						<label for="rank_group_id">Select Rank</label>
						<?php 
						echo form_dropdown('rank_group_id',$ranks,set_value('rank_group_id'),'id="rank_group_id" class="select2"');
