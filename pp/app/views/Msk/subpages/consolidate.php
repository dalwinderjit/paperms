 ...
 <div class="panel panel-default" id="figure_view_consolid">
        <div class="panel-heading">
			...
			<?php /*Create HTML form*/
				...
				$types = array('sanction'=>'Sanction','holding'=>'Holding','issued'=>'Issued','total_in_store'=>'Total in Store','serviceable'=>'Serviceable','unserviceable'=>'Un-serviceable','serviceable_in_store'=>'Available/Serviceable in Store');
			?>
				<div class="col-md-12">
