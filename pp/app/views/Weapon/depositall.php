...
<?php $this->load->view('Btalion/html/headbar'); ?>
  ...
  <strong>Warning!</strong> <?php echo $this->session->flashdata('error_msg'); ?>
      ...
      <h4><strong>Bore:</strong> <?php  $wp = fetchoneinfo('issue_arm',array('issue_arm_id' => $this->uri->segment('2')));  $a = explode(',',$wp->abore); if (array_key_exists('1', $a)) {echo $a[0]; } 

	 
        $b = explode(',',$wp->ammubore); if (array_key_exists('1', $b)) {echo $b[1]; } ?> <strong>Weapon:</strong> <?php  $a = explode(',',$wp->abore); if (array_key_exists('1', $a)) { echo $a[1]; } 
        $b = explode(',',$wp->ammubore); if (array_key_exists('2', $b)) { echo $b[2]; } ?> <?php if($wp->amqunt!='') { ?> <strong>Service Ammunition:</strong> <?php echo $wp->amqunt; }?>  <?php if($wp->ammupqty!=''){ ?><strong>Practice Ammunition:</strong> <?php echo $wp->ammupqty; }?>    <strong>Magzine :</strong> <?php echo $wp->mags.$wp->magp; ?> <strong>Issued To</strong> <?php  $m = fetchoneinfo('newosi',array('man_id' => $wp->issueto)); 
        if($m !=''){echo $m->name;}
          ...
          <div class="panel panel-default">
              <div class="panel-body">
               ...
               <div class="form-group">
                 ...
                 <?php  
if($wp->atype=='Service'){
$atype = array('' => '--Select--','Weapon' => 'Weapon with Ammunition','Ammunition' => 'Ammunition only');
}else{
	$atype =array('' => '--Select--','Ammunition' => 'Ammunition and Weapon');
}
/*newarea Textfield*/
 echo form_dropdown('dtype', $atype, set_value('dtype',''),'id="dep" data-placeholder="Choose One" title="Please select at least 1 area" class="select2"'); 
...
/*newarea Textfield*/
 echo form_dropdown('atype', $atype, set_value('atype',''),'id="ammu" data-placeholder="Choose One" title="Please select at least 1 area" class="select2"'); 
...
<?php } ?>
                  ...
                  <label class="col-sm-3 control-label">Live Cartridges service</label>
                  <div class="col-sm-9">
                       <?php  
/*newarea Textfield*/
...
/*----End newarea Textfield----*/
 ?>
				...
				<div class="form-group" id="serv5" style="display:none;">
                  <label class="col-sm-3 control-label">Ammuition Quantity</label>
                  <div class="col-sm-9">
				  <input type="hidden" name="atype" value="<?php echo $wp->atype; ?>">
                 <?php  
/*newarea Textfield*/
$ammuQty = array('type' => 'text','name' => 'ammuQtys','id' => 'ammuQty','class' => 'form-control','value' => set_value('ammuQtys'), 'placeholder' => 'Enter Ammunition Quantity');
echo form_input($ammuQty);
 echo form_error('ammuQtys');
/*----End newarea Textfield----*/
 ?>
                    <label for="ammuQty" class="error"></label>
                  </div>
                </div><!-- form-group -->
                <!--*** Text field-->
<div class="form-group"  id="prac6" style="display:none;">
                  ...
                  <div class="col-sm-9">
                       <?php  
/*newarea Textfield*/
$lcarts = array('type' => 'text','name' => 'llcartp','id' => 'mq','class' => 'form-control','value' => set_value('llcartp'), 'placeholder' => 'Live Cartridges');
echo form_input($lcarts);
 echo form_error('llcartp');
/*----End newarea Textfield----*/
 ?>
...
/*newarea Textfield*/
 echo form_dropdown('cw', $cw, set_value('cw',''),'id="cw" data-placeholder="Choose One" title="Please select at least 1 area" class="select2"'); 
 echo form_error('cw');
/*----End newarea Textfield----*/
 ?>
...
foreach($ssw as $k=>$v){
 ...
 echo form_dropdown('ssw', $array, set_value('ssw',''),'id="ssw" data-placeholder="Choose One" title="Please select at least 1 area" class="select2"'); 
 echo form_error('ssw');
/*----End newarea Textfield----*/
 ?>
...
/*newarea Textfield*/
 echo form_dropdown('suw', $suw, set_value('suw',1),'id="suw" data-placeholder="Choose One" title="Please select at least 1 area" class="select2"'); 
 echo form_error('suw');
/*----End newarea Textfield----*/
 ?>
                ...
                <!--h4 id="wh" style="display: none;"--><input type="hidden" name="abc" id="clicks" checked> <!--Service Ammunition &nbsp; Use this field only if you wish to deposit Service Ammunition along with Weapon</h4-->
                ...
                <div class="form-group"  id="wep1" style="display:none;">
                  ...
                  <div class="col-sm-9">
                       <?php  
/*newarea Textfield*/
$lcarts = array('type' => 'text','name' => 'wlcarts','id' => 'wep1a','class' => 'form-control','value' => set_value('wlcarts'), 'placeholder' => 'Live Cartridges', 'disabled' => 'disabled');
echo form_input($lcarts);
 echo form_error('wlcarts');
/*----End newarea Textfield----*/
 ?>
                  ...
                  <div class="col-sm-9">
                       <?php  
/*newarea Textfield*/
$mcart = array('type' => 'text','name' => 'wmcarts','id' => 'wep1b','class' => 'form-control','value' => set_value('wmcarts'), 'placeholder' => 'Miss Cartridges', 'disabled' => 'disabled');
echo form_input($mcart);
 echo form_error('wmcarts');
/*----End newarea Textfield----*/
 ?>
     ...
     <?php  
/*newarea Textfield*/
$ecarts = array('type' => 'text','name' => 'wecarts','id' => 'wep1c','class' => 'form-control','value' => set_value('wecarts'), 'placeholder' => 'Empty cartridges', 'disabled' => 'disabled');
echo form_input($ecarts);
 echo form_error('wecarts');
/*----End newarea Textfield----*/
 ?>
                    <label for="now" class="error"></label>
                  </div>
             ...
             <div class="form-group" id="wep4" style="display:none;">
                 ...
                 <?php  
/*newarea Textfield*/
$locarts = array('type' => 'text','name' => 'wlocarts','id' => 'wep1d','class' => 'form-control','value' => set_value('wlocarts'), 'placeholder' => 'Lost cartridges', 'disabled' => 'disabled');
echo form_input($locarts);
 echo form_error('wlocarts');
/*----End newarea Textfield----*/
 ?>
                    <label for="mags" class="error"></label>
                  </div>
				...
				<div class="form-group"  id="wep" style="display:none;">
                  ...
                  <div class="col-sm-9">
                <input type="hidden" value="<?php echo $wp->mags; ?>" name="magp">
				<?php  
				
                /*newarea Textfield*/
                $mq = array('type' => 'text','name' => 'magp__','id' => 'mq','class' => 'form-control','value' => $wp->mags, 'placeholder' => 'Magazine Qty','disabled'=>'disabled');
                echo form_input($mq);
			...
			<div class="form-group" id="prac7" style="display:none;">
                 ...
                 <?php  
/*newarea Textfield*/
$ammu_qty = array('type' => 'text','name' => 'ammu_qty','id' => 'ammu_qty','class' => 'form-control','value' => set_value('ammu_qty'), 'placeholder' => 'Enter ammunition quantity');
echo form_input($ammu_qty);
 echo form_error('ammu_qty');
/*----End newarea Textfield----*/
 ?>
                  </div>
                </div>
          ...
          <div class="form-group"  id="wep5" style="display:none;">
                  <label class="col-sm-3 control-label">Ammunition Quantity</label>
                  <div class="col-sm-9">
				  <input type="hidden" name="wamqunt" value="<?php echo $wp->amqunt; ?>" >
<?php

$amqunt = array('type' => 'text','name' => 'wamqunt','id' => 'wep1e','class' => 'form-control', 'placeholder' =>'Ammunition Quantity','value' => $wp->amqunt, 'disabled' => 'disabled');
echo form_input($amqunt);
echo form_error('amqunt');
?>
                    <label for="amqunt" class="error"></label>
...
$(document).ready(function(){
	var depositType = $('#dep').val();
	var depositTypes = <?php echo json_encode($depositTypes); ?>;
	var ammunitionType = '<?php echo $wp->atype; ?>';
	if(depositType!='' && $.inArray(depositType,depositTypes)){
		if(depositType=='Ammunition'){
			$('#am').show();
			if(ammunitionType=='Practice'){
				$('#serv1').show();
				$('#serv2').show();
				$('#serv3').show();
				$('#serv4').show();
			...
			if(ammunitionType=='Service'){
				$('#serv5').show();
			}
			
			/*var ammuWeapType = $('#ammu').val();
			var ammuWeapTypes = <?php echo json_encode($ammuWeapTypes);?>;*/
		}else if(depositType=='Weapon'){
			...
			//alert('hi');
			var weapon_condition = $('#cw').val();
			var weapon_conditions = <?php echo json_encode($weapon_conditions); ?>;
			if($.inArray(weapon_condition,weapon_conditions)){
				if(weapon_condition=='Serviceable'){
					$('#Serviceable').show();
				}else if(weapon_condition=='Non-Serviceable'){
					$('#unServiceable').show();
