...
<section>
  ...
  <?php $this->load->view('Btalion/html/headbar'); ?>
          ...
          <div class="panel panel-default col-md-12">
            ...
            <div class="panel-body col-md-3">
              <div class="form-group"  id="serv1">
                ...
                <input type="submit" class="btn btn-primary" place-holder="Enter Body Number" name="moveWeaponToCA" value="Search" id="moveWeaponToCA">
    ...
    <div class="panel panel-default col-md-12">
      <table class="table">
        ...
        <tbody>
          ...
          ?>
          <tr>
            <td class="col-md-1"><?php echo $sno;?><input type="checkbox" <?php echo $checkboxStatus; ?> class="form-control has-error" name="ids[<?php echo $id;?>]" value="<?php echo $id;  ?>"></td>
            <td class="col-md-3">
              <style>
                .opt{color:#3572bd;}
              </style>
            ...
            <td class="col-md-2">
              <?php
                $rcno = array('type' => 'text','name' => "rcno[$id]",'id' => '','class' => 'form-control','value' => set_value("rcno[$id]"), 'placeholder' => 'Enter RC/Order Number');
    ...
    <p><?php echo $links; ?></p>
			<div class="panel-body col-md-3" id="div_departments">
              
                <label class="control-label">Move To</label>
                <?php 
                  /*newarea Textfield*/
                  //var_dump($body_numbers);
				  $departments = ['CENTRAL_ARMOURY'=>'CENTRAL ARMOURY','DISTRICT'=>'DISTRICT','OTHER'=>'OTHER'];
                  echo form_dropdown('departments', $departments, set_value('departments',''),'id="departments" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
                  echo form_error('departments');
                  /*----End newarea Textfield----*/
                ?>
              
            </div>
			<div class="panel-body col-md-3" style='display:none;' id="div_districts">
              
                <label class="control-label">District</label>
                <?php 
                  
                  echo form_dropdown('districts', $districts, set_value('districts',''),'id="districts" data-placeholder="Choose One" title="Please select at least 1 value" class="select2" '); 
                  echo form_error('districts');
                  /*----End newarea Textfield----*/
                ?>
              
            </div>
			<div class="panel-body col-md-3" style='display:none;' id="div_other_place">
              
                <label class="control-label">Other</label>
                <?php 
                  /*newarea Textfield*/
                  //var_dump($body_numbers);
				    $other = array('type' => 'text','name' => "other",'id' => '','class' => 'form-control','value' => set_value("other"), 'placeholder' => 'Other location');
		...
		<div class="panel-body col-md-3">
		<br>
		<input type="submit" class="btn btn-primary" name="moveWeaponToCA" id="moveWeaponToCA" value="Submit">
	  </div>
  </div>
</div><!-- contentpanel -->
...
$(document).on('change', '#dep', function() {
  if(this.value == 'BN'){
	...
	$(document).on('change', '#departments', function() {
		$('#div_districts').css('display','none');
		$('#div_other_place').css('display','none');
		if(this.value == 'DISTRICT'){
			$('#div_districts').css('display','inline');
		}else if(this.value=='OTHER'){
			$('#div_other_place').css('display','inline');
		}
