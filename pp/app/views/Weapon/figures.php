...
<section>
  ...
  <?php $this->load->view('Btalion/html/headbar'); ?>
    <div class="pageheader">
      <h4> &nbsp;&nbsp;&nbsp; Consolidate figures of Weapon (KHC Module) <span class="pull-right"> <?php  echo 'Date:'.date('d-m-Y h:i:s A');?> &nbsp; &nbsp; <?php echo 'login:'. $this->session->userdata('username'); ?></span></h4>
    </div>
				...
				<div class="panel panel-default links_">
					<div class="panel-heading">
						...
						<?php
						  ...
						  if($selectedPage == 'weapon_figures.php'){
							$styleWeaponFigures = "background-color:red;color:white;";
						  }else{
							  $styleWeaponFigures = "background-color:#9abfed;";
						  }
						  if($selectedPage == 'weapon_figures_category_wise.php'){
							$styleCategorisedWeaponFigures = "background-color:red;color:white;";
						  }else{
							  $styleCategorisedWeaponFigures = "background-color:#9abfed;";
						  }
					?>
							<a class="btn" style="<?php echo $styleAllFigures; ?>" href="<?php echo base_url().'khc-figures?page=ALL_FIGURES'?>"><b>All Figures of KHC</b></a>&nbsp;&nbsp;
							<a class="btn" style="<?php echo $styleWeaponFigures; ?>" href="<?php echo base_url().'khc-figures?page=WEAPON_FIGURES'?>"><b>Figure View of PAP, IR, CDO BNs</b></a>&nbsp;&nbsp;
							<a class="btn" style="<?php echo $styleConsolidate; ?>" href="<?php echo base_url().'khc-figures?page=CONSOLIDATE'?>"><b>Consolidate Figure of PAP, IR & CDO BNs</b></a>
							<a class="btn" style="<?php echo $styleCategorisedWeaponFigures; ?>" href="<?php echo base_url().'khc-figures-category-wise'?>"><b>Category Wise Consolidate Figure of PAP, IR & CDO BNs</b></a>
						</div>
						<br>
					</div>
				</div>
					...
					<?php 
					$this->load->view('Weapon/figures/'.$subpage);
					?>
...
window.print = function () {
    ...
    $('#all_tables>div>div>div>div>table').addClass('simple_table');
    $('#all_tables>div>div>div>div>table').removeClass('table table-fixedheader');
    oldPrintFunction();
    ...
    $('#all_tables>div>div>div>div>table').removeClass('simple_table');
    $('#all_tables>div>div>div>div>table').addClass('table table-fixedheader');
};
