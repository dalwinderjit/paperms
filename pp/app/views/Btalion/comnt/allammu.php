...
<?php $this->load->view('Btalion/html/headbar'); ?>
    <div class="pageheader">
      <h3>&nbsp; &nbsp;  KHC Module Ammunition (Practice) <?php  if($name!=''){echo $name->nick;} ?></h3>
...
/*newarea Textfield*/
 echo form_dropdown('tpi', $tpi, set_value('tpi',1),'id="tpi" data-placeholder="Select Weapon" title="Please select at least 1 area" class="select2"'); 
 echo form_error('tpi');
...
/*newarea Textfield*/
 echo form_dropdown('tpi2', $tpi2, set_value('tpi2',1),'id="tpi2" data-placeholder="Type of Ammunition Bore" title="Please select at least 1 area" class="select2"'); 
