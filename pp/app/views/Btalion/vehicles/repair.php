          ...
          <div class="panel panel-default">
              ...
              <div class="form-group">
                ...
                <div class="form-group" id="d1">
                  ...
                  <div class="col-sm-9">
<?php
$rn = array('type' => 'text','name' => 'dorepair','id' => 'lid','class' => 'form-control','value' => set_value('dorepair'));
echo form_input($rn);
...
?>
                 ...
                 <div class="form-group" id="d2">
                  ...
                  <div class="col-sm-9">
<?php
$Chasis = array('type' => 'text','name' => 'rdetails','id' => 'Chasis','class' => 'form-control','value' => set_value('rdetails'));
echo form_input($Chasis);
echo form_error('mpolo');
?>
                    
                    <?php echo form_error('rdetails'); ?>
                  </div>
                </div> 
...
?>
                ...
                <div class="form-group" id="pap" style="display: none;">
                  ...
                  <div class="col-sm-9">
<?php
$Chasis = array('type' => 'text','name' => 'pamo','id' => 'Chasis','class' => 'form-control','value' => set_value('pamo'));
echo form_input($Chasis);
              ...
              <div class="panel-footer">
                <div class="row">
                  <div class="col-sm-9 col-sm-offset-3">
                    ...
                    <input type="submit" name="btnSubmit"  class="btn btn-primary" onClick="this.disabled=true;this.value='Adding, please wait...';form.submit();"/>
...
jQuery(document).ready(function(){
  ...
  if(this.value == 'Other'){
    ...
    $('#dislist').hide();
     ...
     $(document).on('change', '#repunit', function() {
      ...
      ChangeRepairingUnit(this.value);
 });
 ...
 function ChangeRepairingUnit(value){
     console.log('hi');
     if(value == 'Private Firm'){
         $('#firm1').show();
         $('#firm2').show();
         $('#firm3').hide();
         $('#firm4').hide();
       ...
       }else if(value ==  'PAP Central Workshop'){
          $('#pap').show();
          $('#firm1').hide();
         $('#firm2').hide();
         $('#firm3').hide();
...
if(isset($submit) && $submit==true){
    ?>
        ChangeRepairingUnit($('#repunit').val());
        <?php
}
?>
</script>
