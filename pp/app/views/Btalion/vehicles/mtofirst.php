              ...
              <tbody>
                <?php  if($msk!=''){ foreach($msk as $value): ?>
                 <tr class="odd gradeX">
                    ...
                    <td><?php  $ranks = info_fetch_countmto($value->catofvechicle,$ninfo); if($ranks!=''){echo  $ranks->san;} ?> </td>
                    <td><?php $hold = info_fetch_countmtoall($value->catofvechicle,$ninfo); echo $hold; ?> </td>
                    <td><?php $inmt = info_fetch_countmtoin($value->catofvechicle,$ninfo); echo $inmt; ?></td>
                    <td> <?php echo $hold - $inmt ; ?></td>
                <?php endforeach; } ?>
              </tbody>
           </table>
