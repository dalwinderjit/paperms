...
<head>
    ...
    <title>Pol/Repair Update List</title>
  ...
  <strong>Success!</strong> <?php echo $this->session->flashdata('success_msg'); ?>
    ...
    <div class="panel panel-default">
        <div class="panel-body"> 
          ...
          <h3>Total Records: <?php echo count($vichel);?></h3>
              ...
              <tbody>
                <?php  $count = 0; if($vichel!=''){ foreach($vichel as $value): $count = $count+1; ?>
                 <tr class="odd gradeX">
                    ...
                    <td> <a href="<?php echo base_url('bt-pol-update/'.$value->mt_id); ?>" class="btn btn-primary btn-xs" target="_blank"> <i class="fa fa-edit"></i> Update</a></td>
