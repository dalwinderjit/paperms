...
/*newarea Textfield*/
 echo form_dropdown('hid', $hn, set_value('hid',$hlist->hid),'id="hid" data-placeholder="Choose One" title="Please select at least 1 value" class="select2" required'); 
 echo form_error('hid');
...
/*newarea Textfield*/
 echo form_dropdown('tpi', $tpi, set_value('tpi',$hlist->tpi),'id="tpi" data-placeholder="Choose One" title="Please select at least 1 area" class="select2" required'); 
 echo form_error('tpi');
/*----End newarea Textfield----*/
 ?>
...
/*----End newarea Textfield----*/
 ?>
                 ...
                 <input type="text" id="search-box"  placeholder="Issued To" class = "form-control" />
                    ...
                    <input type="hidden" name="hn" id="idinfo" value="<?php echo $hlist->hn;  ?>"/>
                  </div>
                </div>
                  ...
                  <div class="col-sm-9">
                 <?php 
                 $ito = array('' => '--Select--','7-PAP' => '7-PAP','9-PAP' => '9-PAP', '13-PAP' => '13-PAP','27-PAP' => '27-PAP','36-PAP' => '36-PAP','75-PAP' => '75-PAP','80-PAP' => '80-PAP','82-PAP' => '82-PAP', 'CCR' => 'CCR', 'CR-PAP' => 'CR-PAP','RTC-PAP' => 'RTC-PAP','ISTC-KPT' => 'ISTC-KPT','CTC-PTL' => 'CTC-PTL','CONTROL-ADGP' => 'CONTROL-ADGP','CSO' => 'CSO','1-CDO' => '1-CDO','2-CDO' => '2-CDO', '3-CDO' => '3-CDO', '4-CDO' => '4-CDO','5-CDO' => '5-CDO','1-IRB' => '1-IRB','2-IRB' => '2-IRB', '3-IRB' => '3-IRB', '4-IRB' => '4-IRB','5-IRB' => '5-IRB','6-IRB' => '6-IRB', '7-IRB' => '7-IRB',); 
                
                
/*newarea Textfield*/
 echo form_dropdown('ito', $ito, set_value('ito',$hlist->ito),'id="ito" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('ito');
/*----End newarea Textfield----*/
 ?>
...
/*newarea Textfield*/
 echo form_dropdown('hids', $am, set_value('hids',$hlist->hids),'id="hids" data-placeholder="Choose One" title="Please select at least 1 value" class="select2" required'); 
...
/*newarea Textfield*/
 echo form_dropdown('pd', $pd, set_value('pd',$hlist->pd),'id="pd" data-placeholder="Choose One" title="Please select at least 1 value" class="select2" required'); 
 echo form_error('pd');
/*----End newarea Textfield----*/
 ?>     <label for="pd" class="error"></label>
                 ...
                 <div class="form-group blockset">
                  ...
                  <div class="col-sm-9">
                 <?php
$ppl = array('type' => 'text','name' => 'ppl','id' => 'ppl','class' => 'form-control','placeholder' =>'Present Posting Location','required' => 'required','value' => $hlist->ppl);
echo form_input($ppl);
echo form_error('ppl');
?>     <label for="ppl" class="error"></label>
                 ...
                 <div class="form-group blockset">
                  ...
                  <div class="col-sm-9">
                 <?php
$pon = array('type' => 'text','name' => 'pon','id' => 'pon','class' => 'form-control','placeholder' =>'Posting order No','value' => $hlist->pon);
echo form_input($pon);
echo form_error('pon');
?>     <label for="pon" class="error"></label>
                 ...
                 <?php
$pod = array('type' => 'text','name' => 'pod','id' => 'pod','class' => 'form-control','placeholder' =>'Posting Order Date','value' => $hlist->pod);
echo form_input($pod);
echo form_error('pod');
