              ...
              <tbody>
                <?php  $count = 0; foreach($horse as $value): $count = $count+1; ?>
                 <tr class="odd gradeX">
                    ...
                    <td><?php $n = fetchoneinfo('horse',array('horse_id' => $value->hid)); echo $n->horse_name; ?></td>
                    <td><?php echo $value->tpi; ?>
                    <td><?php if($value->hn!=0){$m = fetchoneinfo('newosi',array('man_id' => $value->hn)); echo $m->name; }else{echo $value->ito;}?></td>
                    <td><?php echo $value->hids; ?></td>
