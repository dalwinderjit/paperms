              ...
              <tbody>
                <?php  $count = 0; foreach($horse as $value): $count = $count+1; ?>
                 <tr class="odd gradeX">
                    ...
                    <td><a href="<?php echo base_url('bt-edit-horse'); ?>/<?php echo $value->alothorse_id; ?>" class="btn btn-primary btn-xs">Edit</a></td>
                    ...
                    <td><?php echo $value->last_vc_date; ?></td>
                     <td><?php echo $value->vacc_by; ?></td>
                      <td><?php echo $value->lhcp; ?></td>
                       <td><?php echo $value->hcb; ?></td>
