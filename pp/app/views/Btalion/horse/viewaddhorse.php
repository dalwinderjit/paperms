          ...
          <div class="table-responsive">
              ...
              <thead>
                 <tr>
                    ...
                    <th>OB No.</th>
                    <th>Price in INR</th>
                    <th>Weather undergone</th>
                    <th>Health Status</th>
                    <th>Last Vaccination date</th>
                    <th>Vaccinated By</th>
                    <th>Last health checkup date</th>
                    <th>Health Checkup by</th>
              ...
              <tbody>
                <?php  $count = 0; foreach($horse as $value): $count = $count+1; ?>
                 <tr class="odd gradeX">
                    ...
                    <td><a href="<?php echo base_url('bt-edit-horse/'.$value->horse_id); ?>" class="btn btn-primary">Edit</a></td>
                    <td><?php echo $value->horse_name; ?></td>
                    <td><?php echo $value->sex; ?></td>
                    <td><?php echo $value->hoof_no; ?></td>
                    <td><?php echo $value->color; ?></td>
                    <td><?php echo $value->height; ?></td>
                    <td><?php echo $value->breed; ?></td>
                    <td><?php echo $value->atop; ?></td>
                    <td><?php echo $value->moac; ?></td>
                    <td><?php echo $value->orderno; ?></td>
                    <td><?php echo $value->price; ?></td>
                    <td><?php echo $value->wut; ?></td>
                    <td><?php echo $value->health_status; ?> &nbsp; <?php echo $value->serab; ?> <?php echo $value->nonservab; ?></td>
  
                    <td><?php echo $value->last_vc_date; ?></td>
                     <td><?php echo $value->vacc_by; ?></td>
                      <td><?php  echo $value->lhcp; $ahi = fetchoneinfodesc('horse_health',array('hid' => $value->horse_id),'horse_health_id');
                                 /* if($ahi !=''){
                                    echo $ahi->chdate;
                                  } */
                        ?></td>
                                  ...
                                  if($ah !=''){
                                     $osi = fetchoneinfo('newosi',array('man_id' => $ah->hn));
                                      if($osi !=''){
                                        ...
                                        $bn = fetchoneinfo('users',array('users_id' => $osi->bat_id));
                                        echo $bn->nick;
                                      }
