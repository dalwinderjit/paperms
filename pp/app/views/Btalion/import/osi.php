            ...
            <table>
              <thead>
                 <tr>
                    ...
                    <th>Previous BN. No.</th>
                    <th>Placement as Junior Asst. Date</th>
                    <th>Promotion as Sr. Asst. Date</th>
                    <th>Promotion as Supdt Grade-I</th>
                    <th>Promotion as Supdt Grade-II</th>
              ...
              <tbody>
                <?php  $count = 0; if($weapon!=''){ foreach($weapon as $value): $count = $count+1; ?>
                 <tr class="odd gradeX">
                    ...
                    <td><?php echo $value->feet; ?> <?php echo $value->inch; ?></td>
                     <td><?php echo $value->eduqalification; ?></td>
                     <td>
                         <?php
                         if($value->UnderGraduate != "_"){
                              echo $value->UnderGraduate;
                         }
                         if($value->Graduate != "_"){
                              echo $value->Graduate;
                         }
                         if( $value->PostGraduate != "_"){
                              echo $value->PostGraduate;
                         }
                         if( $value->Doctorate != "_"){
                              echo $value->Doctorate;
                         }
                         if( $value->Doctorateother != "_"){
                              echo $value->Doctorateother;
                         }
                         ?>
                     </td>
                     <td><?php echo $value->prebattalion; ?></td>   
                    <td><?php echo $value->modeofrec; ?></td>
                    <td><?php echo $value->eexrank.$value->eminirank.$value->emedirank.$value->ecprank.$value->eccrank; ?></td>
                    <td><?php echo $value->enlistmentcat; ?></td>
                    <td><?php echo $value->dateofinlitment; ?></td>
                    <td><?php echo $value->EnlistmentUnit; ?></td>
                    ...
                    <td><?php echo $value->prebattno; ?></td>
                     <td><?php echo $value->dateblockm1; ?></td>
                     <td><?php echo $value->dateblockm2; ?></td>
                     <td><?php echo $value->dateblockm3; ?></td>
                     <td><?php echo $value->dateblockm4; ?></td>
                    ...
                    <td><?php echo $value->NameofsRanges; ?></td>
                    <td><?php echo $value->tow; ?></td>
                    <td><?php echo $value->dateofprcatice; ?></td>
