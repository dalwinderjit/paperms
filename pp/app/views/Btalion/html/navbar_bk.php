       ...
       <?php  if($this->session->userdata('user_log')==4 ){
        ?>
                ...
                <li <?php if(base_url().'bt-update-manpower' == current_url()) { ?>class="active"  <?php  } ?>><a href="<?php echo base_url(); ?>bt-update-manpower"><i class="fa fa-angle-double-right"></i> De Induction</a></li>
               	...
               	<li <?php if(base_url().'sanction-strength' == current_url() || base_url().'sanction-strength-add' == current_url()) { ?> class="active" <?php  } ?>><a href="<?php echo base_url(); ?>sanction-strength"><i class="fa fa-angle-double-right"></i><?php if(base_url().'sanction-strength-add' == current_url()){ echo 'Add'; } ?> Add Sanction Strength</a></li> 
...
<?php if(false){ ?>
      ...
      <li><a href="<?php echo base_url(); ?>bt-osi-old"target="_blank" style="background-color:rgba(119, 0, 25, 1);"><i class="fa fa-angle-double-right"></i> OSI Consolidate Data</a></li>
        ...
        <li <?php if(base_url().'course-history' == current_url()) { ?> class="active" <?php  } ?>><a href="<?php echo base_url(); ?>course-history"><i class="fa fa-angle-double-right"></i> Course History</a></li>
        <li  <?php if(base_url().'cso' == current_url()) { ?> class="active" <?php  } ?>><a  <?php if(base_url().'cso' == current_url()) { echo 'href="#"'; }else{ echo "href=".base_url()."/cso"; } ?>><i class="fa fa-angle-double-right"></i> CSO</a></li>
          ...
          <a href="<?php echo base_url(); ?>present-strength" style=""><i class="fa fa-angle-double-right"></i>Present Strength</a></li>
