    ...
    <ul class="nav nav-pills nav-stacked nav-bracket">
      ...
      <?php if ($this->session->userdata('user_log') == 0 || $this->session->userdata('user_log') == NULL) { ?>
        ...
        <li class="nav-parent  <?php if (base_url() . 'bt-add-horse' == current_url()) { ?> nav-active active  <?php  } ?>"><a href="#"> <span>Old Data Management</span></a>
          <ul class="children" <?php if (base_url() . 'bt-add-horse' == current_url()) { ?> style="display: block;" <?php  } ?>>
            ...
            <li <?php if (base_url() . 'bt-p-ammu' == current_url()) { ?> class="active" <?php  } ?>><a href="<?php echo base_url(); ?>bt-p-ammu"><i class="fa fa-angle-double-right"></i> Practice Ammunition</a></li>
            <hr />
      ...
      <?php } else { ?>
        ...
        ?>
          <?php if ($this->session->userdata('nick') == 'Comdt 75 Bn PAP' || $this->session->userdata('nick') == '27th Bn. PAP' || $this->session->userdata('nick') == '80th Bn. PAP' || $this->session->userdata('nick') == '7th Bn. PAP' || $this->session->userdata('nick') == 'Cso.PAP' || $this->session->userdata('nick') == 'RTC.PAP' || $this->session->userdata('nick') == 'Comdt I CDO BN' || $this->session->userdata('nick') == 'Comdt 9 Bn PAP.ASR' || $this->session->userdata('nick') == 'Comdt 5-IRB.ASR' || $this->session->userdata('nick') == 'Comdt 4-IRB.KPT' || $this->session->userdata('nick') == 'Comdt ISTC.KPT' || $this->session->userdata('nick') == 'Comdt 13th Bn. PAP' || $this->session->userdata('nick') == 'Comdt 82 Bn. PAP' || $this->session->userdata('nick') == 'Comdt 3 CDO. PAP' || $this->session->userdata('nick') == 'Comdt 4 CDO. PAP' || $this->session->userdata('nick') == 'Comdt 3-IRB.LDH' || $this->session->userdata('nick') == 'Comdt 6-IRB.SGR' || $this->session->userdata('nick') == 'Comdt 2-IRB.SGR' || $this->session->userdata('nick') == 'Comdt 2 CDO BN' || $this->session->userdata('nick') == 'Comdt 36 PAP BN' || $this->session->userdata('nick') == 'Comdt 1-IRB' || $this->session->userdata('nick') == 'Comdt CTC/BHG' || $this->session->userdata('nick') == 'Comdt RTC.L/KOTHI' ||  $this->session->userdata('nick') == 'CSO Punjab Police') {  ?>
            ...
            <li class="nav-parent  <?php if (base_url() . 'bt-quaters-oldl' == current_url()) { ?> nav-active active  <?php  } ?>"><a href="#"> <span><i class="fa fa-angle-double-right"></i> Returns</span></a>
              <ul class="children" <?php if (base_url() . 'bt-quaters-oldl' == current_url() || in_array(current_url(), [base_url() . 'bt-weaponlist', base_url() . 'bt-weaponlist2'])) { ?> style="display: block;" <?php  } ?>>
                <?php if ($this->session->userdata('nick') != 'CSO Punjab Police') { ?>
            ...
            <!-- <li <?php //if(base_url().'bt-special-unit' == current_url()) { 
                      ?>class="active"  <?php  //} 
                                                                                                    ?>><a href="<?php //echo base_url(); 
                                                                                                                          ?>bt-special-unit"><i class="fa fa-angle-double-right"></i> Special Unit</a></li> -->
        ...
        ?>
          ...
          <li class="nav-parent"><a href="#"> <span><i class="fa fa-angle-double-right"></i> Weapon/Ammu/Shell deposit to Nodel Bns./Distt/Unit Permanently</span></a>
            <ul class="children">
              ...
              <li <?php if (base_url() . 'bt-nodeldepositp' == current_url()) { ?> class="active" <?php  } ?>><a href="<?php echo base_url(); ?>bt-nodeldepositp"><i class="fa fa-angle-double-right"></i> Practice Shell</a></li>
          ...
          <!-- 
                <li><a href="<?php //echo base_url('bt-weapon-update'); 
                              ?>"><i class="fa fa-angle-double-right"></i> Update Weapon</a></li>
          ...
          <li class="nav-parent <?php if (in_array(current_url(), [base_url() . 'ammunition/service-to-practice', base_url() . 'ammunition/conversion-report'])) { ?>active<?php  } ?>"><a href="<?php echo base_url(); ?>ammunition/service-to-practice"> <span><i class="fa fa-angle-double-right"></i>Ammunition Convert</span></a>
            <?php if (true) { ?>
              <ul class="children" <?php if (in_array(current_url(), [base_url() . 'ammunition/service-to-practice', base_url() . 'ammunition/conversion-report'])) { ?>style="display:block;" <?php  } ?>>
                <li <?php if (base_url() . 'ammunition/service-to-practice' == current_url()) { ?> class="active" <?php  } ?>><a href="<?php echo base_url(); ?>ammunition/service-to-practice"><i class="fa fa-angle-double-right"></i> All Types</a></li>
                <li <?php if (base_url() . 'ammunition/conversion-report' == current_url()) { ?> class="active" <?php  } ?>><a href="<?php echo base_url(); ?>ammunition/conversion-report"><i class="fa fa-angle-double-right"></i> Conversion Report</a></li>
              </ul>
            <?php } ?>
          </li>
          <li <?php if (base_url() . 'ammunition/destroy-ammunition' == current_url()) { ?>class="active" <?php  } ?>><a href="<?php echo base_url(); ?>ammunition/destroy-ammunition" target="_blank"><i class="fa fa-angle-double-right"></i><img class="new_option" src="<?php echo base_url() . 'webroot/images/photos/new.png'; ?>"> Destroy/Dispose Ammunition</a></li>


          <li class="nav-parent  <?php if (base_url() . 'bt-bkhcarms' == current_url() || base_url() . 'bt-bkhcammu' == current_url() || base_url() . 'ammunition/destroyed-ammunition-report' == current_url()) { ?> nav-active active  <?php  } ?>"><a href="#"> <span><i class="fa fa-angle-double-right"></i> Reports</span></a>
            <ul class="children" <?php if (base_url() . 'bt-bkhcarms' == current_url() || base_url() . 'ammunition/destroyed-ammunition-report' == current_url()) { ?> style="display: block;" <?php  } ?>>
              ...
              <li <?php if (base_url() . 'bt-cawep' == current_url()) { ?>class="active" <?php  } ?>><a href="<?php echo base_url(); ?>bt-cawep"><i class="fa fa-angle-double-right"></i>Weapon/Ammu. Deposit in CA/Distt/Unit</a></li>
              <li <?php if (base_url() . 'ammunition/destroyed-ammunition-report' == current_url()) { ?>class="active" <?php  } ?>><a href="<?php echo base_url(); ?>ammunition/destroyed-ammunition-report"><i class="fa fa-angle-double-right"></i>Destroyed Ammunition Report</a></li>
          ...
          <li class="nav-parent <?php if (in_array(current_url(), [base_url() . 'bt-weaponlist', base_url() . 'bt-ammulist', base_url() . 'bt-ammulistp', base_url() . 'bt-serannureport', base_url() . 'bt-pracreport', base_url() . 'bt-munitionreport'])) { ?> nav-active active  <?php  } ?>"><a href="#"> <span><i class="fa fa-angle-double-right"></i> Return</span></a>
            <ul class="children" <?php if (in_array(current_url(), [base_url() . 'bt-weaponlist', base_url() . 'bt-ammulist', base_url() . 'bt-ammulistp', base_url() . 'bt-serannureport', base_url() . 'bt-pracreport', base_url() . 'bt-munitionreport'])) { ?> style="display:block;" <?php  } ?>>
              <li <?php if (base_url() . 'bt-weaponlist' == current_url()) { ?>class="active" <?php  } ?>><a href="<?php echo base_url(); ?>bt-weaponlist" target="_blank"><i class="fa fa-angle-double-right"></i> KHC Weapon </a></li>
              <li <?php if (base_url() . 'bt-ammulist' == current_url()) { ?>class="active" <?php  } ?>><a href="<?php echo base_url(); ?>bt-ammulist" target="_blank"><i class="fa fa-angle-double-right"></i> KHC Ser Ammu </a></li>
              <li <?php if (base_url() . 'bt-ammulistp' == current_url()) { ?>class="active" <?php  } ?>><a href="<?php echo base_url(); ?>bt-ammulistp" target="_blank"><i class="fa fa-angle-double-right"></i> KHC Prt Ammu </a></li>

              <li <?php if (base_url() . 'khc-figures' == current_url()) { ?> class="active" <?php  } ?>><a href="<?php echo base_url(); ?>khc-figures"><i class="fa fa-angle-double-right"></i> Weapon Figures</a></li>


              <li><a href="<?php echo base_url(); ?>bt-serannureport" target="_blank"><i class="fa fa-angle-double-right"></i> Service Shell </a></li>
              <li><a href="<?php echo base_url(); ?>bt-pracreport" target="_blank"><i class="fa fa-angle-double-right"></i> Practice Shell </a></li>
              <li><a href="<?php echo base_url(); ?>bt-munitionreport" target="_blank"><i class="fa fa-angle-double-right"></i> Munition </a></li>


            </ul>
          </li>

          <li class="nav-parent"><a href="#" target="_blank"><span><i class="fa fa-angle-double-right"></i> Weapon Figures</span></a>


            <ul class="children" <?php if (base_url() . 'khc-figures' == current_url() || base_url() . 'khc-figures-category-wise' == current_url()) { ?> style="display: block;" <?php  } ?>>
              <li <?php if (base_url() . 'khc-figures' == current_url()) { ?> class="active" <?php  } ?>><a href="<?php echo base_url(); ?>khc-figures"><i class="fa fa-angle-double-right"></i> Simple</a></li>
              <li <?php if (base_url() . 'khc-figures-category-wise' == current_url()) { ?> class="active" <?php  } ?>><a href="<?php echo base_url(); ?>khc-figures-category-wise"><i class="fa fa-angle-double-right"></i> Category Wise</a></li>
            </ul>
          </li>
        ...
        ?>
          <li <?php if (base_url() . 'bt-add-manpower' == current_url()) { ?>class="active" <?php  } ?>><a href="<?php echo base_url(); ?>bt-add-manpower"><i class="fa fa-angle-double-right"></i> Add New Record</a></li>
          ...
          <li <?php if (base_url() . 'sanction-strength' == current_url() || base_url() . 'sanction-strength-add' == current_url()) { ?> class="active" <?php  } ?>><a href="<?php echo base_url(); ?>sanction-strength"><i class="fa fa-angle-double-right"></i><?php if (base_url() . 'sanction-strength-add' == current_url()) {
                                                                                                                                                                                                                                                              echo 'Add';
                                                                                                                                                                                                                                                            } ?> Add Sanction Strength</a></li>
          ...
          <li class="nav-parent<?php if (base_url() . 'deployment-statement' == current_url() || base_url() . 'deployment-history' == current_url() || (base_url() . 'sanction-strength' == current_url()) || (base_url() . 'sanction-strength-add' == current_url())) { ?> nav-active active  <?php  } ?>"><a href="#"> <span><i class="fa fa-angle-double-right"></i>Deployment</span></a>
            <ul class="children" <?php if (base_url() . 'deployment-statement' == current_url() || base_url() . 'deployment-statement-consolidated' == current_url() || base_url() . 'deployment-history' == current_url() || stripos(current_url(), base_url() . 'deployment-history-employee') > -1 || (base_url() . 'sanction-strength' == current_url()) || (base_url() . 'sanction-strength-add' == current_url())) { ?> style="display: block;" <?php  } ?>>
          ...
          <li class="nav-parent  <?php if (base_url() . 'bt-osi-old' == current_url()) { ?> nav-active active <?php  } ?>"><a href="#"> <span><i class="fa fa-angle-double-right"></i> Reports</span></a>
            <ul class="children" <?php if (base_url() . 'bt-osi-old' == current_url()) { ?> style="display: block;" <?php  } ?>>
              ...
              <?php if ($this->session->userdata('userid') == 74 || $this->session->userdata('userid') == 60 || $this->session->userdata('userid') == 93  || $this->session->userdata('userid') == 213) {  ?>
                ...
                <?php } else { ?>
                  <li <?php if (base_url() . 'bt-osi-old' == current_url()) { ?>class="active" <?php  } ?>><a href="<?php echo base_url(); ?>bt-osi-old"><i class="fa fa-angle-double-right"></i> <span>Permanent Man Power</span></a></li>
                <?php } ?>
                ...
                <!-- <li <?php //if(base_url().'bt-postingfilter' == current_url()) { 
                          ?>class="active"  <?php // } 
                                                                                                        ?>><a href="<?php //echo base_url(); 
                                                                                                                                ?>bt-postingfilter"><i class="fa fa-angle-double-right"></i> <span>Posting View</span></a></li> -->
          ...
          <li <?php if (base_url() . 'course-history' == current_url()) { ?> class="active" <?php  } ?>><a href="<?php echo base_url(); ?>course-history"><i class="fa fa-angle-double-right"></i> Course History</a></li>
        ...
        ?>
          ...
          <li><a href="<?php echo base_url(); ?>equipment-figures" target="_blank" <?php if (base_url() . 'equipment-figures' == current_url()) {
                                                                                      $color = "rgba(54,91,133,1)";
                                                                                    } else {
                                                                                      $color = "rgba(119, 0, 255, 1)";
                                                                                    } ?>style="background-color:<?php echo $color; ?>;"><i class="fa fa-angle-double-right"></i> MSK Figure View </a> </li>
        ...
        ?>
          ...
          <li <?php if (base_url() . 'mt-figure-view' == current_url()) { ?>class="active" <?php  } ?>><a href="<?php echo base_url(); ?>mt-figure-view"><i class="fa fa-angle-double-right"></i><img class="new_option" src="<?php echo base_url() . 'webroot/images/photos/new.png'; ?>"> MT Figure View</a></li>
          ...
          <li class="nav-parent  <?php if (base_url() . 'bt-vichele-old' == current_url()) { ?> nav-active active  <?php  } ?>"><a href="#"> <span><i class="fa fa-angle-double-right"></i> Reports</span></a>
            <ul class="children" <?php if (base_url() . 'bt-vichele-old' == current_url()) { ?> style="display: block;" <?php  } ?>>
              <li <?php if (base_url() . 'bt-vichele-old' == current_url()) { ?>class="active" <?php  } ?>><a href="<?php echo base_url(); ?>bt-vichele-old"><i class="fa fa-angle-double-right"></i> <span>Vehicles Report </span></a></li>
          ...
          <li class="nav-parent  <?php if (base_url() . 'bt-horse-old' == current_url()) { ?> nav-active active  <?php  } ?>"><a href="#"> <span><i class="fa fa-angle-double-right"></i> Return</span></a>
            <ul class="children" <?php if (base_url() . 'bt-horse-old' == current_url() || base_url() . 'mt-figure-view' == current_url()) { ?> style="display: block;" <?php  } ?>>
              <li <?php if (base_url() . 'bt-mtoreporttwos' == current_url()) { ?>class="active" <?php  } ?>><a href="<?php echo base_url(); ?>bt-mtoreporttwos" target="_blank"><i class="fa fa-angle-double-right"></i> <span>MTO Return</span></a></li>
              <li <?php if (base_url() . 'bt-mtoreporttwospolselect' == current_url()) { ?>class="active" <?php  } ?>><a href="<?php echo base_url(); ?>bt-mtoreporttwospolselect" target="_blank"><i class="fa fa-angle-double-right"></i> <span>POL Return</span></a></li>
              <li <?php if (base_url() . 'mt-figure-view' == current_url()) { ?>class="active" <?php  } ?>><a href="<?php echo base_url(); ?>mt-figure-view"><i class="fa fa-angle-double-right"></i><img class="new_option" src="<?php echo base_url() . 'webroot/images/photos/new.png'; ?>"> MT Figure View</a></li>
            </ul>
          </li>
        ...
        ?>
          ...
          <li class="nav-parent  <?php if (base_url() . 'bt-quaters-oldl' == current_url()) { ?> nav-active active  <?php  } ?>"><a href="#"> <span><i class="fa fa-angle-double-right"></i> Reports</span></a>
            <ul class="children" <?php if (base_url() . 'bt-quaters-oldl' == current_url()) { ?> style="display: block;" <?php  } ?>>
              <li <?php if (base_url() . 'bt-quaters-oldl' == current_url()) { ?>class="active" <?php  } ?>><a href="<?php echo base_url(); ?>bt-quaters-oldl"><i class="fa fa-angle-double-right"></i> <span>Quarter Report</span></a></li>
          ...
          <li <?php if (base_url() . 'quarters' == current_url()) { ?>class="active" <?php  } ?>><a href="<?php echo base_url(); ?>quarters" target="_blank"><i class="fa fa-angle-double-right"></i> <span>Quarter Figure View</span></a></li>
        <?php } ?>
        ...
        ?>
          ...
          <li><a href="<?php echo base_url(); ?>bt-all-reports"><i class="fa fa-angle-double-right"></i> Reports Armed Wing</a></li>
          ...
          <li class="nav-parent  <?php if (base_url() . 'bt-quaters-oldl' == current_url()) { ?> nav-active active  <?php  } ?>"><a href="#"> <span><i class="fa fa-angle-double-right"></i> Returns</span></a>
            <ul class="children" <?php if (base_url() . 'bt-quaters-oldl' == current_url()) { ?> style="display: block;" <?php  } ?>>
              ...
              <?php if (false) { ?>
                ...
                <li><a href="<?php echo base_url(); ?>bt-all-iposioreport" target="_blank"><i class="fa fa-angle-double-right"></i> OSI Sec Cover -I</a></li>
          ...
          <!--li><a href="<?php //echo base_url(); 
                          ?>bt-khc?show_status=&orderno=&issued=&report=1"><i class="fa fa-angle-double-right"></i> KHC Figure View</a></li-->
          <li><a href="<?php //echo base_url(); 
                        ?>khc-figures" target="_blank" style="background-color:rgba(119, 0, 255, 1);"><i class="fa fa-angle-double-right"></i> KHC Figure View</a></li>
          ...
          <!--li><a href="<?php //echo base_url(); 
                          ?>deployment-statement"target="_blank" style="background-color:rgba(119, 0, 25, 1);"><i class="fa fa-angle-double-right"></i>Deployment</a></li-->

          <li class="nav-parent  <?php if (base_url() . 'deployment-statement' == current_url()) { ?> nav-active active  <?php  } ?>"><a href="#"> <span><i class="fa fa-angle-double-right"></i> Deployement</span></a>
            <ul class="children" <?php if (base_url() . 'deployment-statement' == current_url() || base_url() . 'deployment-statement-consolidated' == current_url() && base_url() . 'deployment-history' == current_url()) { ?> style="display: block;" <?php  } ?>>
              <li <?php if (base_url() . 'deployment-statement' == current_url()) { ?> class="active" <?php  } ?>><a href="<?php echo base_url(); ?>deployment-statement" target="_blank"><i class="fa fa-angle-double-right"></i>Deployment</a></li>
              <!--li><a href="<?php echo base_url(); ?>deployment-statement-consolidated" target="_blank"><i class="fa fa-angle-double-right"></i>Consolidated Deployment</a></li-->


              <li><a href="<?php echo base_url(); ?>deployment-history" target="_blank"><i class="fa fa-angle-double-right"></i> History</a></li>


            </ul>
          </li>
          <li <?php if (base_url() . 'course-history' == current_url()) { ?> class="active" <?php  } ?>><a href="<?php echo base_url(); ?>course-history"><i class="fa fa-angle-double-right"></i> Course History</a></li>
          <li <?php if (base_url() . 'cso' == current_url()) { ?> class="active" <?php  } ?>><a <?php if (base_url() . 'cso' == current_url()) {
                                                                                                echo 'href="#"';
                                                                                              } else {
                                                                                                echo "href=" . base_url() . "/cso";
                                                                                              } ?>><i class="fa fa-angle-double-right"></i> CSO</a></li>
          <li class="<?php if (base_url() . 'ammunition/conversion-report' == current_url()) { ?>active<?php  } ?>"><a href="<?php echo base_url(); ?>ammunition/conversion-report" target="_blank" style=""><i class="fa fa-angle-double-right"></i> Ammunition Conversion Report</a></li>
          <li class="<?php if (base_url() . 'present-strength' == current_url()) { ?>active<?php  } ?>">
            <a href="<?php echo base_url(); ?>present-strength" style=""><i class="fa fa-angle-double-right"></i>Present Strength</a>
          </li>
      ...
      <?php } ?>
      <li><a href="<?php //echo base_url();?>#" onclick="logout()"><i class="glyphicon glyphicon-log-out"></i> <span>Log Out</span></a></li><br />
      <li <?php if (base_url() . 'bt-password' == current_url()) { ?>class="active" <?php  } ?>><a href="<?php echo base_url(); ?>bt-password" style="background:#667C2F !important; color:#fff;"><i class="fa fa-angle-double-right"></i> Reset Password</a></li>
      ...
      <li><a href="#" style="background:#667C2F !important; color:#fff;"><i class="fa fa-angle-double-right"></i> <span>FAQ</span></a></li>
      <hr />
...
<script type="text/javascript">
  async function logout(){
    ...
    //alert("Loggin out2");
    let data1= await logout2();
    //console.log(data1);
    //alert(data1);
    localStorage.removeItem('user');
    localStorage.removeItem('token');
    window.location.href = "<?php echo str_replace("pp/",'', base_url());?>";
  }
  async function logout1() {
      let data = await $.ajax({
        //url:"<?php echo str_replace('paperms/pp/','api.paperms/', base_url()); ?>/api.paperms/public/api/logout",
        url: "<?php echo str_replace('paperms/pp/','api.paperms/', base_url()); ?>public/api/logout",
        type: 'POST',
        headers: {
