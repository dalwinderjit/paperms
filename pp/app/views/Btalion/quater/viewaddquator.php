...
<?php $this->load->view('Btalion/html/headbar'); ?>
    <div class="pageheader">
      <h2><i class="fa fa-building-o"></i> View Quator List </h2>
      <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
          <li class="active"><a href="<?php echo base_url();?>bt-dashboard">Dashboard</a></li>
          <li class="active">View Quator List </li>
        </ol>
      </div>
    </div>
  ...
  <strong>Success!</strong> <?php echo $this->session->flashdata('success_msg'); ?>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h3 class="panel-title">View Quator List </h3>
          </div>
            ...
            <table class="table"  id="table">
              <thead>
                 <tr>
                    ...
                    <th>Order No.</th>
                    <th>Order Date</th>
                    <th>Responsibility quota officer</th>
                    <th>Condition</th>
                 </tr>
              </thead>
              <tbody>
                <?php  $count = 0; foreach($horse as $value): $count = $count+1; ?>
                 <tr class="odd gradeX">
                    ...
                    <td><?php echo $value->tq; ?></td>
                    <td><?php echo $value->floor; ?></td>
                    <td><?php echo $value->acct; ?></td>
                    <td><?php echo $value->qno; ?></td>
                    <td><?php echo $value->bb; ?></td>
                    <td><?php echo $value->loc; ?></td>
                    <td><?php echo $value->todp; ?></td>
                    <td><?php echo $value->ono; ?></td>
