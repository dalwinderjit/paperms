...
<head>
    ...
    <title>View Alot Quator List </title>
...
<?php $this->load->view('Btalion/html/headbar'); ?>
    <div class="pageheader">
      <h2><i class="fa fa-building-o"></i> View Alot Quator List </h2>
      <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
          <li class="active"><a href="<?php echo base_url();?>bt-dashboard">Dashboard</a></li>
          <li class="active">View Alot Quator List </li>
        </ol>
      </div>
    </div>
  ...
  <strong>Success!</strong> <?php echo $this->session->flashdata('success_msg'); ?>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h3 class="panel-title">View Alot Quator List </h3>
          </div>
              ...
              <tbody>
                <?php  $count = 0; foreach($horse as $value): $count = $count+1; ?>
                 <tr class="odd gradeX">
                    ...
                    <td><?php $n = fetchoneinfo('add_quater',array('add_quater_id' => $value->qn));
                    echo 'Quarter No: '. $n->qno. '&nbsp; Floor: '. $n->floor. '&nbsp; Accommodation type:'. $n->acct. '&nbsp; Location: '. $n->loc; ?></td>
                    <td><?php $m = fetchoneinfo('officer_master',array('officer_master_id' => $value->nop)); echo $m->off_name; ?></td>
                    <td><?php echo $value->posd; ?></td>
                    <td><?php echo $value->alor; ?></td>
                    <td><?php echo $value->alldate; ?></td>
