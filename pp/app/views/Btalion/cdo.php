...
<?php $this->load->view('Btalion/html/headbar'); ?>
    <div class="pageheader">
      <h2><i class="fa fa-building-o"></i> CDO BNs WISE</h2>
...
?>
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                  ...
                  <div class="col-sm-9">
<?php
$BattalionUnitito = array('' => '--Select--', '1-CDO' => '1-CDO','2-CDO' => '2-CDO','3-CDO' => '3-CDO','4-CDO' => '4-CDO','5-CDO' => '5-CDO', 'CTC.BHG,PTL' => 'CTC.BHG,PTL'); 
/*newarea Textfield*/
...
?>
                   ...
                   <label class="col-sm-3 control-label"><button type="button" class="btn btn-primary cur">Modules</button></label>
                  <div class="col-sm-9">
                 <?php  
