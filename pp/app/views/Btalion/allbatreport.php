          ...
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                 ...
                 if($this->session->userdata('userid') == 209 || $this->session->userdata('userid') == 210){
                  $ito = array('' => '--Select--', '31' => 'KHC-WEAPON', '37' => 'KHC-AMMUNITION (Practice)', '38' => 'KHC-AMMUNITION (Service)', /*'32' => 'OSI',*/'33' => 'MSK', '34' => 'MT',  '36' => 'QUARTERS'); 
                 }
                  elseif($this->session->userdata('userid') == 211 || $this->session->userdata('userid') == 212){
                    $ito = array('' => '--Select--', '31' => 'KHC-WEAPON', '37' => 'KHC-AMMUNITION (Practice)', '38' => 'KHC-AMMUNITION (Service)',/* '32' => 'OSI'*/'33' => 'MSK', '34' => 'MT',  '36' => 'QUARTERS'); 
                  }else{
                    $ito = array('' => '--Select--', '31' => 'KHC-WEAPON', '39' => 'KHC-WEAPON ISSUED', '37' => 'KHC-AMMUNITION (Practice)', '38' => 'KHC-AMMUNITION (Service)', /*'32' => 'OSI',*/'33' => 'MSK', '34' => 'MT',  '36' => 'QUARTERS','35' => 'MOUNTS'); 
                  }
