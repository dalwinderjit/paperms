...
<body> <div class="row">
          ...
          <h2 class="text-center">Detail of Armed Battalion official attached with other units.</h2>
            <table class="table table-bordered">
              ...
              <tbody>
              <?php $count = 0 ; $names = fetchinfoosit('tcover',array('status'=> 1,'bat_id' => $this->session->userdata('rid')));   ?>
              <?php  foreach($names as $listng){ $count = $count + 1; ?>
                <tr>
                  <td><?php echo $count; ?></td>
                   <td><?php $a = fetchoneinfo('newosi',array('man_id'=> $listng->man_id)); ?><?php if($a !=''){echo $a->cexrank;}  ?></td>
