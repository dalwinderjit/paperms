...
<body> <div class="row">
          ...
          <h2 class="text-center">Detail of Armed wing security cover provided to Serving Police Officers</h2>
           <?php $names = fetchinfoosi('seccover',array('status'=> 1,'tname' => 'Police Officer','bat_id' => $this->session->userdata('rid')));  ?>
...
<td><?php echo $listng->address; ?></td>
  ...
  <tr>
    ...
    <td><table width="281" border="1"  class="table table-bordered">
      <tr>
        <td width="116"><strong><strong>Name of officals</strong> </td>
  ...
  <?php $nlist =  fetchoneinfoall('seccover',array('name' => $listng->name,'bat_id' => $this->session->userdata('rid')));  $nc = 0; foreach ($nlist as $value){ $nc = $nc + 1; ?>
    <tr>
    <td><?php echo $nc; ?></td>
    <td><table width="281" border="1"  class="table table-bordered">
      <tr>
        <td width="116"><?php $a = fetchoneinfo('newosi',array('man_id' => $value->man_id)); echo $a->cexrank.'&nbsp;'.$a->name; ?></td>
        <td width="149"><?php echo $a->depttno; ?></td>
      </tr>
    </table></td>
    <td><table width="287" border="1"  class="table table-bordered">
      <tr>
        <td width="121"><?php echo $a->battalion; ?></td>
        <td width="150"><?php echo $value->nod; ?></td>
      </tr>
    </table></td>
    <td><table width="295" border="1"  class="table table-bordered">
      <tr>
        <td width="120"><?php echo $a->phono1; ?></td>
        <td width="159"><?php echo $value->orderby; ?></td>
      </tr>
    </table></td>
 ...
 <h2 class="text-center">Detail of Armed wing security cover provided to Retired Police Officers</h2>
           <?php $names = fetchinfoosi('seccover',array('status'=> 1,'tname' => 'Retired Police Officer','bat_id' => $this->session->userdata('rid')));  ?>
              <?php $count = 0;  foreach($names as $listng){ $count = $count+1; ?>
...
<table class="table table-bordered">
                  ...
                  <tr>
                  <td><?php echo $c = 1; ?></td>   
                  <td><?php $a = fetchoneinfo('newosi',array('man_id' => $listng->man_id)); echo $a->name; ?></td><td><?php echo $a->depttno; ?></td>
                  <td><?php echo $a->battalion ?></td>
                  <td><?php echo $listng->nod; ?></td>
                  <td><?php echo $a->phono1; ?></td>
                  <td><?php echo $listng->orderby; ?></td>
                  <td><?php echo $listng->orderno.'<br/> Dated: '.$listng->order_date; ?></td>
                  </tr></table>
           ...
           <?php $names = fetchinfoosi('seccover',array('status'=> 1,'tname' => 'Political Persons','bat_id' => $this->session->userdata('rid')));  ?>
              <?php $count = 0;   foreach($names as $listng){ $count = $count+1; ?>
              <table class="table table-bordered">
  <thead>
    <tr>
  ...
  <tr>
<td><?php echo $count; ?></td>
<td><?php echo $listng->name; ?> <?php $a = fetchoneinfo('newosi',array('man_id' => $listng->man_id)); echo $a->name; ?></td>
<td><?php echo $listng->rank.$listng->des; ?></td>
<td><?php echo $listng->placeofposting; ?></td>
<td><?php echo $listng->address; ?></td>
</tr>
    <tr> <td  colspan="5"><table class="table table-bordered">
                  ...
                  <td><?php echo $a->phono1; ?></td>
                  <td><?php echo $listng->orderby; ?></td>
                  <td><?php echo $listng->orderno.'&nbsp;'.$listng->order_date; ?></td>
                  </tr></table></td>
    </tr>
  </tbody>
</table>
           ...
           <?php $names = fetchinfoosi('seccover',array('status'=> 1,'tname' => 'Civil Officers','bat_id' => $this->session->userdata('rid')));  ?>
...
<td><?php echo $listng->address; ?></td>
    ...
    <tr> <td  colspan="5"><table class="table table-bordered">
           ...
           <?php $names = fetchinfoosi('seccover',array('status'=> 1,'tname' => 'Retired Civil Officer','bat_id' => $this->session->userdata('rid')));  ?>
              <?php  foreach($names as $listng){ ?>
              <table class="table table-bordered">
  <thead>
    <tr>
...
<td><?php echo $listng->address; ?></td>
    ...
    <tr> <td  colspan="5"><table class="table table-bordered">
           ...
           <?php $names = fetchinfoosi('seccover',array('status'=> 1,'tname' => 'Judicial Officers','bat_id' => $this->session->userdata('rid')));  ?>
              <?php  foreach($names as $listng){ ?>
              <table class="table table-bordered">
  <thead>
    <tr>
...
<td><?php echo $listng->address; ?></td>
    ...
    <tr> <td  colspan="5"><table class="table table-bordered">
           ...
           <?php $names = fetchinfoosi('seccover',array('status'=> 1,'tname' => 'Retired Judicial Officer','bat_id' => $this->session->userdata('rid')));  ?>
              <?php  foreach($names as $listng){ ?>
              <table class="table table-bordered">
  <thead>
    <tr>
...
<td><?php echo $listng->address; ?></td>
    ...
    <tr> <td  colspan="5"><table class="table table-bordered">
      ...
      <h2 class="text-center">Detail of Armed wing security cover provided to Threatened Persons</h2>
           <?php $names = fetchinfoosi('seccover',array('status'=> 1,'tname' => 'Threatening persons','bat_id' => $this->session->userdata('rid')));  ?>
              <?php  foreach($names as $listng){ ?>
              <table class="table table-bordered">
  <thead>
    <tr>
...
<td><?php echo $listng->address; ?></td>
    ...
    <tr> <td  colspan="5"><table class="table table-bordered">
           ...
           <?php $names = fetchinfoosi('seccover',array('status'=> 1,'tname' => 'PERSONAL SECURITY STAFF ARMED WING OFFICER','bat_id' => $this->session->userdata('rid')));  ?>
              <?php  foreach($names as $listng){ ?>
              <table class="table table-bordered">
  <thead>
    <tr>
