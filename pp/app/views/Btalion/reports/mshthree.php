...
<body>  
            <h3 class="text-center">DETAIL OF MISCELLANEOUS ARTICLES <?php $val = explode(' ', $info->nick); echo $val[0];  ?> <?php $val = explode(' ', $info->nick2); echo $val[0];  ?> FOR THE MONTH OF <?php echo strtoupper(date('M-Y')); ?></h3>
                    <div class="row">
