...
<head>
  ...
  <title>Serving Police Officer</title>
...
<?php $this->load->view('Btalion/html/headbar'); ?>
    <div class="pageheader">
      <h2><i class="fa fa-building-o"></i>Serving Police Officer</h2>
      <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
          <li class="active"><a href="<?php echo base_url();?>dashboard">Dashboard</a></li>
          <li class="active">Serving Police Officer</li>
        </ol>
      </div>
    </div>
...
?>
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Serving Police Officer</h4>
              </div>
