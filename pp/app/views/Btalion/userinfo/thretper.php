...
<head>
  ...
  <title>Threatened Persons</title>
...
<?php $this->load->view('Btalion/html/headbar'); ?>
    <div class="pageheader">
      <h2><i class="fa fa-building-o"></i>Threatened Persons</h2>
      <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
          <li class="active"><a href="<?php echo base_url();?>dashboard">Dashboard</a></li>
          <li class="active">Threatened Persons</li>
        </ol>
      </div>
    </div>
...
?>
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Threatened Persons</h4>
              </div>
...
?>
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label">Organization:</label>
                   <div class="col-sm-9">
                <label class="radio-inline"><input type="radio" name="mstatus" checked value="Religious">Religious</label>
                <label class="radio-inline"><input type="radio" name="mstatus" value="Shiv Sena">Shiv Sena</label>
                <label class="radio-inline"><input type="radio" name="mstatus" value="Others">Others </label>
                </div>
                </div>
                  ...
                  <div class="col-sm-9">
<?php
$address = array('type' => 'text','name' => 'address','id' => 'address','class' => 'form-control','placeholder' =>'State/District','required' => 'required','value' => set_value('address'));
