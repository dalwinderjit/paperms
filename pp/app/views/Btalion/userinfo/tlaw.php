...
<?php $this->load->view('Btalion/html/headbar'); ?>
    <div class="pageheader">
      <h2><i class="fa fa-building-o"></i>Temp Duty</h2>
      <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
          <li class="active"><a href="<?php echo base_url();?>dashboard">Dashboard</a></li>
          <li class="active">Temp Duty</li>
        </ol>
      </div>
    </div>
...
?>
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Temp Duty</h4>
              </div>
...
?>
                 ...
                 <div class="form-group">
                  <label class="col-sm-3 control-label">Battallion/ Unit</label>
                  <div class="col-sm-9">
<?php
$bu = array('type' => 'text','name' => 'bu','id' => 'bu','class' => 'form-control','placeholder' =>'Battallion/ Unit','required' => 'required','value' => set_value('bu'));
echo form_input($bu);
echo form_error('bu');
?>
                    <label for="bu" class="error"></label>
                  </div>
                </div>
                  ...
                  <label class="col-sm-3 control-label">Nature of Duty</label>
                   <div class="col-sm-9">
                <label class="radio-inline"><input type="radio" name="mstatus" checked value="Law & Order">Law & Order</label>
                <label class="radio-inline"><input type="radio" name="mstatus" value="Electation Duty">Electation Duty</label>
                <label class="radio-inline"><input type="radio" name="mstatus" value="Security">Security</label>
                </div>
                </div>
