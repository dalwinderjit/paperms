...
?>
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                  ...
                  <div class="col-sm-9">
                 <?php  
$mq = array('A' => 'A','B' => 'B','C' => 'C');
/*newarea Textfield*/
 echo form_dropdown('mq', $mq, set_value('mq',1),'id="mq" data-placeholder="Choose One" title="Please select at least 1 area" class="select2" required'); 
 echo form_error('mq');
