...
<head>
  ...
  <title>Retired Judicial Officer</title>
...
<?php $this->load->view('Btalion/html/headbar'); ?>
    <div class="pageheader">
      <h2><i class="fa fa-building-o"></i>Retired Judicial Officer</h2>
      <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
          <li class="active"><a href="<?php echo base_url();?>dashboard">Dashboard</a></li>
          <li class="active">Retired Judicial Officer</li>
        </ol>
      </div>
    </div>
...
?>
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Retired Judicial Officer</h4>
              </div>
