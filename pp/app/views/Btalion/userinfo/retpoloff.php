...
<head>
  ...
  <title>Retired Police Officer</title>
...
<?php $this->load->view('Btalion/html/headbar'); ?>
    <div class="pageheader">
      <h2><i class="fa fa-building-o"></i>Retired Police Officer</h2>
      <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
          <li class="active"><a href="<?php echo base_url();?>dashboard">Dashboard</a></li>
          <li class="active">Retired Police Officer</li>
        </ol>
      </div>
    </div>
...
?>
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Retired Police Officer</h4>
              </div>
...
?>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-9">
<?php
$address = array('type' => 'text','name' => 'address','id' => 'address','class' => 'form-control','placeholder' =>'Address','required' => 'required','value' => set_value('pop'));
