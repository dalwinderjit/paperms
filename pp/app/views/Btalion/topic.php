...
echo form_dropdown('vcat', $vcati, set_value('vcat',''),'id="vcat"  class="form-control  line" '); 
...
<div class="form-group">
  ...
  <?php 
$tmob = array('type' => 'text','name' => 'vtit','id' => 'tmob','class' => 'form-control input-sm  line','placeholder' =>'Title','value' => set_value('vtit'));
...
<div class="form-group">
  ...
  <?php 
$tname = array('type' => 'text','name' => 'yname','id' => 'tname','class' => 'form-control input-sm line','placeholder' =>'YouTube URL','value' => set_value('yname'));
...
<div class="form-group">
  ...
  <?php 
$temail = array('type' => 'text','name' => 'vdes','id' => 'temail','class' => 'form-control input-sm  line','placeholder' =>'Description','value' => set_value('vdes'),'style' => 'height:80px;');
...
<tbody>
<?php $sn = 0;  foreach ($topic as $value): $sn = $sn +1; ?>
  <tr>
<td><?php echo $sn; ?></td>
<td><?php echo $value->menu_name; ?></td>
<td><?php echo $value->sub_menu_name; ?></td>
<td><a href=""><?php echo $value->sylink; ?></a> </td>
<td><?php echo $value->sub_menu_details; ?></td>
<td><a href="<?php echo base_url('bt-edittopics'); ?>/<?php echo $value->sub_menu_id; ?>" class="btn btn-success">Edit</a></td>
</tr>
<?php endforeach; ?>
</tbody>
</table>
