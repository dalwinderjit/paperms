...
?>
          <div class="panel panel-default">
             ...
             <div class="form-group">
                  <label class="col-sm-3 control-label">Munition</label>
                  <div class="col-sm-9">
                    <?php $bdn = array();
                      $bdn[] = '--Munition--';
                        foreach ($mun as  $value) {
                     $bdn[$value->name] = $value->name;
                      } 
...
/*newarea Textfield*/
 echo form_dropdown('bodyno', $bdn, set_value('bodyno',1),'id="bodyno" data-placeholder="Choose One" title="Please select at least 1 value" class="select2" required'); 
