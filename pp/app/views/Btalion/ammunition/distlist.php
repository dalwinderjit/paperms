            ...
            <table class="table  table-fixedheader"  id="table">
              <thead>
                 <tr>
                    ...
                    <th>District/Unit</th>
                    <th>Bore</th>
                     <th>Miss Ammunition Quantity</th>
                     <th>Live Ammunition Quantity</th>
                     <th>Lost Ammunition Quantity</th>
                     <th>Empty Ammunition Quantity</th>
                     <th>Condem Ammunition Quantity</th>
                      <th>RC No</th>
                       <th>RC Date </th>
              ...
              <tbody>
                <?php  $count = 0; if($arms!=''){ foreach($arms as $value): $count = $count+1; ?>
                 <tr class="odd gradeX">
                    <td><?php echo $count; ?></td>
                    <td><?php if (is_numeric($value->dist)) {
                      $bat = fetchoneinfo('users',array('users_id' => $value->dist));
                      echo $bat->nick;

                     }else{echo $value->dist;} ?></td>
                    <td><?php echo $value->bore; ?></td>
                    <td><?php echo $value->mic; ?></td>
                    <td><?php echo $value->lic; ?></td>
                    <td><?php echo $value->loc; ?></td>
                    <td><?php echo $value->eammu; ?></td>
                    <td><?php echo $value->conc; ?></td>
                    <td><?php echo $value->rcno; ?></td>
                    <td><?php echo $value->rdate; ?></td>
                    <td><?php echo date('d-m-Y', strtotime($value->dptime)); ?></td>
                    </tr>
                <?php endforeach; } ?>
              </tbody>
           </table>
