...
<?php $this->load->view('Btalion/html/headbar'); ?>
    <div class="pageheader">
      <h3> &nbsp; &nbsp; &nbsp;<?php if(base_url('bt-osifoni') == current_url()){
          echo'Formal order not issued';
        }if(base_url('bt-osipfpp') == current_url()){
          echo'Posted for pay purpose';
        }if(base_url('bt-osi-nor') == current_url() ){
          echo'Not Reported';
        }if(base_url('bt-osi-nord') == current_url() ){
          echo'Not Relieved';
        }if(base_url('bt-osi-ea') == current_url() ){
          echo'Excess Attached';
        }if(base_url('bt-osi-vac') == current_url()){
          echo'Vacancies';
        } ?></h3>
    </div>
          ...
          <div class="panel panel-default">
              ...
              <div class="form-group">
                <label class="col-sm-3 control-label">Rank</label>
                  <div class="col-sm-9">
                   <?php $cw = array('' => '--Present Rank--', 'CT' => 'CT', 'HC' => 'HC', 'ASI' => 'ASI', 'SI' => 'SI', 'INSP' => 'INSP');  
