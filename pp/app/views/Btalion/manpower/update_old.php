...
/*----End newarea Textfield----*/
 ?>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
 <?php  
$ti = array('' => '--Select--', 'Promotion Transfer' => 'Promotion Transfer','Transfer' => 'Transfer','On deputation' => 'On deputation','Dismissed' => 'Dismissed','Retired' => 'Retired','Resignation' => 'Resignation','Missing' => 'Missing','Expired' => 'Expired');
...
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
				 ...
				 <div class="form-group" id="divDateofnotrelieving" style="display:none;">
                  <label class="col-sm-3 control-label">Date</label>
                  <div class="col-sm-9">
                  <div class="input-group">
 <?php  
$Dateofnotrelieving = array('type' => 'text','name' => 'Dateofnotrelieving','id' => 'Dateofnotrelieving','class' => 'form-control','placeholder' =>'Date of not relieving','value' => set_value('Dateofnotrelieving'));
echo form_input($Dateofnotrelieving);
echo form_error('Dateofnotrelieving');
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
</div>
                    <label for="belt" class="error"></label>
                  </div>
...
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                 ...
                 <div class="form-group" id="Deputation1" style="display:none;">
                  ...
                  <div class="col-sm-9">
 <?php  
 $DeputationUnit = array('' => '--Select--', 'CID' => 'CID','Excise' => 'Excise','Vigilance Bureau' => 'Vigilance Bureau','PSPCL' => 'PSPCL','SSG' => 'SSG','IVC' => 'IVC','Municiple Corporation' => 'Municiple Corporation','PPA/PHR' => 'PPA/PHR','PRTC JAHANKHELAN' => 'PRTC JAHANKHELAN','STATE TRANSPORT' => 'STATE TRANSPORT','NRI WING' => 'NRI WING','SNCB' => 'SNCB','Security Wing, Pb., CHD' => 'Security Wing, Pb., CHD','District' => 'District','Intelligence' => 'Intelligence','SOG' => 'SOG');
...
jQuery(document).ready(function(){
  ...
  jQuery('#Dateofnotrelieving').datepicker({dateFormat: "dd/mm/yy"});
...
$(document).on('change', '#tid', function() {
    if(this.value == 'Yes'){
            ...
            $('#pTransfer222').show();
            $('#Expired1').hide();
			 $('div#divDateofnotrelieving').hide();
    }else if(this.value == 'Expired'){
          $('#Expired1').show();
          $('#pTransfer2').hide();
		   $('div#Dateofnotrelieving').hide();
    }else{
        $('#pTransfer2').hide();
        $('div#divDateofnotrelieving').show();
