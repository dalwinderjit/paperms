...
?>
                  ...
                  <div class="col-sm-3"><div class="form-group">
                 <?php  
$Modemdr = array('' => '--Mode of Enlistment--', 'Special Cases','Direct' => 'Direct', 'Direct (Ex-Serviceman)' => 'Direct (Ex-Serviceman)','Direct (Wards of Ex-Serviceman)' => 'Direct (Wards of Ex-Serviceman)', 'Direct (Wards of Police Person)' => 'Direct (Wards of Police Person)','SPO' => 'SPO', 'Direct(SPORTS)' => 'Direct(SPORTS)', 'PLI' => 'PLI', 'Court cases' => 'Court cases','Direct (Freedom Fighter)' => 'Direct (Freedom Fighter)','Other' => 'Other','Temporary' => 'Temporary');
/*newarea Textfield*/
...
?>
 ...
 <div class="col-sm-3"><br/><div class="form-group">    <div class="input-group">
                 <?php
...
<!-------------------------------------------------------------mobno ---->
   ...
   <div class="col-sm-3"><br><div class="form-group">
<?php
$mobno = array('type' => 'text','name' => 'mobno','id' => 'mobno','class' => 'form-control','placeholder' =>'Enter Mobile Number','value' => (isset($_GET['mobno'])) ? $_GET['mobno'] : '');
echo form_input($mobno);
echo form_error('mobno');
?>
                    <label for="mobno" class="error"></label>
                  </div>
                </div>
                 ...
                 <tr class="odd gradeX">
                    <td><?php echo $count; ?></td>
                     ...
                     <?php  if($this->session->userdata('userid') == 93 ){ ?>
                      <div class="dropdown">
  <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"> Game/Posting
