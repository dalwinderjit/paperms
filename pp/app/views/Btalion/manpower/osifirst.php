...
<div class="row">
  ...
  <a href="<?php echo base_url('bt-osireportones'); ?>">DEPLOYMENT HEADING</a>
</div>
       ...
       <table border="0"  data-tableName="Test Table 1"><tr><td>&nbsp;</td><td><h3>DEPLOYMENT STATEMENT OF <?php $a = explode('.',$this->session->userdata('username')); echo $a[0]; ?> PAP BATTALION</h3></td> <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td> </tr></table>
          ...
          <table border="0" data-tableName="Test Table 3"><tr><td>&nbsp;</td><td><h3> 1. FIX DUTIES</h3></td> <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr></table>
            ...
            <table width="922" border="1"  class="table2excel" data-tableName="Test Table 2">
              ...
              <tbody>
                <tr>
                  ...
                  <td><?php $hold1 =  info_fetch_osireport('INSP','VP Guards','fone1'); 
                      $hold2 = info_fetch_osireport('DSP/CR','VP Guards','fone1'); 
                      echo $insp1 = $hold1 + $hold2;  ?></td>
            <td><?php $hold3 = info_fetch_osireport('SI','VP Guards','fone1');
            ...
            echo $si1 = $hold3 + $hold4 + $hold5;
              ?></td>
            <td><?php $hold6 = info_fetch_osireport('ASI','VP Guards','fone1'); 
             ...
             ?></td>
            <td><?php $hold9 = info_fetch_osireport('HC','VP Guards','fone1');
            ...
            <td><?php $hold12 = info_fetch_osireport('CT','VP Guards','fone1');
            ...
            <table width="925" border="1">
              ...
              <tbody>
                <tr>
                 ...
                 <td width="57" ><?php $hold191 = info_fetch_osireport('INSP','PERMANENT DUTY','lone1'); 
                      $hold192 = info_fetch_osireport('DSP/CR','PERMANENT DUTY','lone1'); 
                      echo $insp13 =  $hold191 + $hold192;  ?></td>
            <td width="42"><?php $hold193 = info_fetch_osireport('SI','PERMANENT DUTY','lone1');
            ...
            echo $si13= $hold193 + $hold194 + $hold195;
              ?></td>
            <td width="42"><?php $hold196 = info_fetch_osireport('ASI','PERMANENT DUTY','lone1'); 
             ...
             ?></td>
            <td width="42"><?php $hold199 = info_fetch_osireport('HC','PERMANENT DUTY','lone1');
            ...
            <td width="42"><?php $hold202 = info_fetch_osireport('CT','PERMANENT DUTY','lone1');
            ...
            <td width="43"><?php echo $insp13 + $si13 + $asi13 + $hc13 + $ct13;  ?></td>
                </tr>
...
<table border="0" data-tableName="Test Table 3"><tr><td>&nbsp;</td><td> <h3> 3. SPECIAL SQUADS</h3></td> <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr></table>
            ...
            <table width="925" border="1">
              <tbody>
                <tr>
                 ...
                 <td width="56"><?php $hold239 = info_fetch_osireport('INSP','ANTI RIOT POLICE, JALANDHAR','sqone1'); 
                      $hold240 = info_fetch_osireport('DSP/CR','ANTI RIOT POLICE, JALANDHAR','sqone1'); 
                      echo $insp16 = $hold239 + $hold240;  ?></td>
            <td width="43"><?php $hold241 = info_fetch_osireport('SI','ANTI RIOT POLICE, JALANDHAR','sqone1');
            ...
            echo $si16= $hold241 + $hold242 + $hold243;
              ?></td>
            <td width="42"><?php $hold244 = info_fetch_osireport('ASI','ANTI RIOT POLICE, JALANDHAR','sqone1'); 
             ...
             ?></td>
            <td width="42""><?php $hold2460 = info_fetch_osireport('HC','ANTI RIOT POLICE, JALANDHAR','sqone1');
            ...
            <td width="41"><?php $hold249 = info_fetch_osireport('CT','ANTI RIOT POLICE, JALANDHAR','sqone1');
            ...
            <td width="42"><?php echo $insp16 + $si16 + $asi16 + $hc16 + $ct16;  ?></td>
                </tr>
...
<table border="0"><tr><td>&nbsp;</td><td>  <h3> 4. PERMANENT ATTACHMENT</h3></td> <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr></table>
            ...
            <table width="924" border="1">
              <tbody>
                ...
                <td width="59"><?php $hold337 = info_fetch_osireport('INSP','ATTACHED WITH DISTT.','paone1'); 
                      $hold338 = info_fetch_osireport('DSP/CR','ATTACHED WITH DISTT.','paone1'); 
                      echo $insp22 = $hold337 + $hold338;  ?></td>
            <td width="42"><?php $hold339 = info_fetch_osireport('SI','ATTACHED WITH DISTT.','paone1');
            ...
            echo $si22= $hold339 + $hold340 + $hold341;
              ?></td>
            <td width="42"><?php $hold342 = info_fetch_osireport('ASI','ATTACHED WITH DISTT.','paone1'); 
             ...
             ?></td>
            <td width="43"><?php $hold345 = info_fetch_osireport('HC','ATTACHED WITH DISTT.','paone1');
            ...
            <td width="43"><?php $hold348 = info_fetch_osireport('CT','ATTACHED WITH DISTT.','paone1');
            ...
            <td width="37"><?php echo $insp22 + $si22 + $asi22 + $hc22 + $ct22;  ?></td>
                </tr>
...
<table border="0" data-tableName="Test Table 3"><tr><td>&nbsp;</td><td>  <h3> 5. TRAINING</h3></td> <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr></table>
              ...
              <tbody>
                <tr>
                  ...
                  <td width="577">BASIC TRAINING</td>
                              <td width="59"><?php $hold674 = info_fetch_osireport('INSP','BASIC TRANING','traning1'); 
                      $hold675 = info_fetch_osireport('DSP/CR','BASIC TRANING','traning1'); 
                      echo $insp43 = $hold674 + $hold675;  ?></td>
            <td width="43"><?php $hold676 = info_fetch_osireport('SI','BASIC TRANING','traning1');
            ...
            echo $si43 =$hold676 + $hold677 + $hold678;
              ?></td>
            <td width="42"><?php $hold679 = info_fetch_osireport('ASI','BASIC TRANING','traning1'); 
             ...
             ?></td>
            <td width="43"><?php $hold682 = info_fetch_osireport('HC','BASIC TRANING','traning1');
            ...
            <td width="43"><?php $hold685 = info_fetch_osireport('CT','BASIC TRANING','traning1');
            ...
            <td width="38"><?php echo $insp43 + $si43 + $asi43 + $hc43 + $ct43;  ?></td>
                </tr>
...
<table border="0" data-tableName="Test Table 3"><tr><td>&nbsp;</td><td>   <h3> 6. SPORTS</h3></td> <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr></table>
            ...
            <table width="926" border="1">
              <tbody>
                <tr>
                  <td width="28">i)</td>
                  <td width="580">DSO</td>
                               <td width="59"><?php $hold722 = info_fetch_osireport('INSP','DSO','ssone23'); 
                      $hold723 = info_fetch_osireport('DSP/CR','DSO','ssone23'); 
                      echo $insp46 = $hold722 + $hold723;  ?></td>
            <td width="41"><?php $hold724 = info_fetch_osireport('SI','DSO','ssone23');
            ...
            echo $si46 = $hold724 + $hold725 + $hold726;
              ?></td>
            <td width="45"><?php $hold727 = info_fetch_osireport('ASI','DSO','ssone23'); 
             ...
             ?></td>
            <td width="44"><?php $hold730 = info_fetch_osireport('HC','DSO','ssone23');
            ...
            <td width="44"><?php $hold733 = info_fetch_osireport('CT','DSO','ssone23');
            ...
            <td width="33"><?php echo $insp46 + $si46 + $asi46 + $hc46 + $ct46;  ?></td>
                </tr>
...
<table border="0" data-tableName="Test Table 3"><tr><td>&nbsp;</td><td>  <h3> 7. AVAILABLE WITH BNs.</h3></td> <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr></table>
              ...
              <tbody>
                <tr>
                  ...
                  <td width="583">PAP HQRS. CAMPUS SECURITY,BN. KOT GUARDS,BN. HQRS OTHER GUARDS</td>
                               <td width="54"><?php $hold786 = info_fetch_osireport('INSP','PAP CAMPUS  SECURITY','awbone1'); 
                      $hold787 = info_fetch_osireport('DSP/CR','PAP CAMPUS  SECURITY','awbone1'); 
                      echo $insp50 = $hold786 + $hold787;  ?></td>
            <td width="49" ><?php $hold788 = info_fetch_osireport('SI','PAP CAMPUS  SECURITY','awbone1');
            ...
            echo $si50 =  $hold788 + $hold789 + $hold790;
              ?></td>
            <td width="41"><?php $hold791 = info_fetch_osireport('ASI','PAP CAMPUS  SECURITY','awbone1'); 
             ...
             ?></td>
            <td width="45"><?php $hold794 = info_fetch_osireport('HC','PAP CAMPUS  SECURITY','awbone1');
            ...
            <td width="43"><?php $hold797 = info_fetch_osireport('CT','PAP CAMPUS  SECURITY','awbone1');
            ...
            <td width="32"><?php echo $insp50 + $si50 + $asi50 + $hc50 + $ct50;  ?></td>
                </tr>

            <!--      <tr>
                  <td>ii)</td>
                  <td>dEL PERSONEL SECURITY STAFF WITH ARMED WING OFFICERS</td>
           ...
           // echo $si51 = $hold804 + $hold805 + $hold806;
            ...
            <td><?php //echo $insp54 + $si54 + $asi54 + $hc54 + $ct54;  ?></td>
                ...
                <!--  <tr>
                  <td>  vi)</td>
                  <td>dEL BN. HQRS OTHER GUARDS</td>
            ...
            <td><?php //echo $insp55 + $si55 + $asi55 + $hc55 + $ct55;  ?></td>
                 ...
                 <tr>
                  <td>vii)</td>
                  <td>TRADEMEN</td>
                 <td><?php $hold881 = info_fetch_osireport('INSP','TRADEMEN','awbone7'); 
                          
                      $hold882 = info_fetch_osireport('DSP/CR','TRADEMEN','awbone7'); 
                      echo $insp56 = $hold881 + $hold882;  ?></td>
            <td><?php $hold884 = info_fetch_osireport('SI','TRADEMEN','awbone7');
            $hold885 = info_fetch_osireport('INSP/LR','TRADEMEN','awbone7'); 
            $hold886 = info_fetch_osireport('INSP/CR','TRADEMEN','awbone7'); 
            echo $si56 = $hold884 + $hold885 + $hold886;
              ?></td>
            <td><?php $hold887 = info_fetch_osireport('ASI','TRADEMEN','awbone7'); 
                $hold888 = info_fetch_osireport('SI/CR','TRADEMEN','awbone7');  
                $hold889 = info_fetch_osireport('SI/LR','TRADEMEN','awbone7'); 
                echo $asi56 = $hold887 + $hold888 + $hold889; 

             ?></td>
            <td><?php $hold890 = info_fetch_osireport('HC','TRADEMEN','awbone7');
                    $hold891 = info_fetch_osireport('ASI/LR','TRADEMEN','awbone7');
                     $hold892 = info_fetch_osireport('ASI/CR','TRADEMEN','awbone7');
             echo  $hc56= $hold890 +  $hold891 + $hold892;  ?></td>
            <td><?php $hold893 = info_fetch_osireport('CT','TRADEMEN','awbone7');
                       $hold894 = info_fetch_osireport('HC/PR','TRADEMEN','awbone7');
                        $hold895 = info_fetch_osireport('HC/LR','TRADEMEN','awbone7');
                         $hold896 = info_fetch_osireport('Sr.Const','TRADEMEN','awbone7');
                         $hold897 = info_fetch_osireport('C-II','TRADEMEN','awbone7');
            ...
            <td><?php echo $insp56 + $si56 + $asi56 + $hc56 + $ct56;  ?></td>
                 ...
                 <tr>
                  <td>viii)</td>
                  <td>ARMOURER</td>
                 <td><?php $hold881 = info_fetch_osireport('INSP','Armourer & A/Armourer','awbone9'); 
                      $hold882 = info_fetch_osireport('DSP/CR','Armourer & A/Armourer','awbone9'); 
                      echo $insp56 = $hold881 + $hold882;  ?></td>
            <td><?php $hold884 = info_fetch_osireport('SI','Armourer & A/Armourer','awbone9');
            $hold885 = info_fetch_osireport('INSP/LR','Armourer & A/Armourer','awbone9'); 
            $hold886 = info_fetch_osireport('INSP/CR','Armourer & A/Armourer','awbone9'); 
            echo $si56 = $hold884 + $hold885 + $hold886;
              ?></td>
            <td><?php $hold887 = info_fetch_osireport('ASI','Armourer & A/Armourer','awbone9'); 
                $hold888 = info_fetch_osireport('SI/CR','Armourer & A/Armourer','awbone9');  
                $hold889 = info_fetch_osireport('SI/LR','Armourer & A/Armourer','awbone9'); 
                echo $asi56 = $hold887 + $hold888 + $hold889; 

             ?></td>
            <td><?php $hold890 = info_fetch_osireport('HC','Armourer & A/Armourer','awbone9');
                    $hold891 = info_fetch_osireport('ASI/LR','Armourer & A/Armourer','awbone9');
                     $hold892 = info_fetch_osireport('ASI/CR','Armourer & A/Armourer','awbone9');
             echo  $hc56= $hold890 +  $hold891 + $hold892;  ?></td>
            <td><?php $hold893 = info_fetch_osireport('CT','Armourer & A/Armourer','awbone9');
                       $hold894 = info_fetch_osireport('HC/PR','Armourer & A/Armourer','awbone9');
                        $hold895 = info_fetch_osireport('HC/LR','Armourer & A/Armourer','awbone9');
                         $hold896 = info_fetch_osireport('Sr.Const','Armourer & A/Armourer','awbone9');
                         $hold897 = info_fetch_osireport('C-II','Armourer & A/Armourer','awbone9');
             echo $ct56= $hold893 + $hold894 + $hold895 + $hold896 + $hold897;  ?></td>
            <td><?php echo $insp56 + $si56 + $asi56 + $hc56 + $ct56;  ?></td>
                </tr>
  ...
  <tbody>
    <tr>
                  ...
                  <td width="584">RECRUITS</td>
                    ...
                    <td width="52"><?php $hold961 = info_fetch_osireport('INSP','RECRUIT','bmdone1'); 
                      $hold962 = info_fetch_osireport('DSP/CR','RECRUIT','bmdone1'); 
                      echo $insp61 = $hold961 + $hold962;  ?></td>
            <td width="51"><?php $hold963 = info_fetch_osireport('SI','RECRUIT','bmdone1');
            ...
            echo $si61 = $hold963 + $hold964 + $hold965;
              ?></td>
            <td width="41"><?php $hold966 = info_fetch_osireport('ASI','RECRUIT','bmdone1'); 
             ...
             ?></td>
            <td width="45"><?php $hold969 = info_fetch_osireport('HC','RECRUIT','bmdone1');
            ...
            <td width="43"><?php $hold972 = info_fetch_osireport('CT','RECRUIT','bmdone1');
            ...
            <td width="28"><?php echo $insp61 + $si61 + $asi61 + $hc61 + $ct61;  ?></td>
                 ...
                 <tr>
                  ...
                  <td>LEAVES</td>
                    ...
                    <td><?php $hold977 = info_fetch_osireports('INSP','','bmdone2'); 
                      $hold978 = info_fetch_osireports('DSP/CR','','bmdone2'); 
                      echo $insp62 = $hold977 + $hold978;  ?></td>
            <td><?php $hold979 = info_fetch_osireports('SI','','bmdone2');
            $hold980 = info_fetch_osireports('INSP/LR','','bmdone2'); 
            $hold981 = info_fetch_osireports('INSP/CR','','bmdone2'); 
            echo $si62 = $hold979 + $hold980 + $hold981;
              ?></td>
            <td><?php $hold982 = info_fetch_osireports('ASI','','bmdone2'); 
                $hold983 = info_fetch_osireports('SI/CR','','bmdone2');  
                $hold984 = info_fetch_osireports('SI/LR','','bmdone2'); 
                echo $asi62 = $hold982 + $hold983 + $hold984; 

             ?></td>
            <td><?php $hold985 = info_fetch_osireports('HC','','bmdone2');
                    $hold986 = info_fetch_osireports('ASI/LR','','bmdone2');
                     $hold987 = info_fetch_osireports('ASI/CR','','bmdone2');
             echo $hc62= $hold985 +  $hold986 + $hold987;  ?></td>
            <td><?php $hold988 = info_fetch_osireports('CT','','bmdone2');
                       $hold989 = info_fetch_osireports('HC/PR','','bmdone2');
                        $hold990 = info_fetch_osireports('HC/LR','','bmdone2');
                         $hold991 = info_fetch_osireports('Sr.Const','','bmdone2');
                         $hold992 = info_fetch_osireports('C-II','','bmdone2');
...
<table border="0" data-tableName="Test Table 3"><tr><td>&nbsp;</td><td>  <h3> 9. INSTITUTIONS</h3></td> <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr></table>
              ...
              <tbody>
                <tr>
                  ...
                  <td width="586">PAP HQRS INSTITUTIONS</td>
                   ...
                   <td width="49"><?php $hold1105 = info_fetch_osireports('INSP','','instone4'); 
                      $hold1106 = info_fetch_osireports('DSP/CR','','instone4'); 
                      echo $insp70= $hold1105 + $hold1106;  ?></td>
            <td width="52"><?php $hold1107 = info_fetch_osireports('SI','','instone4');
            ...
            echo $si70 = $hold1107 + $hold1108 + $hold1109;
              ?></td>
            <td width="40"><?php $hold1110 = info_fetch_osireports('ASI','','instone4'); 
             ...
             ?></td>
            <td width="46"><?php $hold1113 = info_fetch_osireports('HC','','instone4');
            ...
            <td width="41"><?php $hold1116 = info_fetch_osireports('CT','','instone4');
            ...
            <td width="28"><?php echo $insp70 + $si70 + $asi70 + $hc70 + $ct70;  ?></td>
