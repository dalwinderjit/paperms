...
<table border="0" data-tableName="Test Table 3"><tr><td>&nbsp;</td><td>  <h3> 7. AVAILABLE WITH BNs.</h3></td> <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr></table>
            ...
            <td><?php echo $gdaffeduinsp + $gdaffedusi + $gdaffeduasi + $gdaffeduhc + $gdaffeduct;  ?></td>
                ...
                <td><?php $trgresatbnhqrs1 = info_fetch_osireport('INSP','RECRUITMENT DUTY','awbone12'); 
                      $trgresatbnhqrs2 = info_fetch_osireport('DSP/CR','RECRUITMENT DUTY','awbone12'); 
                      echo $trgresatbnhqrsinsp = $trgresatbnhqrs1 + $trgresatbnhqrs2;  ?></td>
            <td><?php $trgresatbnhqrs3 = info_fetch_osireport('SI','RECRUITMENT DUTY','awbone12');
            $trgresatbnhqrs4 = info_fetch_osireport('INSP/LR','RECRUITMENT DUTY','awbone12'); 
            $trgresatbnhqrs5 = info_fetch_osireport('INSP/CR','RECRUITMENT DUTY','awbone12'); 
            echo $trgresatbnhqrssi = $trgresatbnhqrs3 + $trgresatbnhqrs4 + $trgresatbnhqrs5;
              ?></td>
            <td><?php $trgresatbnhqrs6 = info_fetch_osireport('ASI,','RECRUITMENT DUTY','awbone12'); 
                $trgresatbnhqrs7 = info_fetch_osireport('SI/CR','RECRUITMENT DUTY','awbone12');  
                $trgresatbnhqrs8 = info_fetch_osireport('SI/LR','RECRUITMENT DUTY','awbone12'); 
                echo $trgresatbnhqrsasi =  $trgresatbnhqrs6 + $trgresatbnhqrs7 + $trgresatbnhqrs8; 

             ?></td>
            <td><?php $trgresatbnhqrs9 = info_fetch_osireport('HC','RECRUITMENT DUTY','awbone12');
                    $trgresatbnhqrs10 = info_fetch_osireport('ASI/LR','RECRUITMENT DUTY','awbone12');
                     $trgresatbnhqrs11 = info_fetch_osireport('ASI/CR','RECRUITMENT DUTY','awbone12');
             echo $trgresatbnhqrshc= $trgresatbnhqrs9 +  $trgresatbnhqrs10 + $trgresatbnhqrs11;  ?></td>
            <td><?php $trgresatbnhqrs12 = info_fetch_osireport('CT','RECRUITMENT DUTY','awbone12');
                       $trgresatbnhqrs13 = info_fetch_osireport('HC/PR','RECRUITMENT DUTY','awbone12');
                        $trgresatbnhqrs14 = info_fetch_osireport('HC/LR','RECRUITMENT DUTY','awbone12');
                         $trgresatbnhqrs15 = info_fetch_osireport('Sr.Const','RECRUITMENT DUTY','awbone12');
                         $trgresatbnhqrs16 = info_fetch_osireport('C-II','RECRUITMENT DUTY','awbone12');
    ...
    <tr>
            ...
            <td><?php echo $chroonlidutyinsp + $chroonlidutysi + $chroonlidutyasi + $chroonlidutyhc + $chroonlidutyct;  ?></td>
                 ...
                 <tr>
                  <td>ix)</td>
                  <td>OSD ETC.</td>
                   <td><?php $osdetc1 = info_fetch_osireport('INSP','OSD ETC','bmdone8'); 
                      $osdetc2 = info_fetch_osireport('DSP/CR','OSD ETC','bmdone8'); 
                      echo $osdetcinsp = $osdetc1 + $osdetc2;  ?></td>
            <td><?php $osdetc3 = info_fetch_osireport('SI','OSD ETC','bmdone8');
            $osdetc4 = info_fetch_osireport('INSP/LR','OSD ETC','bmdone8'); 
            $osdetc5 = info_fetch_osireport('INSP/CR','OSD ETC','bmdone8'); 
            echo $osdetcsi = $osdetc3 + $osdetc4 + $osdetc5;
              ?></td>
            <td><?php $osdetc6 = info_fetch_osireport('ASI','OSD ETC','bmdone8'); 
                $osdetc7 = info_fetch_osireport('SI/CR','OSD ETC','bmdone8');  
                $osdetc8 = info_fetch_osireport('SI/LR','OSD ETC','bmdone8'); 
                echo $osdetcasi=  $osdetc6 + $osdetc7 + $osdetc8; 

             ?></td>
            <td><?php $osdetc9 = info_fetch_osireport('HC','OSD ETC','bmdone8');
                    $osdetc10 = info_fetch_osireport('ASI/LR','OSD ETC','bmdone8');
                     $osdetc11 = info_fetch_osireport('ASI/CR','OSD ETC','bmdone8');
             echo $osdetchc = $osdetc9 +  $osdetc10 + $osdetc11;  ?></td>
            <td><?php $osdetc12 = info_fetch_osireport('CT','OSD ETC','bmdone8');
                       $osdetc13 = info_fetch_osireport('HC/PR','OSD ETC','bmdone8');
                        $osdetc14 = info_fetch_osireport('HC/LR','OSD ETC','bmdone8');
                         $osdetc15 = info_fetch_osireport('Sr.Const','OSD ETC','bmdone8');
                         $osdetc16 = info_fetch_osireport('C-II','OSD ETC','bmdone8');
              ...
              <tbody>
                <tr>
                  ...
                  <td width="586">PAP HQRS INSTITUTIONS</td>
                   ...
                   <td width="49"><?php $paphqrsinstitutions1 = info_fetch_osireports('INSP','','instone4'); 
                      $paphqrsinstitutions2 = info_fetch_osireports('DSP/CR','','instone4'); 
                      echo $paphqrsinstitutionsinsp= $paphqrsinstitutions1 + $paphqrsinstitutions2;  ?></td>
            <td width="52"><?php $paphqrsinstitutions3 = info_fetch_osireports('SI','','instone4');
            $paphqrsinstitutions4 = info_fetch_osireports('INSP/LR','','instone4'); 
            $paphqrsinstitutions5 = info_fetch_osireports('INSP/CR','','instone4'); 
            echo $paphqrsinstitutionssi = $paphqrsinstitutions3 + $paphqrsinstitutions4 + $paphqrsinstitutions5;
              ?></td>
            <td width="40"><?php $paphqrsinstitutions6 = info_fetch_osireports('ASI','','instone4'); 
                $paphqrsinstitutions7 = info_fetch_osireports('SI/CR','','instone4');  
                $paphqrsinstitutions8 = info_fetch_osireports('SI/LR','','instone4'); 
                echo $paphqrsinstitutionsasi =  $paphqrsinstitutions6 + $paphqrsinstitutions7 + $paphqrsinstitutions8; 

             ?></td>
            <td width="46"><?php $paphqrsinstitutions9 = info_fetch_osireports('HC','','instone4');
                    $paphqrsinstitutions10 = info_fetch_osireports('ASI/LR','','instone4');
                     $paphqrsinstitutions11 = info_fetch_osireports('ASI/CR','','instone4');
             echo $paphqrsinstitutionshc= $paphqrsinstitutions9 +  $paphqrsinstitutions10 + $paphqrsinstitutions11;  ?></td>
            <td width="41"><?php $paphqrsinstitutions12 = info_fetch_osireports('CT','','instone4');
                       $paphqrsinstitutions13 = info_fetch_osireports('HC/PR','','instone4');
                        $paphqrsinstitutions14 = info_fetch_osireports('HC/LR','','instone4');
                         $paphqrsinstitutions15 = info_fetch_osireports('Sr.Const','','instone4');
                         $paphqrsinstitutions16 = info_fetch_osireports('C-II','','instone4');
