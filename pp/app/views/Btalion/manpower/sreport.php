...
<body> <div class="row">
          ...
          <h2 class="text-center">Detail of Armed wing security cover provided to Serving Police Officers</h2>
           <?php $names = fetchinfoosi('seccover',array('status'=> 1,'tname' => 'Police Officer','bat_id' => $ninfo));  ?>
...
<td><?php echo $listng->address; ?></td>
  ...
  <?php $nlist =  fetchoneinfoall('seccover',array('name' => $listng->name,'bat_id' => $ninfo)); $nc = 0;  foreach ($nlist as $value){ $nc = $nc + 1; ?>
    <tr>
    <td><?php echo $nc.')'; ?></td>
    <td><table width="281" border="1"  class="table table-bordered">
      <tr>
 ...
 <h2 class="text-center">Detail of Armed wing security cover provided to Retired Police Officers</h2>
           <?php $names = fetchinfoosi('seccover',array('status'=> 1,'tname' => 'Retired Police Officer','bat_id' => $ninfo));  ?>
              <?php $count = 0;  foreach($names as $listng){ $count = $count+1; ?>
...
<table class="table table-bordered">
           ...
           <?php $names = fetchinfoosi('seccover',array('status'=> 1,'tname' => 'Political Persons','bat_id' => $ninfo));  ?>
              <?php $count = 0;   foreach($names as $listng){ $count = $count+1; ?>
              <table class="table table-bordered">
  <thead>
    <tr>
...
<td><?php echo $listng->address; ?></td>
    ...
    <tr> <td  colspan="5"><table class="table table-bordered">
           ...
           <?php $names = fetchinfoosi('seccover',array('status'=> 1,'tname' => 'Civil Officers','bat_id' => $ninfo));  ?>
              <?php $c = 0;  foreach($names as $listng){ $c = $c +1; ?>
              <table class="table table-bordered">
  <thead>
    <tr>
      <th> Sr.No.</th>
...
<td><?php echo $listng->address; ?></td>
    ...
    <tr> <td  colspan="5"><table class="table table-bordered">
           ...
           <?php $names = fetchinfoosi('seccover',array('status'=> 1,'tname' => 'Retired Civil Officer','bat_id' => $ninfo));  ?>
              <?php  $c = 0; foreach($names as $listng){ $c = $c + 1; ?>
              <table class="table table-bordered">
  <thead>
    <tr>
...
<td><?php echo $listng->address; ?></td>
    ...
    <tr> <td  colspan="5"><table class="table table-bordered">
           ...
           <?php $names = fetchinfoosi('seccover',array('status'=> 1,'tname' => 'Judicial Officers','bat_id' => $ninfo));  ?>
              <?php $c = 0; foreach($names as $listng){ $c = $c +1; ?>
              <table class="table table-bordered">
  <thead>
    <tr>
...
<td><?php echo $listng->address; ?></td>
    ...
    <tr> <td  colspan="5"><table class="table table-bordered">
           ...
           <?php $names = fetchinfoosi('seccover',array('status'=> 1,'tname' => 'Retired Judicial Officer','bat_id' => $ninfo));  ?>
              <?php $c = 0; foreach($names as $listng){ $c = $c + 1; ?>
              <table class="table table-bordered">
  <thead>
    <tr>
...
<td><?php echo $listng->address; ?></td>
    ...
    <tr> <td  colspan="5"><table class="table table-bordered">
      ...
      <h2 class="text-center">Detail of Armed wing security cover provided to Threatened Persons</h2>
           <?php $names = fetchinfoosi('seccover',array('status'=> 1,'tname' => 'Threatening persons','bat_id' => $ninfo));  ?>
              <?php $c = 0;  foreach($names as $listng){ $c = $c + 1; ?>
              <table class="table table-bordered">
  <thead>
    <tr>
...
<td><?php echo $listng->address; ?></td>
    ...
    <tr> <td  colspan="5"><table class="table table-bordered">
           ...
           <?php $names = fetchinfoosi('seccover',array('status'=> 1,'tname' => 'PERSONAL SECURITY STAFF ARMED WING OFFICER','bat_id' => $ninfo));  ?>
              <?php $c = 0; foreach($names as $listng){ $c = $c +1; ?>
              <table class="table table-bordered">
  <thead>
    <tr>
