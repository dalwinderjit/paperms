...
$bats = fetchoneinfo('users',array('users_id' => $user->bat_id)); echo $bats->nick; 
 ...
 <tr><td>7</td><td>House no.</td><td><?php echo $user->houseno; ?></td></tr>
 <tr><td>8</td><td>Street No.</td><td><?php echo $user->streetno; ?></td></tr>
 <tr><td>9</td><td>Ward No.</td><td><?php echo $user->wardno; ?></td></tr>
 <tr><td>10</td><td>Village/Mohalla</td><td><?php echo $user->villmohala; ?></td></tr>
 <tr><td>11</td><td>Post Office</td><td><?php echo $user->postoffice; ?></td></tr>
 <tr><td>12</td><td>Police Station</td><td><?php echo $user->policestation; ?></td></tr>
 <tr><td>13</td><td>Tehsil</td><td><?php echo $user->teshil; ?></td></tr>
 <tr><td>14</td><td>District</td><td><?php echo $user->district; ?></td></tr>
 <tr><td>15</td><td>State</td><td><?php echo $user->state; ?></td></tr>
 <tr><td><strong>Permanent Address </strong></td></tr>
 <tr><td>16</td><td>House no.</td><td><?php echo $user->phouse; ?></td></tr>
 <tr><td>17</td><td>Street No.</td><td><?php echo $user->pstreet; ?></td></tr>
 <tr><td>18</td><td>Ward No.</td><td><?php echo $user->pward; ?></td></tr>
 <tr><td>19</td><td>Village/Mohalla</td><td><?php echo $user->pvillmohala; ?></td></tr>
 <tr><td>20</td><td>Post Office</td><td><?php echo $user->ppostoffice; ?></td></tr>
 <tr><td>21</td><td>Police Station</td><td><?php echo $user->ppolicestation; ?></td></tr>
 <tr><td>22</td><td>Tehsil</td><td><?php echo $user->ptehsil; ?></td></tr>
 <tr><td>23</td><td>District</td><td><?php echo $user->pdistrict; ?></td></tr>
 <tr><td>24</td><td>State</td><td><?php echo $user->pstate; ?></td></tr>
...
<?php $dd =  date('d-m-Y',strtotime($user->dateofbith)); if($dd == '01-01-1970'){echo'-';}else{ echo $dd;} ?></td></tr>
 <tr><td>28</td><td>Caste</td><td><?php echo $user->caste; ?></td></tr>
 <tr><td>29</td><td>Category</td><td><?php echo $user->category; ?></td></tr>
 <tr><td>30</td><td>Phone1</td><td><?php echo $user->phono1; ?></td></tr>
 ...
 <tr><td>43</td><td>Educational Qualification</td><td><?php echo $user->eduqalification; ?></td></tr>
...
<?php $dde =  date('d-m-Y',strtotime($user->dateofinlitment)); if($dde == '01-01-1970'){echo'-';}else{ echo $dde;} ?></td></tr>
 <tr><td>48</td><td>Rank of Enlistment</td><td><?php echo $user->rankofenlistment.$user->eexrank.$user->eexrank.$user->eminirank.$user->eminirank.$user->emedirank; ?></td></tr>
...
<tr><td>86</td><td>Date Of Posting</td><td>
 ...
 <tr><td>87</td><td>Computer literate</td><td><?php echo $user->comlit; ?></td></tr>
        ...
        <tr><td colspan="3"><strong>Professional Courses (<?php $tr = explode('@', $user->TrainingInstitutessti); echo count($tr); ?>)</strong></td></tr>
