...
$DERABEAS = array('' => '--Select--', 'DERA BEAS SECURITY DUTY' => 'DERA BEAS SECURITY DUTY');
 ...
 ?>
                  ...
                  <div class="col-sm-9">
                 <?php  
$OTHERSTSTIC = array('' => '--Select--', 'OTHER STSTIC GUARDS' => 'OTHER STATIC GUARDS');
...
$ATTACHEDWITHDISTTMOHALI = array('' => '--Select--', 'AD GUARD CP JALL' => 'AD GUARD CP JALL', 'AD GUARD CP ASR' => 'AD GUARD CP ASR','AD GUARD DISTT MKT' => 'AD GUARD DISTT MKT','AD GUARD DISTT LDH' => 'AD GUARD DISTT LDH','AD GUARD DISTT BTL' => 'AD GUARD DISTT BTL');
 echo form_dropdown('paone22', $ATTACHEDWITHDISTTMOHALI, set_value('paone22',''),'id="ATTACHEDWITHDISTTMOHALI" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$ATTACHEDWITHDISTTPOLICEKINMALE = array('' => '--Select--', 'ATTACHED WITH DISTT. POLICE (MARTYR’S KIN MALE)' => 'ATTACHED WITH DISTT. POLICE (MARTYR’S KIN MALE)');
 ...
 ?>
              ...
              <div class="form-group" id="awdpmpod1" style="display: none;">
...
?>
          ...
          <div class="form-group" id="awdpmorno2" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Order No. </label>
                  <div class="col-sm-9">
                 <?php
...
?>
          ...
          <div class="form-group" id="awdpmordate2" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Order date </label>
                  <div class="col-sm-9">
                 <?php
...
$ATTACHEDWITHDISTTPOLICEKINFEMALE = array('' => '--Select--', 'ATTACHED WITH DISTT. POLICE (MARTYR’S KIN FEMALE)' => 'ATTACHED WITH DISTT. POLICE (MARTYR’S KIN FEMALE)');
 ...
 ?>
                    <label for="Postingtiset" class="error"></label>
                              ...
                              <div class="form-group" id="awdpfpod1" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Name of District </label>
                  <div class="col-sm-9">
                <?php
...
?>
          ...
          <div class="form-group" id="awdpforno2" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Order No. </label>
                  <div class="col-sm-9">
                 <?php
...
?>
          ...
          <div class="form-group" id="awdpfordate2" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Order date </label>
                  <div class="col-sm-9">
                 <?php
...
$ATTACHEDWITHDISTTPOLICEOTHERKINMALE = array('' => '--Select--', 'ATTACHED WITH DISTT. POLICE (OTHERS MALE)' => 'ATTACHED WITH DISTT. POLICE (OTHERS MALE)');
 ...
 ?>
                    <label for="Postingtiset" class="error"></label>
                                        ...
                                        <div class="form-group" id="awdpompod1" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Name of District </label>
                  <div class="col-sm-9">
                <?php
...
?>
          ...
          <div class="form-group" id="awdpomorno2" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Order No. </label>
                  <div class="col-sm-9">
                 <?php
...
?>
          ...
          <div class="form-group" id="awdpomordate2" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Order date </label>
                  <div class="col-sm-9">
                 <?php
...
$ATTACHEDWITHDISTTPOLICEOTHERKINFEMALE = array('' => '--Select--', 'ATTACHED WITH DISTT. POLICE (OTHERS FEMALE)' => 'ATTACHED WITH DISTT. POLICE (OTHERS FEMALE)');
 ...
 ?>
                    <label for="Postingtiset" class="error"></label>
                                        ...
                                        <div class="form-group" id="awdpofpod1" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Name of District </label>
                  <div class="col-sm-9">
                <?php
...
?>
          ...
          <div class="form-group" id="awdpoforno2" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Order No. </label>
                  <div class="col-sm-9">
                 <?php
...
?>
          ...
          <div class="form-group" id="awdpofordate2" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Order date </label>
                  <div class="col-sm-9">
                 <?php
...
<?php } ?>
          ...
          <div class="form-group" id="pssawonof1" style="display: none;">
...
?>
                    <label for="fx1" class="error"></label>
                      ...
                      <div class="form-group" id="pssaworank2" style="display: none;">
...
?>
          ...
          <div class="form-group" id="pssawoordate2" style="display: none;">
...
?>
                 ...
                 <div class="form-group" id="awbone10" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php  
$QUARTERMASTERBRANCHLINESTAFF = array('' => '--Select--', 'Reserve Inspector' => 'Reserve Inspector','Line Officer' => 'Line Officer','BHM & A/BHM' => 'BHM & A/BHM','MHC & A/MHC' => 'MHC & A/MHC','Orderly to RI' => 'Orderly to RI','CDI' => 'CDI','CDO & A/CDO' => 'CDO & A/CDO','Quarter Master INSP' => 'Quarter Master INSP','MSK Branch' => 'MSK Branch','KHC' => 'KHC','Armourer & A/Armourer' => 'Armourer & A/Armourer','I/C Class-IV' => 'I/C Class-IV','Quarter Munshi & Asstt.' => 'Quarter Munshi & Asstt.','I/C Canteen & Grossary Shop' => 'I/C Canteen & Grossary Shop');
...
$RECRUITMENTDUTY = array('' => '--Select--', 'RECRUITMENT DUTY' => 'RECRUITMENT DUTY');
 ...
 ?>
                ...
                <div class="form-group" id="recrutnorb1" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Name of Recruitment Board</label>
                  <div class="col-sm-9">
                 <?php
$recrutnorb = array('type' => 'text','name' => 'recrutnorb','id' => 'recrutnorb','class' => 'form-control','placeholder' =>'Name of Recruitment Board','value' => $info->recrutnorb);
...
$ChronicDiseaseonMedicalResti = array('' => '--Select--', 'Chronic Disease on light duty' => 'Chronic Disease on light duty');
 echo form_dropdown('bmdone8', $ChronicDiseaseonMedicalResti, set_value('bmdone8',''),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$ChronicDiseaseonMedicalRest = array('' => '--Select--', 'Chronic Disease on Medical Rest' => 'Chronic Disease on Medical Rest');
 echo form_dropdown('bmdone7', $ChronicDiseaseonMedicalRest, set_value('bmdone7',$info->bmdone7),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$OSDETC = array('' => '--Select--', 'OSD ETC' => 'OSD ETC');
 echo form_dropdown('bmdone8', $OSDETC, set_value('bmdone8',$info->bmdone8),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('bmdone8');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
?>
                  ...
                  <div class="col-sm-9">
                <?php
$dsopod = array('type' => 'text','name' => 'classf1','id' => 'dsopod','class' => 'form-control','placeholder' =>'Place Of Posting','value' => $info->cfpop);
echo form_input($dsopod);
...
?>
          ...
          <div class="form-group" id="classf2" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Present duty </label>
                  <div class="col-sm-9">
                 <?php
$dsoorno = array('type' => 'text','name' => 'classf2','id' => 'dsoorno','class' => 'form-control','placeholder' =>'Present duty','value' => $info->cfppd);
echo form_input($dsoorno);
...
jQuery('#dateofposting1').datepicker({dateFormat: "dd/mm/yy"});
  ...
  $(document).on('change', '#awbone4', function() {
   ...
   } else if(this.value == 'Asstt. Commandant office'){
  ...
  if(this.value == 'Fix Duties'){
    $('#dofposting1').show();
     ...
     $('#paone1,#paone2,#paone3,#paone4,#paone5,#paone6,#paone7,#paone8,#paone9,#paone10,#paone11,#paone12,#paone13,#paone14,#paone15,#paone16,#paone17,#paone18,#paone19,#paone20,#paone21,#paone22,#paone23,#paone24,#paone25,#paone26,#temcov').hide();
    ...
    $('#dofposting1').show();
    $('#fone1,#fone2,#fone3,#fone4,#fone5,#fone6,#fone7,#fone8,#fone9,#fone10,#fone11,#fone12,#fone10,#fone11,#fone12,#fone13,#fone14,#fone15,#fone16,#fone17,#fone18,#fone19,#fone20,#fone21,#fone22,#seccover').hide();
    ...
    $('#lone1,#lone2,#lone3').hide();
    $('#sqone1,#sqone2,#sqone3,#sqone4,#sqone5,#sqone6').hide();
    $('#paone1,#paone2,#paone3,#paone4,#paone5,#paone6,#paone7,#paone8,#paone9,#paone10,#paone11,#paone12,#paone13,#paone14,#paone15,#paone16,#paone17,#paone18,#paone19,#paone20,#paone21,#paone22,#paone23,#paone24,#paone25,#paone26,#temcov').show();
    ...
    $('#bastraing1,#bastraing2,#bastraing3,#bastraing4,#bastraing5,#bastraing6,#bastraing7,#bastraing8,#bastraing9,#bastraing10').show();
     $('#vploc1,#vpdis1,#noj1,#jsdis2,#osgloc1,#osgdis2,#bsdnob1,#bsddis2,#bsdloc2').hide();
      ...
      $('#leavefrom2,#leaveto2,#absentfrom1,#absentddr2,#Date2,#usdos2,#usros2').hide();
      $('#instone1,#instone2,#instone3,#instone4,#instone5,#instone6').hide();
        $('#fone1,#fone2,#fone3,#fone4,#fone5,#fone6,#fone7,#fone8,#fone9,#fone10,#fone11,#fone12,#fone13,#fone14,#fone15,#fone16,#fone17,#fone18,#fone19,#fone20,#fone21,#fone22,#seccover').hide();
    $('#lone1,#lone2,#lone3').hide();
    $('#sqone1,#sqone2,#sqone3,#sqone4,#sqone5,#sqone6').hide();
    $('#paone1,#paone2,#paone3,#paone4,#paone5,#paone6,#paone7,#paone8,#paone9,#paone10,#paone11,#paone12,#paone13,#paone14,#paone15,#paone16,#paone17,#paone18,#paone19,#paone20,#paone21,#paone22,#paone23,#paone24,#paone25,#paone26').hide();
    $('#ssone23,#ssone24,#ssone25,#ssone26').hide();
    $('#awbone1,#awbone2,#awbone3,#awbone4,#awbone5,#awbone6,#awbone7,#awbone8,#awbone9,#awbone10,#awbone11,#awbone12,#awbone13,#awbone14').hide();
    $('#bmdone1,#bmdone2,#bmdone3,#bmdone4,#bmdone5,#bmdone6,#bmdone7,#bmdone8,#bmdone9,#bmdone10').hide();
    $('#instone1,#instone2,#instone3,#instone4,#instone5,#instone6').hide();
