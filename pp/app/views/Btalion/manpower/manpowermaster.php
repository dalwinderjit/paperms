...
?>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-9">
                  <?php 
                    $nat = array('Select' => '--Nationality--','--Nationality--','Indian'=>'Indian','Nepal' => 'Nepal');
                  ?>
                 <?php  
/*newarea Textfield*/
...
/*----End newarea Textfield----*/
 ?>
                ...
                <div class="form-group">
                 <label class="col-sm-3 control-label">Date of birth (YYYY-DD-MM)</label>
                  <div class="col-sm-9">
...
?>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                 <?php
$dateofesnlistment1 = array('type' => 'text','name' => 'dateofesnlistment1','id' => 'dateofesnlistment1','class' => 'form-control','placeholder' =>'Date of Enlistment (YYYY-MM-DD)','value' => set_value('dateofesnlistment1'));
...
$eor = array('' => '--Select--', 'Executive Staff' => 'Executive Staff', 'Ministerial Staff' => 'Ministerial Staff', 'Medical Staff' => 'Medical Staff', 'Class-IV (P)' => 'Class-IV (P)', 'Class-IV (C)' => 'Class-IV (C)');
 ...
 ?>
                ...
                <div class="form-group" id="eors1" style="display: none;">
                  ...
                  <div class="col-sm-9">
            <?php  
$eor1 = array('' => '--Select--', 'CT' => 'CT', 'Sr.Const' => 'Sr. Const', 'C-II' => 'C-II', 'HC/PR' => 'HC/PR', 'HC' => 'HC', 'HC/LR' => 'HC/LR','HC/CR' => 'HC/CR', 'ASI/LR' => 'ASI/LR','ASI/CR' => 'ASI/CR',  'ASI' => 'ASI', 'SI/CR' => 'SI/CR','SI/LR' => 'SI/LR', 'SI' => 'SI', 'INSP/CR' => 'INSP/CR','INSP/LR' => 'INSP/LR', 'INSP' => 'INSP', 'DSP/CR' =>'DSP/CR','DSP' =>'DSP','AIG' => 'AIG','SP/CR' => 'SP/CR', 'SP' => 'SP','Asst. Commandant' =>'Asst. Commandant','Commandant' => 'Commandant');
 ...
 ?>
                 ...
                 <div class="form-group" id="eors2"  style="display: none;">
                  ...
                  <div class="col-sm-9">
            <?php  
$eor2 = array('' => '--Select--', 'Senior Asstt.' => 'Senior Asstt.', 'Junior Asstt.' => 'Junior Asstt.', 'Junior Scale Stenographer' => 'Junior Scale Stenographer', 'Senior Scale Stenographer' => 'Senior Scale Stenographer', 'Clerk' => 'Clerk', 'Peon' => 'Peon', 'Daftari' => 'Daftari','Supdt Grade-I' => 'Supdt Grade-I','SubSupdt Grade-II' => 'Supdt Grade-II');
...
$eor3 = array('' => '--Select--', 'Doctor' => 'Doctor', 'Pharmacist' => 'Pharmacist', 'Physiotherapist' => 'Physiotherapist', 'Lab Technician' => 'Lab Technician', 'Nursing Asstt.' => 'Nursing Asstt.');
 ...
 ?>
                ...
                <div class="form-group" id="eors4"  style="display: none;">
                  ...
                  <div class="col-sm-9">
            <?php  
$eor4 = array('' => '--Select--', 'Cook' => 'Cook', 'Water Carrier' => 'Water Carrier', 'Sweeper' => 'Sweeper', 'Dhobi' => 'Dhobi', 'Mochi' => 'Mochi', 'Barber' => 'Barber', 'Tailor' => 'Tailor', 'Carpenter' => 'Carpenter','Mason' => 'Mason','Mali' => 'Mali','Mechanic' => 'Mechanic', 'Electrician' => 'Electrician', 'Painter' => 'Painter','Syce' => 'Syce');
 ...
 ?>
                  ...
                  <div class="col-sm-9">
            <?php  
$eor5 = array('' => '--Select--', 'Cook' => 'Cook', 'Water Carrier' => 'Water Carrier', 'Sweeper' => 'Sweeper', 'Dhobi' => 'Dhobi', 'Mochi' => 'Mochi', 'Barber' => 'Barber', 'Tailor' => 'Tailor', 'Carpenter' => 'Carpenter','Mason' => 'Mason','Mali' => 'Mali', 'Electrician' => 'Electrician', 'Painter' => 'Painter','Syce' => 'Syce');
...
?>
              ...
              ?>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
<?php
$DateofRetirementdor = array('type' => 'text','name' => 'DateofRetirementdor','id' => 'DateofRetirementdor','class' => 'form-control','placeholder' =>'Date of Retirement (YYYY-MM-DD)','value' => set_value('DateofRetirementdor'));
...
Extension Retirement Date (YYYY-MM-DD)','value' => set_value('DateofRetirementdori'));
echo form_input($DateofRetirementdor);
echo form_error('DateofRetirementdor');
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
</div>
...
?>
              ...
              <?php 
                ...
                <?php  
                /*newarea Textfield*/
                echo form_dropdown('bunitdistrict', $state, set_value('bunitdistrict',''),'id="bunitdistrict" data-placeholder="Choose One" title="Please select at least 1 area" class="select2"'); 
                echo form_error('state');
                /*----End newarea Textfield----*/
              ?>
                    <label for="gpfPRAN" class="error"></label>
...
$Medical = array('' => '--Select--', 'Doctor' => 'Doctor', 'Pharmacist' => 'Pharmacist', 'Physiotherapist' => 'Physiotherapist', 'Lab Technician' => 'Lab Technician', 'Nursing Asstt.' => 'Nursing Asstt.');
 ...
 ?>
                ...
                <div class="form-group" id="cl4"  style="display: none;">
                  ...
                  <div class="col-sm-9">
            <?php  
$cf1 = array('' => '--Select--', 'Cook' => 'Cook', 'Water Carrier' => 'Water Carrier', 'Sweeper' => 'Sweeper', 'Dhobi' => 'Dhobi', 'Mochi' => 'Mochi', 'Barber' => 'Barber', 'Tailor' => 'Tailor', 'Carpenter' => 'Carpenter','Mason' => 'Mason','Mali' => 'Mali','Syce' => 'Syce');
 ...
 ?>
                  ...
                  <div class="col-sm-9">
            <?php  
$cf2 = array('' => '--Select--', 'Cook' => 'Cook', 'Water Carrier' => 'Water Carrier', 'Sweeper' => 'Sweeper', 'Dhobi' => 'Dhobi', 'Mochi' => 'Mochi', 'Barber' => 'Barber', 'Tailor' => 'Tailor', 'Carpenter' => 'Carpenter','Mason' => 'Mason','Mali' => 'Mali','Syce' => 'Syce');
...
$TrainingInstitutessti = array('' => '--Select--',  'RTC' => 'RTC','ISTC' => 'ISTC','CTC BHG' =>'CTC BHG', 'PPA Phillaur' =>'PPA Phillaur', 'PRTC Jahankhelan' => 'PRTC Jahankhelan', 'Ladda Kothi Sangrur' => 'Ladda Kothi Sangrur','PAP Computer Cell' => 'PAP Computer Cell','Other' => 'Other');
 echo form_dropdown('TrainingInstitutessti[]', $TrainingInstitutessti, set_value('TrainingInstitutessti',''),'id="TrainingInstitutessti"  data-placeholder="Choose One" title="Please select at least 1 area" class="form-control"'); 
...
?>
                  ...
                  <div class="col-sm-9">
<?php
$DurationsofsCourses = array('type' => 'text','name' => 'DurationsofsCourses[]','id' => 'tags2','class' => 'form-control','placeholder' =>'From','value' => set_value('DurationsofsCourses'));
...
?>
                ...
                <div class="form-group" >
                 <label class="col-sm-3 control-label">Duration of Course End date</label>
                   <div class="col-xs-9">
<?php
$DurationsofsCoursest = array('type' => 'text','name' => 'DurationsofsCoursest[]','id' => 'tags3','class' => 'form-control','placeholder' =>'To','value' => set_value('DurationsofsCoursest'));
