...
$gPostingtiset = array('' => '--Select--', 'Accupressure' => 'Accupressure', 'Archery' => 'Archery', 'Archery Women' => 'Archery Women','Astro Turf Groun' => 'Astro Turf Groun','Athletic' => 'Athletic','Athletic Women' => 'Athletic Women','Basketball' => 'Basketball','Basketball Women' => 'Basketball Women','Body Building' => 'Body Building','Boxing' => 'Boxing','Boxing Women' => 'Boxing Women','Cycling' => 'Cycling','DSO Coach' => 'DSO Coach','Equestrian' => 'Equestrian','Football' => 'Football','GYM' => 'GYM','Gymnastics' => 'Gymnastics','Gymnastics Women' => 'Gymnastics Women','Handball' => 'Handball','Handball Women' => 'Handball Women','Hockey' => 'Hockey','Indoor Stadium' => 'Indoor Stadium','Judo' => 'Judo','Judo Women' => 'Judo Women','Kabaddi' => 'Kabaddi','Kabaddi Women' => 'Kabaddi Women','Motor Cyclist' => 'Motor Cyclist','Netball' => 'Netball','Office' => 'Office','Power Lifting' => 'Power Lifting','Rowing' => 'Rowing','Rowing Women' => 'Rowing Women','Shooting' => 'Shooting','Shooting Women' => 'Shooting Women','Sports Cafe' => 'Sports Cafe','Swimming' => 'Swimming','Taekwondo' => 'Taekwondo','Volleyball' => 'Volleyball','Women Hostel' => 'Women Hostel','Wrestling F/S' => 'Wrestling F/S','Wrestling G/R' => 'Wrestling G/R','Wrestling Women' =>'Wrestling Women', 'Wtlifting' => 'Wtlifting','Wtlifting Women' => 'Wtlifting Women','Wushu' => 'Wushu','Yoga' => 'Yoga','Yoga Women' => 'Yoga Women');
 echo form_dropdown('gPostingtiset', $gPostingtiset, set_value('gPostingtiset',$info->game),'id="gPostingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$vpgurds = array('' => '--Select--', 'VP Guards' => 'VP Guards');
 echo form_dropdown('fone1', $vpgurds, set_value('fone1',$info->fone1),'id="vpgurds" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
            ...
            <div class="form-group" id="vploc1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                <?php
$vploc = array('type' => 'text','name' => 'vploc','id' => 'vploc','class' => 'form-control','placeholder' =>'Location','value' => $info->vploc);
...
?>
          ...
          <div class="form-group" id="vpdis1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$vpdis = array('type' => 'text','name' => 'vpdis','id' => 'vpdis','class' => 'form-control','placeholder' =>'District','value' => $info->vpdis);
...
$Jails = array('' => '--Select--', 'Jails Security' => 'Jails Security');
 echo form_dropdown('fone2', $Jails, set_value('fone2',$info->fone2),'id="Jails" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
            ...
            <div class="form-group" id="noj1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                <?php
$noj = array('type' => 'text','name' => 'noj','id' => 'noj','class' => 'form-control','placeholder' =>'Name of jail','value' => $info->noj);
echo form_input($noj);
echo form_error('noj');
?>
                    <label for="fx1" class="error"></label>
          ...
          <div class="form-group" id="jsdis2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$jsdis = array('type' => 'text','name' => 'jsdis','id' => 'jsdis','class' => 'form-control','placeholder' =>'District','value' => $info->jsdis);
...
$pphqsec = array('' => '--Select--', 'Punjab Police HQRS,SEC.9,CHG' => 'Punjab Police HQRS,SEC.9,CHG');
 echo form_dropdown('fone3', $pphqsec, set_value('fone3',$info->fone3),'id="pphqsec" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
$DERABEAS = array('' => '--Select--', 'DERA BEAS SECURITY DUTY' => 'DERA BEAS SECURITY DUTY');
 echo form_dropdown('fone4', $DERABEAS, set_value('fone4',$info->fone4),'id="DERABEAS" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$OTHERSTSTIC = array('' => '--Select--', 'OTHER STATIC GUARDS' => 'OTHER STATIC GUARDS');
 echo form_dropdown('fone5', $OTHERSTSTIC, set_value('fone5',$info->fone5),'id="OTHERSTSTIC" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                  ...
                  <div class="col-sm-9">
                <?php
$osgloc = array('type' => 'text','name' => 'osgloc','id' => 'osgloc','class' => 'form-control','placeholder' =>'Location','value' => $info->osgloc);
...
?>
          ...
          <div class="form-group" id="osgdis2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$osgdis = array('type' => 'text','name' => 'osgdis','id' => 'osgdis','class' => 'form-control','placeholder' =>'District','value' => $info->osgdis);
...
$PSOSGUNMAN  = array('' => '--Select--', 'Police Officer' => 'Police Officer', 'Retired Police Officer' => 'Retired Police Officer', 'Political Persons' => 'Political Persons','Civil Officers' => 'Civil Officers','Judicial Officers' => 'Judicial Officers','Threatening persons' => 'Threatening persons','PERSONAL SECURITY STAFF ARMED WING OFFICER' => 'PERSONAL SECURITY STAFF ARMED WING OFFICER');
 echo form_dropdown('fone6', $PSOSGUNMAN, set_value('fone6',$info->fone6),'id="PSOSGUNMAN" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('fone6');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
                </div>
<?php $bats = fetchoneinfo('seccover',array('man_id' => $id)); 
  if($bats !=''){ 
  ?>
                 ...
                 <div class="form-group" id="fone13" style="display: none;">
                  ...
                  <div class="col-sm-9">
<?php
$name = array('type' => 'text','name' => 'scname','id' => 'name','class' => 'form-control','placeholder' =>'Name','value' => $bats->name);
...
$RankRankre = array('' => '--Select--', 'DGP' => 'DGP', 'ADGP' => 'ADGP', 'IGP' => 'IGP', 'DIG' => 'DIG', 'AIG' => 'AIG', 'SSP' => 'SSP','SP' => 'SP',  'DSP' => 'DSP','INSPR' => 'INSPR');
 echo form_dropdown('scrank', $RankRankre, set_value('scrank',$bats->rank),'id="RankRankrei" data-placeholder="Choose One" class="select2"'); 
 ...
 ?>
                  ...
                  <div class="col-sm-9">
           <?php
$des = array('type' => 'text','name' => 'scdes','id' => 'des','class' => 'form-control','placeholder' =>'Designation','value' => $bats->des);
echo form_input($des);
...
?>
                  ...
                  <div class="col-sm-9">
<?php
$pop = array('type' => 'text','name' => 'scpop','id' => 'pop','class' => 'form-control','placeholder' =>'Place of Posting','value' => $bats->placeofposting);
echo form_input($pop);
...
?>
                ...
                <div class="form-group" id="fone17" style="display: none;">
                  ...
                  <div class="col-sm-9">
<?php
$address = array('type' => 'text','name' => 'scaddress','id' => 'address','class' => 'form-control','placeholder' =>'Address','value' => $bats->address);
...
?>
                  ...
                  <div class="col-sm-9">
<?php
$mob = array('type' => 'text','name' => 'scmob','id' => 'mob','class' => 'form-control','placeholder' =>'Mobile','value' => $bats->mobile);
echo form_input($mob);
echo form_error('mob');
?>
...
$nod = array('' => '--Select--','Gunman' => 'Gunman','Driver' => 'Driver', 'Reader' => 'Reader', 'Guard' => 'Guard', 'PSO' => 'PSO','Office Orderly' => 'Office Orderly','Dak Runner' => 'Dak Runner','Escort' => 'Escort','Telphone operator' => 'Telphone operator','Leave Reserve' => 'Leave Reserve','Anti sabotage Team' => 'Anti sabotage Team','Admn. Staff' => 'Admn. Staff');
 echo form_dropdown('scnod', $nod, set_value('scnod',$bats->nod),'id="nod" data-placeholder="Choose One" class="select2"'); 
 echo form_error('nod');
?>
                    <label for="sno" class="error"></label>
                  </div>
 ...
 <div class="form-group" id="fone20" style="display: none;">
                  ...
                  <div class="col-sm-9">
<?php
$oby = array('type' => 'text','name' => 'scoby','id' => 'oby','class' => 'form-control','placeholder' =>'Order By','value' => $bats->orderby);
echo form_input($oby);
echo form_error('oby');
?>
                 ...
                 <div class="form-group" id="fone21" style="display: none;">
                  ...
                  <div class="col-sm-9">
<?php
$ono = array('type' => 'text','name' => 'scono','id' => 'ono','class' => 'form-control','placeholder' =>'Order No','value' => $bats->orderno);
echo form_input($ono);
echo form_error('ono');
?>
                 ...
                 <div class="form-group" id="fone22" style="display: none;">
                  ...
                  <div class="col-sm-9">
<?php
$odate = array('type' => 'text','name' => 'scodate','id' => 'odate','class' => 'form-control','placeholder' =>'Order Date','value' => $bats->order_date);
...
?>
 ...
 <div class="form-group" id="fone19" style="display: none;">
                  ...
                  <div class="col-sm-9">
<?php
$nod = array('' => '--Select--','Gunman' => 'Gunman','Driver' => 'Driver', 'Reader' => 'Reader', 'Guard' => 'Guard', 'PSO' => 'PSO','Office Orderly' => 'Office Orderly','Dak Runner' => 'Dak Runner','Escort' => 'Escort','Telphone operator' => 'Telphone operator','Leave Reserve' => 'Leave Reserve','Anti sabotage Team' => 'Anti sabotage Team');
...
$VIPSEC = array('' => '--Select--', 'VIP SEC.WING CHG.U/82nd BN.' => 'VIP SEC.WING CHG.U/82nd BN.');
 echo form_dropdown('fone7', $VIPSEC, set_value('fone7',$info->fone7),'id="VIPSEC" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$POLICESECWING = array('' => '--Select--', 'POLICE SEC.WING CHG U/13th BN.' => 'POLICE SEC.WING CHG U/13th BN.');
 echo form_dropdown('fone8', $POLICESECWING, set_value('fone8',$info->fone8),'id="POLICESECWING" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
$BANKSECURITYDUTY  = array('' => '--Select--', 'BANK SECURITY DUTY' => 'BANK SECURITY DUTY');
 echo form_dropdown('fone9', $BANKSECURITYDUTY, set_value('fone9',$info->fone9),'id="BANKSECURITYDUTY" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
                  ...
                  <div class="col-sm-9">
                <?php
$bsdnob = array('type' => 'text','name' => 'bsdnob','id' => 'bsdnob','class' => 'form-control','placeholder' =>'Name of Bank','value' => $info->bsdnob);
...
?>
                 ...
                 <div class="form-group" id="bsddis2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$jsdis = array('type' => 'text','name' => 'bsddis','id' => 'bsddis','class' => 'form-control','placeholder' =>'District','value' => $info->bsddis);
echo form_input($jsdis);
echo form_error('jsdis');
?>
                    <label for="fx1" class="error"></label>
          ...
          <div class="form-group" id="bsdloc2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$bsdloc = array('type' => 'text','name' => 'bsdloc','id' => 'bsdloc','class' => 'form-control','placeholder' =>'Location','value' => $info->bsdloc);
...
$SPECIALPROTECTIONUNIT = array('' => '--Select--', 'SPECIAL PROTECTION UNIT (C.M. SEC.)' => 'SPECIAL PROTECTION UNIT (C.M. SEC.)');
 echo form_dropdown('fone10', $SPECIALPROTECTIONUNIT, set_value('fone10',$info->fone10),'id="SPECIALPROTECTIONUNIT" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
  ...
  <?php $batsio = fetchoneinfo('tcover',array('man_id' => $id)); 
  if($batsio !='' /*&& $info->paone1 !='' || $info->paone2 !='' || $info->paone3 !='' || $info->paone4 !='' || $info->paone5 !='' ||$info->paone6 !='' ||$info->paone7 !='' ||$info->paone6 !='' ||$info->paone8 !='' ||$info->paone9 !='' ||$info->paone10 !='' ||$info->paone11 !='' ||$info->paone12 !='' ||$info->paone13 !='' ||$info->paone14 !='' ||$info->paone15 !='' ||$info->paone16 !='' ||$info->paone17 !='' ||$info->paone18 !='' ||$info->paone19 !='' || $info->paone20 !='' || $info->paone21 !='' $info->paone27 !=''*/){ 
  ?>
                ...
                <div class="form-group"  id="spuoderny"  style="display: none;">
                              ...
                              <div class="col-sm-9">
            <?php
            $oby = array('type' => 'text','name' => 'spuoderny','id' => 'tcoby','class' => 'form-control','placeholder' =>'Order By','value' => $batsio->orderby);
            echo form_input($oby);
            echo form_error('oby');
            ?>
                                <label for="oby" class="error"></label>
                 ...
                 <div class="form-group"  id="spuodernyno"  style="display: none;">
                  ...
                  <div class="col-sm-9">
<?php
$ono = array('type' => 'text','name' => 'spuodernyno','id' => 'tcono','class' => 'form-control','placeholder' =>'Order No','value' => $batsio->orderno);
echo form_input($ono);
echo form_error('ono');
?>
                    <label for="ono" class="error"></label>
                 ...
                 <div class="form-group"  id="spuodernyod"  style="display: none;">
                  ...
                  <div class="col-sm-9">
<?php
$odate = array('type' => 'text','name' => 'spuodernyod','id' => 'odate','class' => 'form-control','placeholder' =>'Order Date','value' => $batsio->orderdate);
echo form_input($odate);
...
$PBBHAWANNEWDELHI = array('' => '--Select--', 'PB. BHAWAN NEW DELHI (SEC. DUTY)' => 'PB. BHAWAN NEW DELHI (SEC. DUTY)');
 echo form_dropdown('fone11', $PBBHAWANNEWDELHI, set_value('fone11',$info->fone11),'id="PBBHAWANNEWDELHI" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$PBBHAWANNEWDELHIr = array('' => '--Select--', 'PB. BHAWAN NEW DELHI (RESERVE)' => 'PB. BHAWAN NEW DELHI (RESERVE)');
 echo form_dropdown('fone12', $PBBHAWANNEWDELHIr, set_value('fone12',$info->fone12),'id="PBBHAWANNEWDELHIr" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$PERMANENTDUTY = array('' => '--Select--', 'PERMANENT DUTY' => 'PERMANENT DUTY');
 echo form_dropdown('lone1', $PERMANENTDUTY, set_value('lone1',$info->lone1),'id="PERMANENTDUTY" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
                  ...
                  <div class="col-sm-9">
                <?php
$perdupod = array('type' => 'text','name' => 'perdupod','id' => 'perdupod','class' => 'form-control','placeholder' =>'Place of duty','value' => $info->perdupod);
...
?>
                 ...
                 <div class="form-group" id="perdudis2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$perdudis = array('type' => 'text','name' => 'perdudis','id' => 'perdudis','class' => 'form-control','placeholder' =>'District','value' => $info->perdudis);
...
?>
          ...
          <div class="form-group" id="perduorno2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$perduorno = array('type' => 'text','name' => 'perduorno','id' => 'perduorno','class' => 'form-control','placeholder' =>'Order No.','value' => $info->perduorno);
...
?>
          ...
          <div class="form-group" id="perduordate2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$perduordate = array('type' => 'text','name' => 'perduordate','id' => 'perduordate','class' => 'form-control','placeholder' =>'Order date','value' => $info->perduordate);
...
$DGPRESERVES = array('' => '--Select--', 'DGP, RESERVES' => 'DGP, RESERVES');
 echo form_dropdown('lone2', $DGPRESERVES, set_value('lone2',$info->lone2),'id="DGPRESERVES" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
               ...
               <div class="form-group" id="dgppod1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                <?php
$dgppod = array('type' => 'text','name' => 'dgppod','id' => 'dgppod','class' => 'form-control','placeholder' =>'Place of duty','value' => $info->dgppod);
...
?>
                 ...
                 <div class="form-group" id="dgpdis2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$dgpdis = array('type' => 'text','name' => 'dgpdis','id' => 'dgpdis','class' => 'form-control','placeholder' =>'District','value' => $info->dgpdis);
...
?>
          ...
          <div class="form-group" id="dgporno2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$dgporno = array('type' => 'text','name' => 'dgporno','id' => 'dgporno','class' => 'form-control','placeholder' =>'Order No.','value' => $info->dgporno);
...
?>
          ...
          <div class="form-group" id="dgpordate2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$dgpordate = array('type' => 'text','name' => 'dgpordate','id' => 'dgpordate','class' => 'form-control','placeholder' =>'Order date','value' => $info->dgpordate);
...
$TRAININGEMERGENCY = array('' => '--Select--', 'TRAINING /EMERGENCY RESERVE FOR TEMP. DUTY' => 'TRAINING /EMERGENCY RESERVE FOR TEMP. DUTY');
 echo form_dropdown('lone3', $TRAININGEMERGENCY, set_value('lone3',$info->lone3),'id="TRAININGEMERGENCY" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
                  ...
                  <div class="col-sm-9">
                <?php
$tertdpod = array('type' => 'text','name' => 'tertdpod','id' => 'tertdpod','class' => 'form-control','placeholder' =>'Place of duty','value' => $info->tertdpod);
...
?>
                 ...
                 <div class="form-group" id="tertddis2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$tertddis = array('type' => 'text','name' => 'tertddis','id' => 'tertddis','class' => 'form-control','placeholder' =>'District','value' => $info->tertddis);
...
?>
          ...
          <div class="form-group" id="tertdorno2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$tertdorno = array('type' => 'text','name' => 'tertdorno','id' => 'tertdorno','class' => 'form-control','placeholder' =>'Order No.','value' => $info->tertdorno);
...
?>
          ...
          <div class="form-group" id="tertdordate2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$tertdordate = array('type' => 'text','name' => 'tertdordate','id' => 'tertdordate','class' => 'form-control','placeholder' =>'Order date','value' => $info->tertdordate);
...
$ANTIRIOTPOLICEJAL = array('' => '--Select--', 'ANTI RIOT POLICE, JALANDHAR' => 'ANTI RIOT POLICE, JALANDHAR');
 echo form_dropdown('sqone1', $ANTIRIOTPOLICEJAL, set_value('sqone1',$info->sqone1),'id="ANTIRIOTPOLICEJAL" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('ss1');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
$ANTIRIOTPOLICEMANSA = array('' => '--Select--', 'ANTI RIOT POLICE, MANSA' => 'ANTI RIOT POLICE, MANSA');
 echo form_dropdown('sqone2', $ANTIRIOTPOLICEMANSA, set_value('sqone2',$info->sqone2),'id="ANTIRIOTPOLICEMANSA" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$ANTIRIOTPOLICEMUKATSAR = array('' => '--Select--', 'ANTI RIOT POLICE, MUKATSAR' => 'ANTI RIOT POLICE, MUKATSAR');
 echo form_dropdown('sqone3', $ANTIRIOTPOLICEMUKATSAR, set_value('sqone3',$info->sqone3),'id="ANTIRIOTPOLICEMUKATSAR" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$SDRFTEAM = array('' => '--Select--', 'S.D.R.F. TEAM, JALANDHAR' => 'S.D.R.F. TEAM, JALANDHAR');
 echo form_dropdown('sqone4', $SDRFTEAM, set_value('sqone4',$info->sqone4),'id="SDRFTEAM" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$SPLSTRIKING = array('' => '--Select--', 'SPL. STRIKING GROUPS' => 'SPL. STRIKING GROUPS');
 echo form_dropdown('sqone5', $SPLSTRIKING, set_value('sqone5',$info->sqone5),'id="SPLSTRIKING" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
           ...
           <div class="form-group" id="sstgpod1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                <?php
$sstgpod = array('type' => 'text','name' => 'sstgpod','id' => 'sstgpod','class' => 'form-control','placeholder' =>'Place of duty','value' => $info->sstgpod);
...
?>
                 ...
                 <div class="form-group" id="sstgdis2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$sstgdis = array('type' => 'text','name' => 'sstgdis','id' => 'sstgdis','class' => 'form-control','placeholder' =>'District','value' => $info->sstgdis);
...
?>
          ...
          <div class="form-group" id="sstgorno2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$sstgorno = array('type' => 'text','name' => 'sstgorno','id' => 'sstgorno','class' => 'form-control','placeholder' =>'Order No.','value' => $info->sstgorno);
...
?>
          ...
          <div class="form-group" id="sstgordate2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$sstgordate = array('type' => 'text','name' => 'sstgordate','id' => 'sstgordate','class' => 'form-control','placeholder' =>'Order date','value' => $info->sstgordate);
...
$SWATTEAM = array('' => '--Select--', 'SWAT TEAM (4TH CDO)' => 'SWAT TEAM (4TH CDO)');
 echo form_dropdown('sqone6', $SWATTEAM, set_value('sqone6',$info->sqone6),'id="SWATTEAM" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
                  ...
                  <div class="col-sm-9">
                <?php
$swatpod = array('type' => 'text','name' => 'swatpod','id' => 'swatpod','class' => 'form-control','placeholder' =>'Place of duty','value' => $info->swatpod);
...
?>
                 ...
                 <div class="form-group" id="swatdis2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$swatdis = array('type' => 'text','name' => 'swatdis','id' => 'swatdis','class' => 'form-control','placeholder' =>'District','value' => $info->swatdis);
...
?>
          ...
          <div class="form-group" id="swatorno2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$swatorno = array('type' => 'text','name' => 'swatorno','id' => 'swatorno','class' => 'form-control','placeholder' =>'Order No.','value' => $info->swatorno);
...
?>
          ...
          <div class="form-group" id="swatordate2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$swatordate = array('type' => 'text','name' => 'swatordate','id' => 'swatordate','class' => 'form-control','placeholder' =>'Order date','value' => $info->swatordate);
...
$SWATTEAM = array('' => '--Select--', 'SOG BHG.,PTL(SPECIAL OPS.GROUP)' => 'SOG BHG.,PTL(SPECIAL OPS.GROUP)');
 echo form_dropdown('sqone7', $SWATTEAM, set_value('sqone7',$info->sqone7),'id="SWATTEAM" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$ATTACHEDWITHDISTTMOHALI = array('' => '--Select--', 'ATTACHED WITH DISTT., MOHALI' => 'ATTACHED WITH DISTT., MOHALI','MT C.M. POOL CHD' => 'MT C.M. POOL CHD');
 echo form_dropdown('paone1', $ATTACHEDWITHDISTTMOHALI, set_value('paone1',$info->paone1),'id="ATTACHEDWITHDISTTMOHALI" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
                 ...
                 <div class="form-group" id="paone22" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php  
$ATTACHEDWITHDISTTMOHALI = array('' => '--Select--', 'AD GUARD CP JALL' => 'AD GUARD CP JALL', 'AD GUARD CP ASR' => 'AD GUARD CP ASR','AD GUARD DISTT MKT' => 'AD GUARD DISTT MKT','AD GUARD DISTT LDH' => 'AD GUARD DISTT LDH','AD GUARD DISTT BTL' => 'AD GUARD DISTT BTL');
 echo form_dropdown('paone22', $ATTACHEDWITHDISTTMOHALI, set_value('paone22',$info->paone22),'id="ATTACHEDWITHDISTTMOHALI" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$ATTACHEDWITHDISTTPOLICEKINMALE = array('' => '--Select--', 'ATTACHED WITH DISTT. POLICE (MARTYR’S KIN MALE)' => 'ATTACHED WITH DISTT. POLICE (MARTYR’S KIN MALE)');
 echo form_dropdown('paone2', $ATTACHEDWITHDISTTPOLICEKINMALE, set_value('paone2',$info->paone2),'id="ATTACHEDWITHDISTTPOLICEKINMALE" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
              ...
              <div class="form-group" id="awdpmpod1i" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Name of District </label>
                  <div class="col-sm-9">
                <?php
$awdpmpod = array('type' => 'text','name' => 'awdpmpod','id' => 'awdpmpod','class' => 'form-control','placeholder' =>'Name of District','value' => $info->awdpmpod);
...
?>
          ...
          <div class="form-group" id="awdpmorno2i" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Order No. </label>
                  <div class="col-sm-9">
                 <?php
$awdpmorno = array('type' => 'text','name' => 'awdpmorno','id' => 'awdpmorno','class' => 'form-control','placeholder' =>'Order No.','value' => $info->awdpmorno);
...
?>
          ...
          <div class="form-group" id="awdpmordate2i" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Order date </label>
                  <div class="col-sm-9">
                 <?php
$awdpmordate = array('type' => 'text','name' => 'awdpmordate','id' => 'awdpmordate','class' => 'form-control','placeholder' =>'Order date','value' => $info->awdpmordate);
...
$ATTACHEDWITHDISTTPOLICEKINFEMALE = array('' => '--Select--', 'ATTACHED WITH DISTT. POLICE (MARTYR’S KIN FEMALE)' => 'ATTACHED WITH DISTT. POLICE (MARTYR’S KIN FEMALE)');
 echo form_dropdown('paone3', $ATTACHEDWITHDISTTPOLICEKINFEMALE, set_value('paone3',$info->paone3),'id="ATTACHEDWITHDISTTPOLICEKINFEMALE" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
                    <label for="Postingtiset" class="error"></label>
                              ...
                              <div class="form-group" id="awdpfpod1i" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Name of District </label>
                  <div class="col-sm-9">
                <?php
$awdpfpod = array('type' => 'text','name' => 'awdpfpod','id' => 'awdpfpod','class' => 'form-control','placeholder' =>'Name of District','value' => $info->awdpfpod);
...
?>
          ...
          <div class="form-group" id="awdpforno2i" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Order No. </label>
                  <div class="col-sm-9">
                 <?php
$awdpforno = array('type' => 'text','name' => 'awdpforno','id' => 'awdpforno','class' => 'form-control','placeholder' =>'Order No.','value' => $info->awdpforno);
...
?>
          ...
          <div class="form-group" id="awdpfordate2i" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Order date </label>
                  <div class="col-sm-9">
                 <?php
$awdpfordate = array('type' => 'text','name' => 'awdpfordate','id' => 'awdpfordate','class' => 'form-control','placeholder' =>'Order date','value' => $info->awdpfordate);
...
?>
                 ...
                 <div class="form-group"   id="paone4" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php  
$ATTACHEDWITHDISTTPOLICEOTHERKINMALE = array('' => '--Select--', 'ATTACHED WITH DISTT. POLICE (OTHERS MALE)' => 'ATTACHED WITH DISTT. POLICE (OTHERS MALE)','ATTACHED WITH DISTT. POLICE (OTHERS MALE)' => 'ATTACHED WITH DISTT. POLICE (OTHERS MALE)','AD GUARD CP JALL' => 'AD GUARD CP JALL', 'AD GUARD CP ASR' => 'AD GUARD CP ASR','AD GUARD DISTT MKT' => 'AD GUARD DISTT MKT','AD GUARD DISTT LDH' => 'AD GUARD DISTT LDH','AD GUARD DISTT BTL' => 'AD GUARD DISTT BTL');
 echo form_dropdown('paone4', $ATTACHEDWITHDISTTPOLICEOTHERKINMALE, set_value('paone4',$info->paone4),'id="ATTACHEDWITHDISTTPOLICEOTHERKINMALE" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
                    <label for="Postingtiset" class="error"></label>
                                        ...
                                        <div class="form-group" id="awdpompod1i" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Name of District </label>
                  <div class="col-sm-9">
                <?php
$awdpompod = array('type' => 'text','name' => 'awdpompod','id' => 'awdpompod','class' => 'form-control','placeholder' =>'Name of District','value' => $info->awdpompod);
...
?>
          ...
          <div class="form-group" id="awdpomorno2i" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Order No. </label>
                  <div class="col-sm-9">
                 <?php
$awdpomorno = array('type' => 'text','name' => 'awdpomorno','id' => 'awdpomorno','class' => 'form-control','placeholder' =>'Order No.','value' => $info->awdpomorno);
...
?>
          ...
          <div class="form-group" id="awdpomordate2i" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Order date </label>
                  <div class="col-sm-9">
                 <?php
$awdpomordate = array('type' => 'text','name' => 'awdpomordate','id' => 'awdpomordate','class' => 'form-control','placeholder' =>'Order date','value' => $info->awdpomordate);
...
$ATTACHEDWITHDISTTPOLICEOTHERKINFEMALE = array('' => '--Select--', 'ATTACHED WITH DISTT. POLICE (OTHERS FEMALE)' => 'ATTACHED WITH DISTT. POLICE (OTHERS FEMALE)');
 echo form_dropdown('paone5', $ATTACHEDWITHDISTTPOLICEOTHERKINFEMALE, set_value('paone5',$info->paone5),'id="ATTACHEDWITHDISTTPOLICEOTHERKINFEMALE" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
                    <label for="Postingtiset" class="error"></label>
                                        ...
                                        <div class="form-group" id="awdpofpod1i" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Name of District </label>
                  <div class="col-sm-9">
                <?php
$awdpofpod = array('type' => 'text','name' => 'awdpofpod','id' => 'awdpofpod','class' => 'form-control','placeholder' =>'Name of District','value' => $info->awdpofpod);
...
?>
          ...
          <div class="form-group" id="awdpoforno2i" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Order No. </label>
                  <div class="col-sm-9">
                 <?php
$awdpoforno = array('type' => 'text','name' => 'awdpoforno','id' => 'awdpoforno','class' => 'form-control','placeholder' =>'Order No.','value' => $info->awdpoforno);
...
?>
          ...
          <div class="form-group" id="awdpofordate2i" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Order date </label>
                  <div class="col-sm-9">
                 <?php
$awdpofordate = array('type' => 'text','name' => 'awdpofordate','id' => 'awdpofordate','class' => 'form-control','placeholder' =>'Order date','value' => $info->awdpofordate);
...
$CPOATTACHMENTUNDER13THBN = array('' => '--Select--', 'C.P.O. ATTACHMENT UNDER 13TH BN' => 'C.P.O. ATTACHMENT UNDER 13TH BN');
 echo form_dropdown('paone6', $CPOATTACHMENTUNDER13THBN, set_value('paone6',$info->paone6),'id="CPOATTACHMENTUNDER13THBN" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$PBPOLICEOFFICERINSTITUTESEC32CHG = array('' => '--Select--', 'PB. POLICE OFFICER INSTITUTE SEC 32 CHG' => 'PB. POLICE OFFICER INSTITUTE SEC 32 CHG');
 echo form_dropdown('paone7', $PBPOLICEOFFICERINSTITUTESEC32CHG, set_value('paone7',$info->paone7),'id="PBPOLICEOFFICERINSTITUTESEC32CHG" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$NRICELLMOHALI = array('' => '--Select--', 'NRI CELL MOHALI' => 'NRI CELL MOHALI');
 echo form_dropdown('paone8', $NRICELLMOHALI, set_value('paone8',$info->paone8),'id="NRICELLMOHALI" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$INTELLIGENCEWING = array('' => '--Select--', 'INTELLIGENCE WING' => 'INTELLIGENCE WING');
 echo form_dropdown('paone9', $INTELLIGENCEWING, set_value('paone9',$info->paone9),'id="INTELLIGENCEWING" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$CENTRALPOLICELINEMOHALI = array('' => '--Select--', 'CENTRAL POLICE LINE MOHALI' => 'CENTRAL POLICE LINE MOHALI');
 echo form_dropdown('paone10', $CENTRALPOLICELINEMOHALI, set_value('paone10',$info->paone10),'id="CENTRALPOLICELINEMOHALI" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$VIGILANCEBUREAU = array('' => '--Select--', 'VIGILANCE BUREAU' => 'VIGILANCE BUREAU');
 echo form_dropdown('paone11', $VIGILANCEBUREAU, set_value('paone11',$info->paone11),'id="VIGILANCEBUREAU" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$STATENARCOTICCRIMEBUREAU = array('' => '--Select--', 'STATE NARCOTIC CRIME BUREAU' => 'STATE NARCOTIC CRIME BUREAU');
 echo form_dropdown('paone12', $STATENARCOTICCRIMEBUREAU, set_value('paone12',$info->paone12),'id="STATENARCOTICCRIMEBUREAU" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
$MOHALIAIRPORTIMMIGRATIONDUTY = array('' => '--Select--', 'MOHALI AIRPORT IMMIGRATION DUTY' => 'MOHALI AIRPORT IMMIGRATION DUTY');
 echo form_dropdown('paone13', $MOHALIAIRPORTIMMIGRATIONDUTY, set_value('paone13',$info->paone13),'id="MOHALIAIRPORTIMMIGRATIONDUTY" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
$STATEHUMANRIGHTSCOMMISSION = array('' => '--Select--', 'STATE HUMAN RIGHTS COMMISSION' => 'STATE HUMAN RIGHTS COMMISSION ');
 echo form_dropdown('paone14', $STATEHUMANRIGHTSCOMMISSION, set_value('paone14',$info->paone14),'id="STATEHUMANRIGHTSCOMMISSION" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
$BUREAUOFINVESTIGATION = array('' => '--Select--', 'BUREAU OF INVESTIGATION' => 'BUREAU OF INVESTIGATION');
 echo form_dropdown('paone15', $BUREAUOFINVESTIGATION, set_value('paone15',$info->paone15),'id="BUREAUOFINVESTIGATION" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
$RTCPAP = array('' => '--Select--', 'SPECIAL TASK FORCE(STF)' => 'SPECIAL TASK FORCE(STF)');
 echo form_dropdown('paone23', $RTCPAP, set_value('paone23',$info->paone23),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
$RTCPAP = array('' => '--Select--', 'PPSSOC' => 'PPSSOC');
 echo form_dropdown('paone24', $RTCPAP, set_value('paone24',$info->paone24),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
$RTCPAP = array('' => '--Select--', 'RTC/PAP, JALANDHAR' => 'RTC/PAP, JALANDHAR');
 echo form_dropdown('paone16', $RTCPAP, set_value('paone16',$info->paone16),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
$vpgurds = array('' => '--Select--', 'ISTC/PAP, KAPURTHALA' => 'ISTC/PAP, KAPURTHALA','Drill Staff' => 'Drill Staff','Law Staff' => 'Law Staff');
 echo form_dropdown('paone17', $vpgurds, set_value('paone17',$info->paone17),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
$vpgurds = array('' => '--Select--', 'POLICE COMMANDO TRG. CENTRE, BHG, PATIALA' => 'POLICE COMMANDO TRG. CENTRE, BHG, PATIALA');
 echo form_dropdown('paone18', $vpgurds, set_value('paone18',$info->paone18),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
$vpgurds = array('' => '--Select--', 'RTC LADDA KOTHI SANGRUR' => 'RTC LADDA KOTHI SANGRUR');
 echo form_dropdown('paone19', $vpgurds, set_value('paone19',$info->paone19),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
$vpgurds = array('' => '--Select--', 'PUNJAB POLICE ACADEMY PHILLAUR' => 'PUNJAB POLICE ACADEMY PHILLAUR');
 echo form_dropdown('paone20', $vpgurds, set_value('paone20',$info->paone20),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
$vpgurds = array('' => '--Select--', 'POLICE RECRUITS TRAINING CENTRE, JAHAN KHELAN' => 'POLICE RECRUITS TRAINING CENTRE, JAHAN KHELAN');
 echo form_dropdown('paone21', $vpgurds, set_value('paone21',$info->paone21),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
<?php $batsio = fetchoneinfo('tcover',array('man_id' => $id)); 
  ...
  ?>
                ...
                <div class="form-group" id="paone22" style="display: none;">
                  ...
                  <div class="col-sm-9">
            <?php  
            $rank = array('type' => 'text','name' => 'tcrank','id' => 'tcrank','class' => 'form-control','placeholder' =>'Name of District','value' => $batsio->dis);
...
echo form_error('tcrank');
 ?>
                  ...
                  <div class="form-group" id="paone23i"  style="display: none;">
                  <label class="col-sm-3 control-label">Temp Att. with</label>
                  <div class="col-sm-9">
           <?php
$des = array('type' => 'text','name' => 'tcdes','id' => 'tcdes','class' => 'form-control','placeholder' =>'Designation','value' => $batsio->tem);
echo form_input($des);
...
?>
 ...
 <div class="form-group"  id="paone24"  style="display: none;">
                  ...
                  <div class="col-sm-9">
<?php
$oby = array('type' => 'text','name' => 'tcoby','id' => 'tcoby','class' => 'form-control','placeholder' =>'Order By','value' => $batsio->orderby);
echo form_input($oby);
echo form_error('oby');
?>
                    <label for="oby" class="error"></label>
                 ...
                 <div class="form-group"  id="paone25"  style="display: none;">
                  ...
                  <div class="col-sm-9">
<?php
$ono = array('type' => 'text','name' => 'tcono','id' => 'tcono','class' => 'form-control','placeholder' =>'Order No','value' => $batsio->orderno);
echo form_input($ono);
echo form_error('ono');
?>
                    <label for="ono" class="error"></label>
                 ...
                 <div class="form-group"  id="paone26"  style="display: none;">
                  ...
                  <div class="col-sm-9">
<?php
$odate = array('type' => 'text','name' => 'tcodate','id' => 'odate','class' => 'form-control','placeholder' =>'Order Date','value' => $batsio->orderdate);
echo form_input($odate);
echo form_error('tcodate');
?>
                    <label for="odate" class="error"></label>
...
<?php }else{ ?>
                ...
                <div class="form-group" id="paone22" style="display: none;">
                  ...
                  <div class="col-sm-9">
            <?php  
            $rank = array('type' => 'text','name' => 'tcrank','id' => 'tcrank','class' => 'form-control','placeholder' =>'Name of District','value' => '');
echo form_input($rank);
echo form_error('tcrank');
 ?>
                    <label for="RankRankre" class="error"></label>
                  ...
                  <div class="col-sm-9">
           <?php
$des = array('type' => 'text','name' => 'tcdes','id' => 'tcdes','class' => 'form-control','placeholder' =>'Designation','value' => '');
echo form_input($des);
echo form_error('tcdes');
?>
                    <label for="RankRankre" class="error"></label>
 ...
 <div class="form-group"  id="paone24"  style="display: none;">
                  ...
                  <div class="col-sm-9">
<?php
$oby = array('type' => 'text','name' => 'tcoby','id' => 'tcoby','class' => 'form-control','placeholder' =>'Order By','value' => '');
echo form_input($oby);
echo form_error('oby');
?>
                    <label for="oby" class="error"></label>
                 ...
                 <div class="form-group"  id="paone25"  style="display: none;">
                  ...
                  <div class="col-sm-9">
<?php
$ono = array('type' => 'text','name' => 'tcono','id' => 'tcono','class' => 'form-control','placeholder' =>'Order No','value' => '');
echo form_input($ono);
echo form_error('ono');
?>
                    <label for="ono" class="error"></label>
                 ...
                 <div class="form-group"  id="paone26"  style="display: none;">
                  ...
                  <div class="col-sm-9">
<?php
$odate = array('type' => 'text','name' => 'tcodate','id' => 'odate','class' => 'form-control','placeholder' =>'Order Date','value' => '');
echo form_input($odate);
echo form_error('tcodate');
?>
                    <label for="odate" class="error"></label>
...
$DSO = array('' => '--Select--', 'DSO' => 'DSO');
 ...
 ?>
            ...
            <div class="form-group" id="dsopod1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                <?php
$dsopod = array('type' => 'text','name' => 'dsopod','id' => 'dsopod','class' => 'form-control','placeholder' =>'Name of District','value' => $info->dsopod);
...
?>
          ...
          <div class="form-group" id="dsoorno2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$dsoorno = array('type' => 'text','name' => 'dsoorno','id' => 'dsoorno','class' => 'form-control','placeholder' =>'Order No.','value' => $info->dsoorno);
...
?>
          ...
          <div class="form-group" id="dsoordate2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$dsoordate = array('type' => 'text','name' => 'dsoordate','id' => 'dsoordate','class' => 'form-control','placeholder' =>'Order date','value' => $info->dsoordate);
...
$CSOJALANDHAR = array('' => '--Select--', 'CSO, JALANDHAR' => 'CSO, JALANDHAR');
 echo form_dropdown('ssone24', $CSOJALANDHAR, set_value('ssone24',$info->ssone24),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
                  ...
                  <div class="col-sm-9">
                 <?php
$csojalorno = array('type' => 'text','name' => 'csojalorno','id' => 'csojalorno','class' => 'form-control','placeholder' =>'Order No.','value' => $info->csojalorno);
...
?>
          ...
          <div class="form-group" id="csojalordate2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$csojalordate = array('type' => 'text','name' => 'csojalordate','id' => 'csojalordate','class' => 'form-control','placeholder' =>'Order date','value' => $info->csojalordate);
...
$NISPATIALA = array('' => '--Select--', 'NIS PATIALA' => 'NIS PATIALA');
 echo form_dropdown('ssone25', $NISPATIALA, set_value('ssone25',$info->ssone25),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
                  ...
                  <div class="col-sm-9">
                 <?php
$mispatorno = array('type' => 'text','name' => 'mispatorno','id' => 'mispatorno','class' => 'form-control','placeholder' =>'Order No.','value' => $info->mispatorno);
...
?>
          ...
          <div class="form-group" id="mispatordate2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$mispatordate = array('type' => 'text','name' => 'mispatordate','id' => 'mispatordate','class' => 'form-control','placeholder' =>'Order date','value' => $info->mispatordate);
...
$OTHERSs = array('' => '--Select--', 'OTHERS' => 'OTHERS');
 echo form_dropdown('ssone26', $OTHERSs, set_value('ssone26',$info->ssone26),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
                ...
                <div class="form-group" id="othersnod1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$othersnod = array('type' => 'text','name' => 'othersnod','id' => 'othersnod','class' => 'form-control','placeholder' =>'Nature of Duty','value' => $info->othersnod);
...
?>
          ...
          <div class="form-group" id="othersordate2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$othersnodis = array('type' => 'text','name' => 'othersnodis','id' => 'othersnodis','class' => 'form-control','placeholder' =>'Name of district','value' => $info->othersnodis);
...
?>
                  ...
                  <div class="col-sm-9">
                 <?php
$othersorno = array('type' => 'text','name' => 'othersorno','id' => 'othersorno','class' => 'form-control','placeholder' =>'Order No.','value' => $info->othersorno);
...
?>
          ...
          <div class="form-group" id="csojalordate2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$othersordate = array('type' => 'text','name' => 'othersordate','id' => 'othersordate','class' => 'form-control','placeholder' =>'Order date','value' => $info->othersordate);
...
$PAPCAMPUSSECURITY = array('' => '--Select--', 'PAP CAMPUS  SECURITY' => 'PAP CAMPUS  SECURITY','BN. KOT GUARDS' => 'BN. KOT GUARDS','BN. HQRS OTHER GUARDS' => 'BN. HQRS OTHER GUARDS','STATIC GUARD CR' => 'STATIC GUARD CR');
 echo form_dropdown('awbone1', $PAPCAMPUSSECURITY, set_value('awbone1',$info->awbone1),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
                ...
                <div class="form-group" id="awbone2i" style="display: none;">
...
$PERSONALSECURITYSTAFFARMEDWINGOFFICER = array('' => '--Select--', 'PERSONAL SECURITY STAFF ARMED WING OFFICER' => 'PERSONAL SECURITY STAFF ARMED WING OFFICER');
 echo form_dropdown('awbone2', $PERSONALSECURITYSTAFFARMEDWINGOFFICER, set_value('awbone2',$info->awbone2),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('pa28');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
                </div>
<?php $batsi = fetchoneinfo('seccover',array('man_id' => $id));
  if($batsi !='' && $info->awbone2 !=''){
  ?>
                 <h3 id="seccoversi" style="display: none;">Security Cover</h3>
                 <div class="form-group" id="awbones1i" style="display: none;">
                  <label class="col-sm-3 control-label">Name</label>
                  <div class="col-sm-9">
<?php
$name = array('type' => 'text','name' => 'scnames','id' => 'name','class' => 'form-control','placeholder' =>'Name','value' => $batsi->name);
echo form_input($name);
echo form_error('scname');
?>
                    <label for="name" class="error"></label>
                 ...
                 <div class="form-group" id="awbones2i" style="display: none;">
                  <label class="col-sm-3 control-label">Rank</label>
                  <div class="col-sm-9">
            <?php  
$RankRankre = array('' => '--Select--', 'DGP' => 'DGP', 'ADGP' => 'ADGP', 'IGP' => 'IGP', 'DIG' => 'DIG', 'AIG' => 'AIG', 'SSP' => 'SSP','SP' => 'SP',  'DSP' => 'DSP','INSPR' => 'INSPR');
 echo form_dropdown('scranks', $RankRankre, set_value('scrank',$batsi->rank),'id="RankRankrei" data-placeholder="Choose One" class="select2"'); 
 echo form_error('RankRankre');
 ?>
                    <label for="RankRankre" class="error"></label>
                  </div>
                  ...
                  <div class="form-group" id="awbones3i" style="display: none;">
                  <label class="col-sm-3 control-label">Designation</label>
                  <div class="col-sm-9">
           <?php
$des = array('type' => 'text','name' => 'scdess','id' => 'des','class' => 'form-control','placeholder' =>'Designation','value' => $batsi->des);
echo form_input($des);
echo form_error('scdes');
?>
                    <label for="RankRankre" class="error"></label>
                  ...
                  <div class="form-group" id="awbones4i" style="display: none;">
                  <label class="col-sm-3 control-label">Place of Posting</label>
                  <div class="col-sm-9">
<?php
$pop = array('type' => 'text','name' => 'scpops','id' => 'pop','class' => 'form-control','placeholder' =>'Place of Posting','value' => $batsi->placeofposting);
echo form_input($pop);
echo form_error('scpop');
?>
                    <label for="pop" class="error"></label>
                ...
                <div class="form-group" id="awbones5i" style="display: none;">
                  <label class="col-sm-3 control-label">Address</label>
                  <div class="col-sm-9">
<?php
$scaddressp = array('type' => 'text','name' => 'scaddressp','id' => 'scaddressp','class' => 'form-control','placeholder' =>'Address','value' => $batsi->address);
...
?>
                  ...
                  <div class="form-group" id="awbones6i" style="display: none;">
                  <label class="col-sm-3 control-label">Mobile</label>
                  <div class="col-sm-9">
<?php
$mob = array('type' => 'text','name' => 'scmobs','id' => 'mob','class' => 'form-control','placeholder' =>'Mobile','value' => $batsi->mobile);
echo form_input($mob);
echo form_error('mob');
?>
                    <label for="mob" class="error"></label>
 ...
 <div class="form-group" id="awbones7i" style="display: none;">
                  <label class="col-sm-3 control-label">Nature of duty</label>
                  <div class="col-sm-9">
<?php
$nod = array('' => '--Select--','Gunman' => 'Gunman','Driver' => 'Driver', 'Reader' => 'Reader', 'Guard' => 'Guard', 'PSO' => 'PSO');
 echo form_dropdown('scnods', $nod, set_value('scnod',$batsi->nod),'id="nod" data-placeholder="Choose One" class="select2"'); 
 echo form_error('nod');
?>
                    <label for="sno" class="error"></label>
                  </div>
 ...
 <div class="form-group" id="awbones8i" style="display: none;">
                  <label class="col-sm-3 control-label">Order By</label>
                  <div class="col-sm-9">
<?php
$oby = array('type' => 'text','name' => 'scobys','id' => 'oby','class' => 'form-control','placeholder' =>'Order By','value' => $batsi->orderby);
echo form_input($oby);
echo form_error('oby');
?>
                    <label for="oby" class="error"></label>
                 ...
                 <div class="form-group" id="awbones9i" style="display: none;">
                  <label class="col-sm-3 control-label">Order No</label>
                  <div class="col-sm-9">
<?php
$ono = array('type' => 'text','name' => 'sconos','id' => 'ono','class' => 'form-control','placeholder' =>'Order No','value' => $batsi->orderno);
echo form_input($ono);
echo form_error('ono');
?>
                    <label for="ono" class="error"></label>
                 ...
                 <div class="form-group" id="awbones10i" style="display: none;">
                  <label class="col-sm-3 control-label">Order Date</label>
                  <div class="col-sm-9">
<?php
$odate = array('type' => 'text','name' => 'scodates','id' => 'odate','class' => 'form-control','placeholder' =>'Order Date','value' => $batsi->order_date);
echo form_input($odate);
echo form_error('odate');
?>
                    <label for="odate" class="error"></label>
...
<?php } ?>
          ...
          <div class="form-group" id="pssawonof1i" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Name of officers </label>
                  <div class="col-sm-9">
                 <?php
$pssawonof = array('type' => 'text','name' => 'pssawonof','id' => 'pssawonof','class' => 'form-control','placeholder' =>'Name of officers','value' => $info->pssawonof);
echo form_input($pssawonof);
echo form_error('pssawonof');
?>
                    <label for="fx1" class="error"></label>
                  </div><hr/>
                </div>
                      ...
                      <div class="form-group" id="pssaworank2i" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Rank </label>
                  <div class="col-sm-9">
                 <?php
$pssaworank = array('type' => 'text','name' => 'pssaworank','id' => 'pssaworank','class' => 'form-control','placeholder' =>'Rank','value' => $info->pssaworank);
echo form_input($pssaworank);
echo form_error('pssaworank');
?>
                    <label for="fx1" class="error"></label>
                  </div><hr/>
                </div>

          <div class="form-group" id="pssawoordate2i" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Place of posting </label>
                  <div class="col-sm-9">
                 <?php
$pssawoordate = array('type' => 'text','name' => 'pssawoordate','id' => 'pssawoordate','class' => 'form-control','placeholder' =>'Place of posting','value' => $info->pssawoordate);
echo form_input($pssawoordate);
echo form_error('pssawoordate');
?>
                    <label for="fx1" class="error"></label>
                  </div><hr/>
                </div>
...
$OFFICESTAFFINHIGHEROFFICES = array('' => '--Select--', 'OFFICE STAFF IN HIGHER OFFICES' => 'OFFICE STAFF IN HIGHER OFFICES','CONTROL ROOM PAP' => 'CONTROL ROOM PAP');
 echo form_dropdown('awbone3', $OFFICESTAFFINHIGHEROFFICES, set_value('awbone3',$info->awbone3),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
                ...
                <div class="form-group" id="osihonoo2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$osihonoo = array('type' => 'text','name' => 'osihonoo','id' => 'osihonoo','class' => 'form-control','placeholder' =>'Name of office','value' => $info->osihonoo);
...
$OFFICESTAFFINBNOFFICE = array('' => '--Select--', 'Commandant office' => 'Commandant office', 'Asstt. Comdt. office' => 'Asstt. Comdt. office', 'Dy.S.P. office' => 'Dy.S.P. office', 'English Branch' => 'English Branch','Account Branch' => 'Account Branch' , 'OSI Branch' => 'OSI Branch', 'Litigation Branch' => 'Litigation Branch', 'Steno Branch' => 'Steno Branch','GPF Branch' => 'GPF Branch','Computer Cell' => 'Computer Cell','Control Room' => 'Control Room','Reader to INSP' => 'Reader to INSP','CCTNS office' => 'CCTNS office','Nodal Officer' => 'Nodal Officer','Recruitment Cell' => 'Recruitment Cell','Photostate Machine operator' => 'Photostate Machine operator','Battalion Hqr.' => 'Battalion Hqr.');
 echo form_dropdown('awbone4', $OFFICESTAFFINBNOFFICE, set_value('awbone4',$info->awbone4),'id="awbone4" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
                ...
                <div class="form-group" id="Readerosinbo1" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Reader </label>
                  <div class="col-sm-9">
                 <?php
$Readerosinbo = array('type' => 'text','name' => 'Readerosinbo','id' => 'Readerosinbo','class' => 'form-control','placeholder' =>'Reader','value' => $info->Readerosinbo);
echo form_input($Readerosinbo);
...
?>
                ...
                <div class="form-group" id="Orderly1" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Orderly </label>
                  <div class="col-sm-9">
                 <?php
$Orderly = array('type' => 'text','name' => 'Orderly','id' => 'Orderly','class' => 'form-control','placeholder' =>'Orderly','value' => $info->Orderly);
echo form_input($Orderly);
...
?>
                ...
                <div class="form-group" id="telopr1" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Telphone operator </label>
                  <div class="col-sm-9">
                 <?php
$telopr = array('type' => 'text','name' => 'telopr','id' => 'telopr','class' => 'form-control','placeholder' =>'Telphone operator','value' => $info->telopr);
echo form_input($telopr);
...
?>
                 ...
                 <div class="form-group" id="darrun1" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Dark Runner </label>
                  <div class="col-sm-9">
                 <?php
$darrun = array('type' => 'text','name' => 'darrun','id' => 'darrun','class' => 'form-control','placeholder' =>'Dark Runner','value' => $info->darrun);
echo form_input($darrun);
...
?>
               ...
               <!--   <div class="form-group" id="awbone6i" style="display: none;">
                  <label class="col-sm-3 control-label">BN KOT GUARD</label>
                  <div class="col-sm-9">
                 <?php  
/*$BNKOTGUARD = array('' => '--Select--', 'BN KOT GUARD' => 'BN KOT GUARD');
 echo form_dropdown('awbone5', $BNKOTGUARD, set_value('awbone5',$info->awbone5),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');*/
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
                  ...
                  <div class="form-group" id="bnkgdop1wwww" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Date of Posting</label>
                  <div class="col-sm-9">
                 <?php
$bnkgdop = array('type' => 'text','name' => 'bnkgdop','id' => 'bnkgdop','class' => 'form-control','placeholder' =>'Date of Posting','value' => $info->bnkgdop);
...
/*$BNHQRSOTHERGUARD = array('' => '--Select--', 'BN. HQRS.  OTHER GUARD' => 'BN. HQRS.  OTHER GUARD','STATIC GUARD CR' => 'STATIC GUARD CR');
 echo form_dropdown('awbone6', $BNHQRSOTHERGUARD, set_value('awbone6',$info->awbone6),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
              ...
              <!--   <div class="form-group" id="bhogpog1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
/*$bhogpog = array('type' => 'text','name' => 'bhogpog','id' => 'bhogpog','class' => 'form-control','placeholder' =>'Place of Guard','value' => $info->bhogpog);
...
?>
               ...
               <div class="form-group" id="bhogdop1wwww" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Date of Posting</label>
                  <div class="col-sm-9">
                 <?php
$bhogdop = array('type' => 'text','name' => 'bhogdop','id' => 'bhogdop','class' => 'form-control','placeholder' =>'Date of Posting','value' => $info->bhogdop);
...
$TRADESMEN = array('' => '--Select--', 'TRADEMEN' => 'TRADEMEN');
 echo form_dropdown('awbone7', $TRADESMEN, set_value('awbone7',$info->awbone7),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
        ...
        <div class="form-group" id="tradestot1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$tradestot = array('type' => 'text','name' => 'tradestot','id' => 'tradestot','class' => 'form-control','placeholder' =>'Type of trade','value' => $info->tradestot);
...
?>
          ...
          <div class="form-group" id="tradestt2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$tradestt = array('type' => 'text','name' => 'tradestt','id' => 'tradestt','class' => 'form-control','placeholder' =>'Technical Team','value' => $info->tradestt);
...
?>
          ...
          <div class="form-group" id="tradesbat1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$tradesbat = array('type' => 'text','name' => 'tradesbat','id' => 'tradesbat','class' => 'form-control','placeholder' =>'Battalion','value' => $info->tradesbat);
...
?>
           ...
           <div class="form-group" id="tradesdop1www" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Date of Posting</label>
                  <div class="col-sm-9">
                 <?php
$tradesdop = array('type' => 'text','name' => 'tradesdop','id' => 'tradesdop','class' => 'form-control','placeholder' =>'Date of Posting','value' => $info->tradesdop);
...
?>
                  ...
                  <div class="col-sm-9">
                 <?php
$tradesorno = array('type' => 'text','name' => 'tradesorno','id' => 'tradesorno','class' => 'form-control','placeholder' =>'Date of Posting','value' => $info->tradesorno);
...
$MTSECTION = array('' => '--Select--', 'M.T. SECTION' => 'M.T. SECTION');
 echo form_dropdown('awbone8', $MTSECTION, set_value('awbone8',$info->awbone8),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
          ...
          <div class="form-group" id="mtsecpod1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$mtsecpod = array('type' => 'text','name' => 'mtsecpod','id' => 'mtsecpod','class' => 'form-control','placeholder' =>'Place of Duty','value' => $info->mtsecpod);
...
?>
          ...
          <div class="form-group" id="mtsecvehno1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$mtsecvehno = array('type' => 'text','name' => 'mtsecvehno','id' => 'mtsecvehno','class' => 'form-control','placeholder' =>'Vehicle No.','value' => $info->mtsecvehno);
...
?>
           ...
           <div class="form-group" id="mtsecdop1wwww" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Date of Posting</label>
                  <div class="col-sm-9">
                 <?php
$mtsecdop = array('type' => 'text','name' => 'mtsecdop','id' => 'mtsecdop','class' => 'form-control','placeholder' =>'Date of Posting','value' => $info->mtsecdop);
...
?>
                  ...
                  <div class="col-sm-9">
                 <?php
$mtsecorno = array('type' => 'text','name' => 'mtsecorno','id' => 'mtsecorno','class' => 'form-control','placeholder' =>'Order No','value' => $info->mtsecorno);
...
?>
                  ...
                  <div class="col-sm-9">
                 <?php 
$a = array('' => '--Select--','Armourer & A/Armourer' => 'Armourer & A/Armourer');
 echo form_dropdown('awbone13', $a, set_value('awbone13',$info->awbone13),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('awbone13');

 if($info->awbone13 !=''){ ?>
<input type="hidden" name="awbone13" value="<?php echo $info->awbone13;  ?>"/>
 <?php } ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
                </div>
...
$QUARTERMASTERBRANCHLINESTAFF = array ('' => '--Select--', 'Reserve Inspector' => 'Reserve Inspector','Line Officer' => 'Line Officer','BHM & A/BHM' => 'BHM & A/BHM','MHC & A/MHC' => 'MHC & A/MHC','Reader/Orderly to RI' => 'Reader/Orderly to RI','I/C MESS' => 'I/C MESS','Asst. I/C MESS' => 'Asst. I/C MESS', 'CDI' => 'CDI','CDO & A/CDO' => 'CDO & A/CDO','Quarter Master INSP' => 'Quarter Master INSP','MSK Branch' => 'MSK Branch','KHC & A/KHC' => 'KHC & A/KHC','I/C Class-IV' => 'I/C Class-IV','Quarter Munshi & Asstt.' => 'Quarter Munshi & Asstt.','I/C Canteen & Grossary Shop' => 'I/C Canteen & Grossary Shop','CHC' => 'CHC','Dak Runner' => 'Dak Runner','I/C GO Mess' => 'I/C GO Mess','I/C Hospital' => 'I/C Hospital');
 echo form_dropdown('awbone9', $QUARTERMASTERBRANCHLINESTAFF, set_value('awbone9',$info->awbone9),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('awbone9');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
                </div>
                  <div class="form-group" id="quartbradop1www" style="display: none;">
                  <label class="col-sm-3 control-label text-right">Date of Posting</label>
                  <div class="col-sm-9">
                 <?php
$quartbradop = array('type' => 'text','name' => 'quartbradop','id' => 'quartbradop','class' => 'form-control','placeholder' =>'Date of Posting','value' => $info->quartbradop);
...
?>
                ...
                <div class="form-group" id="quartbraorno1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$quartbraorno = array('type' => 'text','name' => 'quartbraorno','id' => 'quartbraorno','class' => 'form-control','placeholder' =>'Order no','value' => $info->quartbraorno);
...
$GENERALDUTYBNHQRS = array('' => '--Select--', 'GENERAL DUTY ,AVAILABLE FORCE FOR EMERGENT L&O DUTY' => 'GENERAL DUTY ,AVAILABLE FORCE FOR EMERGENT L&O DUTY');
 echo form_dropdown('awbone10', $GENERALDUTYBNHQRS, set_value('awbone10',$info->awbone10),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$TRGRESERVEATBNHQRS = array('' => '--Select--', 'TRG. RESERVE AT BN.HQRS.' => 'TRG. RESERVE AT BN.HQRS.');
 echo form_dropdown('awbone11', $TRGRESERVEATBNHQRS, set_value('awbone11',$info->awbone11),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$RECRUITMENTDUTY = array('' => '--Select--', 'OTHER DUTIES' => 'OTHER DUTIES');
 echo form_dropdown('awbone12', $RECRUITMENTDUTY, set_value('awbone12',$info->awbone12),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
                ...
                <div class="form-group" id="recrutnorb1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$recrutnorb = array('type' => 'text','name' => 'recrutnorb','id' => 'recrutnorb','class' => 'form-control','placeholder' =>'Name of Duty','value' => $info->recrutnorb);
...
?>
               ...
               <!--  <div class="form-group" id="recrutorno1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
/*$recrutorno = array('type' => 'text','name' => 'recrutorno','id' => 'recrutorno','class' => 'form-control','placeholder' =>'Duty Order no','value' => $info->recrutorno);
...
?>
 ...
 -->
                 ...
                 <!-- <div class="form-group" id="recrutordate1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
/*$recrutordate = array('type' => 'text','name' => 'recrutordate','id' => 'recrutordate','class' => 'form-control','placeholder' =>'Duty Order date','value' => $info->recrutordate);
...
$RECRUIT = array('' => '--Select--', 'RECRUIT' => 'RECRUIT');
 echo form_dropdown('bmdone1', $RECRUIT, set_value('bmdone1',$info->bmdone1),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$LEAVE = array('' => '--Select--', 'Earned Leave' => 'Earned Leave','Casual Leave' => 'Casual Leave','Paternity Leave'  => 'Paternity Leave','Medical Leave'  => 'Medical Leave','Ex-India Leave' => 'Ex-India Leave','Others' => 'Others');
 echo form_dropdown('bmdone2', $LEAVE, set_value('bmdone2',$info->bmdone2),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
                 ...
                 <div class="form-group" id="leavefrom2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$leavefrom = array('type' => 'text','name' => 'leavefrom','id' => 'leavefrom','class' => 'form-control','placeholder' =>'From','value' => $info->leavefrom);
...
?>
                 ...
                 <div class="form-group" id="leaveto2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$leaveto = array('type' => 'text','name' => 'leaveto','id' => 'leaveto','class' => 'form-control','placeholder' =>'To','value' => $info->leaveto);
...
$ABSENT = array('' => '--Select--', 'ABSENT' => 'ABSENT');
 echo form_dropdown('bmdone3', $ABSENT, set_value('bmdone3',$info->bmdone3),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
                 ...
                 <div class="form-group" id="absentfrom1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$absentfrom = array('type' => 'text','name' => 'absentfrom','id' => 'absentfrom','class' => 'form-control','placeholder' =>'Absent From','value' => $info->absentfrom);
...
?>
                 ...
                 <div class="form-group" id="absentddr2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$absentddr = array('type' => 'text','name' => 'absentddr','id' => 'absentddr','class' => 'form-control','placeholder' =>'DDR No.','value' => $info->absentddr);
...
?>
                  ...
                  <div class="col-sm-9">
                 <?php
$absentdate = array('type' => 'text','name' => 'absentdate','id' => 'absentdate','class' => 'form-control','placeholder' =>'Date','value' => $info->absentdate);
...
$UNDERSUSPENSION  = array('' => '--Select--', 'UNDER SUSPENSION' => 'UNDER SUSPENSION');
 echo form_dropdown('bmdone4', $UNDERSUSPENSION, set_value('bmdone4',$info->bmdone4),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
                 ...
                 <div class="form-group" id="usdos2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$usdos = array('type' => 'text','name' => 'usdos','id' => 'usdos','class' => 'form-control','placeholder' =>'Date of suspension','value' => $info->usdos);
...
?>
                  ...
                  <div class="col-sm-9">
                 <?php
$usros = array('type' => 'text','name' => 'usros','id' => 'usros','class' => 'form-control','placeholder' =>'Reason of suspension','value' => $info->usros);
...
array('' => '--Select--', 'Handicapped on Medical Rest' => 'Handicapped on Medical Rest');
 echo form_dropdown('bmdone5', $HandicappedonMedicalRest, set_value('bmdone5',$info->bmdone5),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
');
 echo form_dropdown('bmdone6', $Handicappedonlightduty, set_value('bmdone6',$info->bmdone6),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
$ChronicDiseaseonMedicalRest = array('' => '--Select--', 'Chronic Disease on Medical Rest' => 'Chronic Disease on Medical Rest');
 echo form_dropdown('bmdone8', $ChronicDiseaseonMedicalRest, set_value('bmdone8',$info->bmdone7),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
                ...
                <div class="form-group"  id="bmdone9" style="display: none;">
                  <label class="col-sm-3 control-label">OSD ETC</label>
                  <div class="col-sm-9">
                 <?php  
$OSDETC = array('' => '--Select--', 'OSD ETC' => 'OSD ETC');
 echo form_dropdown('bmdone9', $OSDETC, set_value('bmdone9',$info->bmdone9),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$IRBInstitutions = array('' => '--Select--', 'IRB Institutions' => 'IRB Institutions');
 echo form_dropdown('instone1', $IRBInstitutions, set_value('instone1',$info->instone1),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$CDOInstitutions = array('' => '--Select--', 'CDO Institutions' => 'CDO Institutions');
 echo form_dropdown('instone2', $CDOInstitutions, set_value('instone2',$info->instone2),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$PAPOuterBnInstitutions = array('' => '--Select--', 'PAP Outer Bn Institutions' => 'PAP Outer Bn Institutions');
 echo form_dropdown('instone3', $PAPOuterBnInstitutions, set_value('instone3',$info->instone3),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
...
$Institutionsti = array('' => '--Select--', 'Drill Staff' => 'Drill Staff', 'Law Staff' => 'Law Staff');
 echo form_dropdown('instone4', $Institutionsti, set_value('instone4',$info->instone4),'id="Institutionsti" data-placeholder="Choose One" title="Please select at least 1 area" class="select2"'); 
 echo form_error('irb5');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
$vpgurds = array('' => '--Select--', 'BASIC TRANING' => 'BASIC TRANING');
 echo form_dropdown('traning1', $vpgurds, set_value('traning1',$info->traning1),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('lone1');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
$TrainingInstituteti = array('' => '--Select--', 'Deferred Basic Training Sports Person' => 'Deferred Basic Training Sports Person', 'Deferred basic training Medical Rest' => 'Deferred basic training Medical Rest', 'RTCI' => 'RTC','ISTC' => 'ISTC','CTC BHG' =>'CTC BHG', 'PPA Phillaur' =>'PPA Phillaur', 'PRTC Jahankhelan' => 'PRTC Jahankhelan', 'Ladda Kothi Sangrur' => 'Ladda Kothi Sangrur','CTC BHG' => 'CTC BHG' ,'CTC BHG PTL' => 'CTC BHG PTL','ISTC KPT' => 'ISTC KPT', 'ISTC KPT.' => 'ISTC KPT.', 'ISTC/KPT' => 'ISTC/KPT','PPA PHR' => 'PPA PHR','PPA PHR.' => 'PPA PHR.', 'PPA/PHR' => 'PPA/PHR','RTC' => 'RTC','RTC BHG PTL' => 'RTC BHG PTL', 'RTC BHG PTL.' => 'RTC BHG PTL.','RTC L/SGR.' => 'RTC L/SGR.', 'RTC PAP JRC' => 'RTC PAP JRC','RTC PAP JRC' => 'RTC PAP JRC','RTC/PAP' => 'RTC/PAP');
 echo form_dropdown('btarin1', $TrainingInstituteti, set_value('btarin1',$info->btarin1),'id="TrainingInstituteti" data-placeholder="Choose One" title="Please select at least 1 area" class="select2"'); 
 ...
 ?>
                ...
                <div class="form-group" id="bastraing2" style="display: none;">
                  ...
                  <div class="col-sm-9">
<?php
$Batchbn = array('type' => 'text','name' => 'btarin2','id' => 'Batchbn','class' => 'form-control','placeholder' =>'Batch Group','value' => $info->btarin2);
...
$vpgurds = array('' => '--Select--', 'PROMOTIONAL COURSE' => 'PROMOTIONAL COURSE');
 echo form_dropdown('traning2', $vpgurds, set_value('traning2',$info->traning2),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
$TrainingInstitutessti = array('' => '--Select--',  'RTCI' => 'RTC','ISTC' => 'ISTC','CTC BHG' =>'CTC BHG', 'PPA Phillaur' =>'PPA Phillaur', 'PRTC Jahankhelan' => 'PRTC Jahankhelan', 'Ladda Kothi Sangrur' => 'Ladda Kothi Sangrur','Other' => 'Other');
 echo form_dropdown('btarin4', $TrainingInstitutessti, set_value('btarin4',$info->btarin4),'id="TrainingInstitutessti" data-placeholder="Choose One" title="Please select at least 1 area" class="select2"'); 
 ...
 <div class="form-group" id="bastraing6"  style="display:none">
                  ...
                  <div class="col-sm-9">
<?php
$NamesofsCourses = array('type' => 'text','name' => 'btarin5','id' => 'NamesofsCourses','class' => 'form-control','placeholder' =>'Name of Course','value' => $info->btarin5);
...
?>
           ...
           <div class="form-group" id="bastraing7"  style="display:none">
                  ...
                  <div class="col-xs-3">
<?php
$DurationsofsCourses = array('type' => 'text','name' => 'btarin6','id' => 'DurationsofsCourses','class' => 'form-control','placeholder' =>'From','value' => $info->btarin6);
...
?>
                    ...
                    <div class="col-xs-3">
<?php
$DurationsofsCoursest = array('type' => 'text','name' => 'btarin7','id' => 'DurationsofsCoursest','class' => 'form-control','placeholder' =>'To','value' => $info->btarin7);
...
$vpgurds = array('' => '--Select--', 'DEPARTMENT COURSE' => 'DEPARTMENT COURSE');
 echo form_dropdown('traning3', $vpgurds, set_value('traning3',$info->traning3),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
                 ...
                 <?php  
$TrainingInstitutessti = array('' => '--Select--',  'RTCI' => 'RTC','ISTC' => 'ISTC','CTC BHG' =>'CTC BHG', 'PPA Phillaur' =>'PPA Phillaur', 'PRTC Jahankhelan' => 'PRTC Jahankhelan', 'Ladda Kothi Sangrur' => 'Ladda Kothi Sangrur','Other' => 'Other');
 echo form_dropdown('btarin8', $TrainingInstitutessti, set_value('btarin8',$info->btarin8),'id="TrainingInstitutessti" data-placeholder="Choose One" title="Please select at least 1 area" class="select2"'); 
 echo form_error('TrainingInstitutessti');
 ?>
                    <label for="TrainingInstitutessti" class="error"></label>
                  </div>
 ...
 <div class="form-group" id="bastraing9"  style="display:none">
                  ...
                  <div class="col-sm-9">
<?php
$NamesofsCourses = array('type' => 'text','name' => 'btarin9','id' => 'btarin9','class' => 'form-control','placeholder' =>'Name of Course','value' => $info->btarin9);
echo form_input($NamesofsCourses);
echo form_error('NamesofsCourses');
?>
                    <label for="NamesofsCourses" class="error"></label>
...
<?php
$DurationsofsCourses = array('type' => 'text','name' => 'btarin10','id' => 'DurationsofsCourses','class' => 'form-control','placeholder' =>'From','value' => $info->btarin10);
echo form_input($DurationsofsCourses);
echo form_error('DurationsofsCourses');
?>
                    <label for="DurationsofsCourses" class="error"></label>
                    ...
                    <div class="col-xs-3">
<?php
$DurationsofsCoursest = array('type' => 'text','name' => 'btarin11','id' => 'DurationsofsCoursest','class' => 'form-control','placeholder' =>'To','value' => $info->btarin10);
echo form_input($DurationsofsCoursest);
echo form_error('DurationsofsCoursest');
?>
</div>
                  ...
                  <div class="col-sm-9">
                <?php
$dsopod = array('type' => 'text','name' => 'classf1','id' => 'dsopod','class' => 'form-control','placeholder' =>'Place Of Duty','value' => $info->cfpop);
echo form_input($dsopod);
...
?>
          ...
          <div class="form-group" id="classf2" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$dsoorno = array('type' => 'text','name' => 'classf2','id' => 'dsoorno','class' => 'form-control','placeholder' =>'Nature of duty','value' => $info->cfppd);
echo form_input($dsoorno);
...
<?php
$dateofposting1 = array('type' => 'text','name' => 'dateofposting1','id' => 'dateofposting1','class' => 'form-control','placeholder' =>'Date of Posting','value' => $info->dateofposting1);
...
jQuery('#dateofposting1').datepicker({dateFormat: "dd/mm/yy"});
  ...
  if(this.value == 'Fix Duties'){
    $('#dofposting1').show();
     $('#fone1,#fone2,#fone3,#fone4,#fone5,#fone6,#fone7,#fone8,#fone9,#fone10,#fone11,#fone12,#fone13,#fone14,#fone15,#fone16,#fone17,#fone18,#fone19,#fone20,#fone21,#fone22,#seccover,#spuoderny,#spuodernyno,#spuodernyod').show();
     ...
     $('#vploc1,#vpdis1,#noj1,#jsdis2,#osgloc1,#osgdis2,#bsdnob1,#bsddis2,#bsdloc2').show();
      ...
      $('#instone1,#instone2,#instone3,#instone4,#instone5,#instone6,#instone10').hide();
   ...
   $('#instone1,#instone2,#instone3,#instone4,#instone5,#instone6,#instone10').hide();
    ...
    $('#awbones1,#awbones2,#awbones3,#awbones4,#awbones5,#awbones6,#awbones7,#awbones8,#awbones9,#awbones10,#seccovers').hide();
