...
$vpgurds = array('' => '--Select--', 'VP Guards' => 'VP Guards');
 ...
 ?>
            ...
            <div class="form-group" id="vploc1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                <?php
$vploc = array('type' => 'text','name' => 'vploc','id' => 'vploc','class' => 'form-control','placeholder' =>'Location','value' => set_value('vploc'));
...
$OFFICESTAFFINBNOFFICE = array('' => '--Select--', 'Commandant office' => 'Commandant office', 'Asstt. Commandant office' => 'Asstt. Commandant office', 'Dy.S.P. office' => 'Dy.S.P. office', 'English Branch' => 'English Branch','Account Branch' => 'Account Branch' , 'OSI Branch' => 'OSI Branch', 'Litigation Branch' => 'Litigation Branch', 'Steno Branch' => 'Steno Branch','GPF Branch' => 'GPF Branch','Computer Cell' => 'Computer Cell','Control Room' => 'Control Room','Reader to INSP' => 'Reader to INSP','CCTNS office' => 'CCTNS office','Nodal Officer' => 'Nodal Officer');
 ...
 ?>
                ...
                <div class="form-group" id="Readerosinbo1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$Readerosinbo = array('type' => 'text','name' => 'Readerosinbo','id' => 'Readerosinbo','class' => 'form-control','placeholder' =>'Reader','value' => set_value('Readerosinbo'));
...
?>
                ...
                <div class="form-group" id="Orderly1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$Orderly = array('type' => 'text','name' => 'Orderly','id' => 'Orderly','class' => 'form-control','placeholder' =>'Orderly','value' => set_value('Orderly'));
...
?>
                ...
                <div class="form-group" id="telopr1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$telopr = array('type' => 'text','name' => 'telopr','id' => 'telopr','class' => 'form-control','placeholder' =>'Telphone operator','value' => set_value('telopr'));
...
?>
                 ...
                 <div class="form-group" id="darrun1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$darrun = array('type' => 'text','name' => 'darrun','id' => 'darrun','class' => 'form-control','placeholder' =>'Dark Runner','value' => set_value('darrun'));
...
?>
                 ...
                 <div class="form-group" id="awbone10" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php  
$QUARTERMASTERBRANCHLINESTAFF = array('' => '--Select--', 'Reserve Inspector' => 'Reserve Inspector','Line Officer' => 'Line Officer','BHM & A/BHM' => 'BHM & A/BHM','MHC & A/MHC' => 'MHC & A/MHC','Reader/Orderly to RI' => 'Reader/Orderly to RI','I/C MESS' => 'I/C MESS','Asst. I/C MESS' => 'Asst. I/C MESS', 'CDI' => 'CDI','CDO & A/CDO' => 'CDO & A/CDO','Quarter Master INSP' => 'Quarter Master INSP','MSK Branch' => 'MSK Branch','KHC' => 'KHC','Armourer & A/Armourer' => 'Armourer & A/Armourer','I/C Class-IV' => 'I/C Class-IV','Quarter Munshi & Asstt.' => 'Quarter Munshi & Asstt.','I/C Canteen & Grossary Shop' => 'I/C Canteen & Grossary Shop');
...
$RECRUITMENTDUTY = array('' => '--Select--', 'RECRUITMENT DUTY' => 'RECRUITMENT DUTY');
 ...
 ?>
                ...
                <div class="form-group" id="recrutnorb1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                 <?php
$recrutnorb = array('type' => 'text','name' => 'recrutnorb','id' => 'recrutnorb','class' => 'form-control','placeholder' =>'Name of Recruitment Board','value' => set_value('recrutnorb'));
...
$ChronicDiseaseonMedicalRest = array('' => '--Select--', 'Chronic Disease on Medical Rest' => 'Chronic Disease on Medical Rest');
 echo form_dropdown('bmdone10', $ChronicDiseaseonMedicalRest, set_value('bmdone10',''),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('bmdone10');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
                </div>
...
<div class="form-group" id="classf1" style="display: none;">
                  ...
                  <div class="col-sm-9">
                <?php
$dsopod = array('type' => 'text','name' => 'classf1','id' => 'dsopod','class' => 'form-control','placeholder' =>'Place Of Posting','value' => set_value('classf1'));
echo form_input($dsopod);
