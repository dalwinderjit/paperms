...
<?php $this->load->view('Btalion/html/headbar'); ?>
    <div class="pageheader">
      <h3>&nbsp; &nbsp;  KHC Module Ammunition (Practice)</h3>
                ...
                <?php  $count = 0; if($weapon!=''){ foreach($weapon as $value): $count = $count+1; ?>
                 <tr class="odd gradeX">
                    ...
                    <td><?php echo $value->qty; ?></td>
                     ...
                     <td><?php $id = fetchoneinfo('newosi',array('man_id' => $value->osi_id)); echo $id->name. 'Dept No:'. $id->depttno; ?></td>
                    <td><a href="<?php echo base_url('bt-editparm'); ?>/<?php echo $value->pammu_id; ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Edit</a> 

                    <a href="<?php echo base_url('bt-depositparm'); ?>/<?php echo $value->pammu_id; ?>" class="btn btn-primary btn-xs"> Deposit</a></td>
                <?php endforeach; } ?>
              </tbody>
           </table>
