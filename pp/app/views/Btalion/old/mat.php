...
<head>
    ...
    <title> Current Material Report</title>
              ...
              <tbody>
                <?php  $count = 0; if($msk!=''){ foreach($msk as $value): $count = $count+1; ?>
                 <tr class="odd gradeX">
                    ...
                    <td><?php $cc = ''; $cc .= $value->qty + $value->issued; echo $cc; ?>
                      <?php /*$a = info_fetch_conly($value->item,$value->name,$this->session->userdata('userid')); if($a !=''){ foreach ($a as $key) {
                          echo 'Condem &nbsp;'.$cc - $key->total; 
                    }}else{
