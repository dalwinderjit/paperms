...
<head>
    ...
    <title> Statement of service ammunition issued, Lost/Deposited</title>
...
<body>
    ...
    <div class="panel panel-default">
        <div class="panel-body"> 
          ...
          <h3 class="text-center">Statement of service ammunition issued, Lost/Deposited</h3>
            <table class="table" >
              <thead>
                 <tr>
              <th>S.No</th>
                ...
                <?php  $count = 0; if($weapon!=''){ foreach($weapon as $value): $count = $count+1; ?>
                 <tr class="odd gradeX">
                   ...
                   ?></td>
                    ...
                    <td><?php  
                      $infos = fetchoneinfocartridges($value->abore,'',$ninfo);
                    ...
                    <td><?php  
                      ...
                      ?></td>
                    <td><?php $id = fetchoneinfo('nodelist',array('btype' => $value->abore)); 
                    if($id != ''){
                      echo $id->bnempty;
                    }else{
                      echo'-';
