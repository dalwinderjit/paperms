...
$eor1 = array('' => '--Rank/Trade--', 'CT' => 'CT', 'Sr.Const' => 'Sr. Const', 'C-II' => 'C-II', 'HC/PR' => 'HC/PR', 'HC' => 'HC', 'HC/LR' => 'HC/LR','HC/CR' => 'HC/CR', 'ASI/LR' => 'ASI/LR','ASI/CR' => 'ASI/CR',  'ASI' => 'ASI','ASI/ORP' => 'ASI/ORP', 'SI/CR' => 'SI/CR','SI/LR' => 'SI/LR', 'SI' => 'SI', 'INSP/CR' => 'INSP/CR','INSP/LR' => 'INSP/LR', 'INSP' => 'INSP', 'DSP/CR' =>'DSP/CR','DSP' =>'DSP','AIG' => 'AIG','SP/CR' => 'SP/CR', 'SP' => 'SP','Asst. Commandant' =>'Asst. Commandant','Commandant' => 'Commandant');
 ...
 ?>
            ...
            <?php  
$eor2 = array('' => '--Rank/Trade--', 'Senior Asstt.' => 'Senior Asstt.', 'Junior Asstt.' => 'Junior Asstt.','Senior Scale Stenographer' => 'Senior Scale Stenographer','Junior Scale Stenographer' => 'Junior Scale Stenographer', 'Clerk' => 'Clerk', 'Peon' => 'Peon', 'Daftari' => 'Daftari','Steno' => 'Steno', 'Supdt Grade-I' => 'Supdt Grade-I','SubSupdt Grade-II' => 'Supdt Grade-II');
...
$eor3 = array('' => '--Rank/Trade--', 'Doctor' => 'Doctor', 'Pharmacist' => 'Pharmacist', 'Physiotherapist' => 'Physiotherapist', 'Lab Technician' => 'Lab Technician', 'Nursing Asstt.' => 'Nursing Asstt.');
 ...
 ?>
            ...
            <?php  
$eor4 = array('' => '--Rank/Trade--', 'Cook' => 'Cook', 'Water Carrier' => 'Water Carrier', 'Sweeper' => 'Sweeper', 'Dhobi' => 'Dhobi', 'Mochi' => 'Mochi', 'Barber' => 'Barber', 'Tailor' => 'Tailor', 'Carpenter' => 'Carpenter','Mason' => 'Mason','Mali' => 'Mali', 'Electrician' => 'Electrician', 'Painter' => 'Painter');
 ...
 ?>
            ...
            <?php  
$eor5 = array('' => '--Rank/Trade--', 'Cook' => 'Cook', 'Water Carrier' => 'Water Carrier', 'Sweeper' => 'Sweeper', 'Dhobi' => 'Dhobi', 'Mochi' => 'Mochi', 'Barber' => 'Barber', 'Tailor' => 'Tailor', 'Carpenter' => 'Carpenter','Mason' => 'Mason','Mali' => 'Mali', 'Electrician' => 'Electrician', 'Painter' => 'Painter');
...
/*----End newarea Textfield----*/
 ...
 <div class="col-sm-3"  id="gb"  style="display:none;">
                 ...
                 <?php  
$Graduate = array('' => '--Edu Qualified--', 'BA' => 'BA', 'B.Sc' => 'B.Sc','BSc .IT' => 'BSc .IT', 'B.Com' => 'B.Com','BCA' =>'BCA','BBA' => 'BBA','BDS' => 'BDS','LLB' => 'LLB','B.Tech' => 'B.Tech','LAB Technician' => 'LAB Technician','BA/LLB' => 'BA/LLB');
/*newarea Textfield*/
...
?>
                  ...
                  <div class="col-sm-3"><div class="form-group">
                 <?php  
$Modemdr = array('' => '--Mode of Enlistment--', 'Special Cases' => 'Special Cases','Direct' => 'Direct', 'Direct (Ex-Serviceman)' => 'Direct (Ex-Serviceman)','Direct(SPORTS)' => 'Direct(SPORTS)', 'PLI' => 'PLI', 'Court cases' => 'Court cases','Direct (Freedom Fighter)' => 'Direct (Freedom Fighter)','SPO' => 'SPO');
/*newarea Textfield*/
...
$InductionModeim = array('' => '--Computer literate--', 'Yes' => 'Yes', 'No' => 'No');
 ...
 ?>
                ...
                <div class="col-sm-3"><br/>  <div class="input-group">
                 <?php
$dateofesnlistment1 = array('type' => 'text','name' => 'dateofesnlistment1','id' => 'dateofesnlistment1','class' => 'form-control','placeholder' =>'Date of Enlistment From (YYYY-MM-DD)','value' => (isset($_GET['dateofesnlistment1'])) ? $_GET['dateofesnlistment1'] : '');
...
?>
                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                 ...
                 <div class="col-sm-3"><br/>     <div class="input-group">
                 <?php
$dateofesnlistment2 = array('type' => 'text','name' => 'dateofesnlistment2','id' => 'edateofesnlistment1','class' => 'form-control','placeholder' =>'Date of Enlistment To (YYYY-MM-DD)','value' => (isset($_GET['dateofesnlistment2'])) ? $_GET['dateofesnlistment2'] : '');
...
<?php
$DateofRetirementdor = array('type' => 'text','name' => 'DateofRetirementdor','id' => 'DateofRetirementdor','class' => 'form-control','placeholder' =>'Date of Retirement (YYYY-MM-DD)','value' => (isset($_GET['DateofRetirementdor'])) ? $_GET['DateofRetirementdor'] : '');
...
?>
 ...
 <div class="col-sm-3">  <br/>   <div class="input-group">
                 <?php
$dateofbirth = array('type' => 'text','name' => 'dateofbirth','id' => 'dateofbirth','class' => 'form-control','placeholder' =>'Date of Birth From (YYYY-MM-DD)','value' =>  (isset($_GET['dateofbirth'])) ? $_GET['dateofbirth'] : '');
...
<div class="col-sm-3">  <br/>   <div class="input-group">
                 <?php
$dateofbirth = array('type' => 'text','name' => 'dateofbirthi','id' => 'dateofbirthi','class' => 'form-control','placeholder' =>'Date of Birth To (YYYY-MM-DD)','value' =>   (isset($_GET['dateofbirthi'])) ? $_GET['dateofbirthi'] : '');
echo form_input($dateofbirth);
echo form_error('dateofbirth');
?>
                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
...
$Postingtiset = array('' => '--Category of Duty--', 'Fix Duties' => 'Fix Duties', 'Law & Order Duty' => 'Law & Order Duty', 'Special Squads' => 'Special Squads','Permanent Attachment' => 'Permanent Attachment','Training' => 'Training','Sports' => 'Sports','Available with BNs' => 'Available with BNs','Battalion Misc Duties' => 'Battalion Misc Duties','Institutions' => 'Institutions');
 echo form_dropdown('Postingtiset', $Postingtiset, set_value('Postingtiset',  (isset($_GET['Postingtiset'])) ? $_GET['Postingtiset'] : ''),'id="Postingtiset" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 ...
 ?>
                 ...
                 <?php  
$Postingtiset1 = array('' => '--Nature/Place of Duty--', 'VP Guards' => 'VP Guards','Jails Security' => 'Jails Security','Punjab Police HQRS,SEC.9,CHG' =>  'Punjab Police HQRS,SEC.9,CHG', 'DERA BEAS SECURITY DUTY' => 'DERA BEAS SECURITY DUTY','OTHER STATIC GUARDS' => 'OTHER STATIC GUARDS','Police Officer' => 'Serving Police Officer', 'Retired Police Officer' => 'Retired Police Officer', 'Political Persons' => 'Political Persons','Civil Officers' => 'Civil Officers','Judicial Officers' => 'Judicial Officers','Threatening persons' => 'Threatening persons','PERSONAL SECURITY STAFF ARMED WING OFFICER' => 'PERSONAL SECURITY STAFF ARMED WING OFFICER','VIP SEC.WING CHG.U/82nd BN.' => 'VIP SEC.WING CHG.U/82nd BN.','POLICE SEC.WING CHG U/13th BN.' => 'POLICE SEC.WING CHG U/13th BN.','BANK SECURITY DUTY' => 'BANK SECURITY DUTY','SPECIAL PROTECTION UNIT (C.M. SEC.)' => 'SPECIAL PROTECTION UNIT (C.M. SEC.)','PB. BHAWAN NEW DELHI (SEC. DUTY)' => 'PB. BHAWAN NEW DELHI (SEC. DUTY)') ;
 echo form_dropdown('Postingtiset', $Postingtiset1, set_value('Postingtiset', ''),'id="Postingtiseto" data-placeholder="Choose One" title="Please select at least 1 value" class="select2 l"'); 
 echo form_error('Postingtiset');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
...
$Postingtiset5 = array('' => '--Nature/Place of Duty--','BASIC TRANING' => 'BASIC TRANING','PROMOTIONAL COURSE' => 'PROMOTIONAL COURSE','DEPARTMENT COURSE' => 'DEPARTMENT COURSE') ;
 echo form_dropdown('Postingtiset5', $Postingtiset5, set_value('Postingtiset5',''),'id="Postingtiset5" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset5');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
                </div>
                 ...
                 <?php  
$Postingtiset6 = array('' => '--Nature/Place of Duty--','DSO' => 'DSO','CSO, JALANDHAR' => 'CSO, JALANDHAR','NIS PATIALA' => 'NIS PATIALA','OTHERS' => 'OTHERS') ;
 echo form_dropdown('Postingtiset6', $Postingtiset6, set_value('Postingtiset6',''),'id="Postingtiset6" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
 echo form_error('Postingtiset6');
 ?>
                    <label for="Postingtiset" class="error"></label>
                  </div>
                </div>
  ...
  <li><a href="<?php echo base_url('bt-edit-rank/'.$value->man_id); ?>" target="_blank"> <i class="fa fa-edit"></i> Edit</a></li>
   ...
   <li><a href="<?php echo base_url('bt-posdeleit'); ?>/<?php echo $value->man_id; ?>" onclick="return confirm('Are you sure you want to delete?');"> <i class="fa fa-minus"></i> Delete</a></li>
                  ...
                  <a href="<?php echo base_url('bt-osidelete/'.$value->man_id); ?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure you want to delete this record?');">Delete</a>
                    ...
                    <td><?php 
                        switch($value->presentrank){
                          case 'Executive Staff':
                            echo $value->cexrank;
                            break;
                          case 'Ministerial Staff':
                            echo $value->cminirank;
                            break;
                          case 'Medical Staff':
                            echo $value->cmedirank;
                            break; 
                          case 'Class-IV (P)':
                            echo $value->ccprank;
                            break;
                          case 'Class-IV (C)':
                            ...
                            break;  
                          default:
                            echo $value->presentrank;
                        }
                    //echo $rank.' '.$value->cexrank.$value->cminirank.$value->cmedirank.$value->ccprank.$value->cccrank; ?></td>
                    ...
                    <td><?php $ax = explode('@', $value->NamesofsCourses);
                          /*if($ax[0] == '-' || $ax[0] == ''){
                            ...
                            if($value->NamesofsCourses !=''){

                             echo count($ax);  } ?></td>
                            
                    <td><?php echo $value->dateofretirment; ?></td>
                    <td><?php //echo $value->dateofretirment2; ?></td>
