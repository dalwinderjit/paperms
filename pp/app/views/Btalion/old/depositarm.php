...
<head>
    ...
    <title> Issue weapon/Ammunition list</title>
        ...
        <div class="panel-body"> 
          ...
          <div class="table-responsive">
            <table class="table"  id="table">
              ...
              <th>Deposit Service Ammunition</th>
              <th>Deposit Practice Ammunition</th>
              <th>Date</th>
                </tr>
              </thead>
              <tbody>
                <?php  $count = 0; if($weapon!=''){ foreach($weapon as $value): $count = $count+1; ?>
                 <tr class="odd gradeX">
                   ...
                   ?></td>
                    ...
                    <td><?php if($value->issue_arm_id != ''){
                      $info = fetchoneinfo('deposit_ammu',array('issue_arm_id' => $value->issue_arm_id)); if($info != ''){echo date('d-m-Y',strtotime($info->da_date));} 
                    }  ?>
                    </td>  
                    </tr>
                <?php endforeach; } ?>
