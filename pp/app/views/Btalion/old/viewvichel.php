...
/*newarea Textfield*/
 ...
 ?>
           ...
           <?php  
$option = array('' => '--Status of Vehicle--', 'On Road' => 'On Road','Off Road' => 'Off Road');
/*newarea Textfield*/
...
/*----End newarea Textfield----*/
 ?>
                  ...
                  <div class="form-group">
                 <?php  
$vcn = array('' => '--AC/Non-AC--', 'AC' => 'AC','Non-AC' => 'Non-AC');
/*newarea Textfield*/
...
/*----End newarea Textfield----*/
 ?>
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                 <?php  
$vcn = array('' => '--BP/Non-BP--', 'BP' => 'BP','Non-BP' => 'Non-BP');
/*newarea Textfield*/
              ...
              <tbody>
                <?php  $count = 0; if($weapon!=''){ foreach($weapon as $value): $count = $count+1; ?>
                 <tr class="odd gradeX">
                    ...
                    <td><a href="<?php echo base_url('bt-view-mrepair'); ?>/<?php echo $value->mt_id;  ?>" class="btn btn-primary btn-xs">Repair Details</a></td>
                    <td><a href="<?php echo base_url('bt-mtview'); ?>/<?php echo $value->mt_id;  ?>" class="btn btn-success btn-xs">View</a></td>
