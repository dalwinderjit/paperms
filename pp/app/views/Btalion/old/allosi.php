...
<div class="form-group" >
                 ...
                 <?php  
$UnderGraduate = array('' => '--Edu Qualified--','BA-I' => 'BA-I', 'BA-II' => 'BA-II', 'BSc-I' => 'BSc-I', 'BSc-II' => 'BSc-II','BSc .IT-I' => 'BSc .IT-I', 'BSc .IT-II' => 'BSc .IT-II', 'Bcom-I' => 'Bcom-I','Bcom-II' => 'Bcom-II','BCA-I' =>'BCA-I','BCA-II' =>'BCA-II','BBA-I' => 'BBA-I','BBA-II' => 'BBA-II','LLB-I' => 'LLB-I','LLB-II' => 'LLB-II','B.Tech-I' => 'B.Tech-I', 'B.Tech-II' => 'B.Tech-II', 'B.Tech-III' => 'B.Tech-III','BA/LLB'=>'BA/LLB');
/*newarea Textfield*/
              ...
              <tbody>
                <?php  $count = 0; if($weapon!=''){ foreach($weapon as $value): $count = $count+1; ?>
                 <tr class="odd gradeX">
                    ...
                    <td><?php $db =  date('d-m-Y',strtotime($value->dateofbith)); if($db == '00-00-0000'){echo '-';}else{echo $db;} ?></td>
                    <td><?php $dde =  date('d-m-Y',strtotime($value->dateofinlitment)); if($dde == '00-00-0000'){echo'-';}else{ echo $dde;} ?> </td>
