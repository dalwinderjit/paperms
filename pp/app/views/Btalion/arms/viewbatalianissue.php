...
<head>
    ...
    <title>Issued Weapons List</title>
...
<?php $this->load->view(F_BTALION.'html/headbar'); ?>
    <div class="pageheader">
      <h2><i class="fa fa-building-o"></i> View Weapons List</h2>
      <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
          <li class="active"><a href="<?php echo base_url();?>bt-dashboard">Dashboard</a></li>
          <li class="active">View Weapons List</li>
        </ol>
      </div>
    </div>
  ...
  <strong>Success!</strong> <?php echo $this->session->flashdata('success_msg'); ?>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h3 class="panel-title">View Weapons List </h3>
          </div>
