          ...
          <div class="panel panel-default">
              <div class="panel-body">
                 ...
                 foreach ($weapon as $value) {
                   $tow[$value->old_weapon_id] = $value->tow. '&nbsp; Body No:'.$value->bono.'&nbsp; Butt No:'.$value->buno;
                 }
/*newarea Textfield*/
...
?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                 <?php 
                 $tows = array('' => '--Select--','Temporary' => 'Temporary','Permanent' => 'Permanent');
/*newarea Textfield*/
