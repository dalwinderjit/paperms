...
/*newarea Textfield*/
 echo form_dropdown('now', $now, set_value('now',$arms->ammubore.','.$arms->ammuwep),'id="now" data-placeholder="Choose One" title="Please select at least 1 value" class="select2" required'); 
 echo form_error('now');
/*----End newarea Textfield----*/
 ?>
                  ...
                  <div class="col-sm-9">
<?php
$acc = array('type' => 'text','name' => 'acc','id' => 'acc','class' => 'form-control','placeholder' =>'Rc No:','value' => $arms->rcno);
echo form_input($acc);
echo form_error('acc');
?>
                    <label for="acc" class="error"></label>
                      ...
                      <div class="form-group">
                  <label class="col-sm-3 control-label">Issued Quantity</label>
                  <div class="col-sm-9">
<?php
$ab = array('type' => 'text','name' => 'ab','id' => 'ab','class' => 'form-control','placeholder' =>'Quantity','required' => 'required','value' => $arms->qty, 'readonly' => 'readonly' );
echo form_input($ab);
echo form_error('ab');
?>
                  ...
                  <div class="form-group">
                  <label class="col-sm-3 control-label">Add Quantity</label>
                  <div class="col-sm-9">
<?php
$ab = array('type' => 'text','name' => 'qty','id' => 'ab','class' => 'form-control','placeholder' =>'Quantity','required' => 'required');
echo form_input($ab);
echo form_error('ab');
?>
                    <label for="ab" class="error"></label>
...
/*newarea Textfield*/
 echo form_dropdown('hn', $hn, set_value('hn',$arms->osi_id),'id="hn" data-placeholder="Choose One" title="Please select at least 1 area" class="select2"'); 
 echo form_error('hn');
/*----End newarea Textfield----*/
 ?>
