...
<head>
    ...
    <title>View Issue Arms List</title>
...
<?php $this->load->view(F_BTALION.'html/headbar'); ?>
    <div class="pageheader">
      <h2><i class="fa fa-building-o"></i> View issue arms list</h2>
      <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
          <li class="active"><a href="<?php echo base_url();?>bt-dashboard">Dashboard</a></li>
          <li class="active">View issue arms list</li>
        </ol>
      </div>
    </div>
  ...
  <strong>Success!</strong> <?php echo $this->session->flashdata('success_msg'); ?>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h3 class="panel-title">View issue arms list </h3>
          </div>
  ...
  <div class="dropdown-menu" id="colvis">
          ...
          <div class="table-responsive">
            <table class="table"  id="table">
              ...
              <tbody>
                <?php  $count = 0; foreach($arms as $value): $count = $count+1;
                ?>
                 <tr class="odd gradeX">
                    <td><?php echo $count; ?></td>
                    <td><?php $wep = explode(',', $value->weapon_id); $weapon = info_fetch_rec($wep); $prefix = '';  foreach ($weapon as  $val) {
      
                     echo $prefix . '' . $val['weapon_body_no']. '';
                      $prefix = ', ';
                    } ?></td>
                    <td><?php echo $value->mzqty; ?></td>
                    <td><?php echo $value->accesso; ?></td>
                    <td><?php echo $value->mode; ?></td>
                    <td><?php echo $value->issue_to; ?></td>
                    <td><?php echo $value->td; ?></td>
                    <td><?php if($value->holdname != 0 ){$user = fetchoneinfo(T_MANMASTER,array('man_master_id',$value->holdname)); echo $user->name; } else{echo '-';}?></td>
                    <td><?php $of = fetchoneinfo(T_OFFICER,array('officer_master_id',$value->protec)); echo $of->off_name; ?></td>
                   </tr>
                <?php endforeach; ?>
              </tbody>
           </table>
