...
<body>
      <h3 class="text-center"> &nbsp; &nbsp; STATEMENT OF ARMS <?php $val = explode(' ', $this->session->userdata('nick')); echo $val[0];  ?> BATTALION PAP, JRC </h3> 
      <div class="row">
              ...
              <tbody>
                <?php  if($msk!=''){ $count = 0; foreach($msk as $value): $count = $count + 1; ?>
                 ...
                 <td><?php echo $count;  ?></td>
                    ...
                    <td><?php $issued = info_fetch_countarmsanigp($value->arm); if($issued!=''){if($issued->sun == 0){echo "-";}else{echo $issued->sun; }
                    }else{echo "-";}  ?></td>
                    <td><?php $hold = info_fetch_countarmipg($value->arm); if($hold == 0){echo "-";}else{echo $hold;} ?></td>
                    <td><?php $issued = info_fetch_countarmissuedipg($value->arm); if($issued == 0){echo "-";}else{echo $issued;}  ?></td>
