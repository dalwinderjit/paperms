...
<head>
    ...
    <title>View Deposit Arms List</title>
...
<?php $this->load->view(F_BTALION.'html/headbar'); ?>
    <div class="pageheader">
      <h2><i class="fa fa-building-o"></i> View Deposit Arms List</h2>
      <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
          <li class="active"><a href="<?php echo base_url();?>bt-dashboard">Dashboard</a></li>
          <li class="active">View Deposit Arms List</li>
        </ol>
      </div>
    </div>
  ...
  <strong>Success!</strong> <?php echo $this->session->flashdata('success_msg'); ?>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h3 class="panel-title">View Deposit Arms List </h3>
          </div>
              ...
              <tbody>
                ...
                ?>
                 <tr class="odd gradeX">
                    ...
                    <td><?php $wep = explode(',', $value->body_no); $weapon = info_fetch_rec($wep); $prefix = '';  foreach ($weapon as  $val) {
      
                     echo $prefix . '' . $val['weapon_body_no']. '';
                      $prefix = ', ';
                    } ?></td>
                    <td><?php $user = fetchoneinfo(T_MANMASTER,array('man_master_id' => $value->holder_id)); 
                     echo $user->name;
                     ?></td>
                    <td><?php echo $value->recieve; ?></td>
