...
<head>
    ...
    <title>Condem Material Reports</title>
  ...
  <strong>Success!</strong> <?php echo $this->session->flashdata('success_msg'); ?>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body"> 
          ...
          <h3>Total Entries: <?php if($weapon!=''){echo count($weapon) + count($mskd);}else{echo "0";} ?> <span class="pull-right"><h3>Total Quantities: <?php if($cl!=''){ foreach($cl as $val){echo $val->total;}}else{echo "0";} ?></H3></span></h3>
                    ...
                    <td><?php echo $value->recfrom; ?></td> 
                     ...
                     <td><?php echo $value->recdate; ?> <?php //echo $value->per_rec_date; ?> <?php echo $value->per_rec_date; ?></td> 
                      <td><?php echo $value->billno; ?></td>
                       ...
                       <td><a href="<?php echo base_url('bt-condemlistmskactions/'.$value->msk_id); ?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure you want to Auction this Item?');">Auction</a> <a href="<?php echo base_url('bt-mskbackstore/'.$value->msk_id); ?>" class="btn btn-info btn-xs" onclick="return confirm('Are you sure you want Back to sotre this Item?');">Back to store</a> </td></tr>
                <?php endforeach; } ?>
                    ...
                    <td><?php //echo $value->recfrom; ?></td> 
                     ...
                     <td><?php //echo $value->recdate; ?> <?php //echo $value->per_rec_date; ?> <?php //echo $value->per_rec_date; ?></td> 
                      <td><?php //echo $value->billno; ?></td>
                       <td><?php //echo $value->billdate; ?></td> 
                       <td><?php //echo $value->fund_name.$value->govt_fund; ?></td>
                       <td><a href="<?php echo base_url('bt-mskauctionlists/'.$value->deposit_material_id); ?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure you want to Auction this Item?');">Auction</a>  <a href="<?php echo base_url('bt-mskbackstores/'.$value->deposit_material_id); ?>" class="btn btn-info btn-xs" onclick="return confirm('Are you sure you want Back to sotre this Item?');">Back to store</a> </td>
                    </tr>
                <?php endforeach; ?>
              </tbody>
           </table>
