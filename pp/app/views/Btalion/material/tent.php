...
<body>
    <h3 class="text-center">DETAIL OF TENTS <?php $val = explode(' ', $this->session->userdata('nick')); echo $val[0];  ?> <?php $val = explode(' ', $this->session->userdata('nick2')); echo $val[0];  ?> FOR THE MONTH OF <?php echo strtoupper(date('M-Y')); ?></h3>
            ...
            <table class="table table-bordered"  id="table">
              ...
              <tr>
               ...
               <td><?php $sans = info_fetch_msksan('Store Tent D/F',$ninfo); if($sans!=''){echo $sans->san;}else{echo "-";} ?></td>
                ...
                <td><?php /*$asec = '';
                 ...
                 $ser1 = info_fetch_countunserviables('Store Tent D/F',$ninfo); 
                 $ser2 = info_fetch_countunserviablesdep('Store Tent D/F',$ninfo); 
                 $ser3 = info_fetch_countunserviablesdepoo('Store Tent D/F',$ninfo); 
              ...
              <tr>
                ...
                <td><?php /*$asec = '';
                 ...
                 $ser1 = info_fetch_countunserviables('EPIP Tent D/F',$ninfo); 
                 $ser2 = info_fetch_countunserviablesdep('EPIP Tent D/F',$ninfo); 
                 $ser3 = info_fetch_countunserviablesdepoo('EPIP Tent D/F',$ninfo); 
              ...
              <tr>
               <td>3</td>
                ...
                <td><?php /*$asec = '';
                 ...
                 $ser1 = info_fetch_countunserviables('EPIP Water Proof Tent',$ninfo); 
                 $ser2 = info_fetch_countunserviablesdep('EPIP Water Proof Tent',$ninfo); 
                 $ser3 = info_fetch_countunserviablesdepoo('EPIP Water Proof Tent',$ninfo); 
               ...
               <td><?php 
                ...
                <td><?php /*$asec = '';
                 ...
                 $ser1 = info_fetch_countunserviables('Tent 180 LBS',$ninfo); 
                 $ser2 = info_fetch_countunserviablesdep('Tent 180 LBS',$ninfo); 
                 $ser3 = info_fetch_countunserviablesdepoo('Tent 180 LBS',$ninfo); 
               ...
               <tr>
                ...
                <td><?php /*$asec = '';
                 ...
                 $ser1 = info_fetch_countunserviables('180 LBS water Proof Tent',$ninfo); 
                 $ser2 = info_fetch_countunserviablesdep('180 LBS water Proof Tent',$ninfo); 
                 $ser3 = info_fetch_countunserviablesdepoo('180 LBS water Proof Tent',$ninfo); 
               ...
               <td><?php 
                ...
                <td><?php /*$asec = '';
                 ...
                 $ser1 = info_fetch_countunserviables('Tent 40 Pound D/F',$ninfo); 
                 $ser2 = info_fetch_countunserviablesdep('Tent 40 Pound D/F',$ninfo); 
                 $ser3 = info_fetch_countunserviablesdepoo('Tent 40 Pound D/F',$ninfo); 
               ...
               <tr>
                ...
                <td><?php /*$asec = '';
                 ...
                 $ser1 = info_fetch_countunserviables('Latrine Tent',$ninfo); 
                 $ser2 = info_fetch_countunserviablesdep('Latrine Tent',$ninfo); 
                 $ser3 = info_fetch_countunserviablesdepoo('Latrine Tent',$ninfo); 
              ...
              <tr>
                ...
                <td><?php /*$asec = '';
                 ...
                 $ser1 = info_fetch_countunserviables('Tent Service Pole',$ninfo); 
                 $ser2 = info_fetch_countunserviablesdep('Tent Service Pole',$ninfo); 
                 $ser3 = info_fetch_countunserviablesdepoo('Tent Service Pole',$ninfo); 
              ...
              <tr>
                ...
                <td><?php /*$asec = '';
                 ...
                 $ser1 = info_fetch_countunserviables('Swiss Cottage 10"x10"',$ninfo); 
                 $ser2 = info_fetch_countunserviablesdep('Swiss Cottage 10"x10"',$ninfo); 
                 $ser3 = info_fetch_countunserviablesdepoo('Swiss Cottage 10"x10"',$ninfo); 
              ...
              <tr>
                ...
                <td><?php /*$asec = '';
                 ...
                 $ser1 = info_fetch_countunserviables('Swiss Cottage 12"x12"',$ninfo); 
                 $ser2 = info_fetch_countunserviablesdep('Swiss Cottage 12"x12"',$ninfo); 
                 $ser3 = info_fetch_countunserviablesdepoo('Swiss Cottage 12"x12"',$ninfo); 
               ...
               <tr>
                ...
                <td>11</td>
                <td>Arctic Tent Medium</td>
                 <td><?php $sans = info_fetch_msksan('Arctic Tent Medium',$ninfo); if($sans!=''){echo $sans->san;}else{echo "-";} ?></td>
                <td><?php $hold = info_fetch_countmskitemii('Arctic Tent Medium',$ninfo); 
                $holds = info_fetch_countmskitemiis('Arctic Tent Medium',$ninfo);
                 //if($hold!='' && $holds!=''){//echo $hold->qty + $holds->issued;}else{echo "-";}
                $asec = '';
                 $ser1 = info_fetch_countserviable('Arctic Tent Medium',$ninfo); 
                 if($ser1!=''){ $asec .= $ser1->recqut;}
                  $bsec = '';
                  $ser1 = info_fetch_countunserviable('Arctic Tent Medium',$ninfo); 
                 if($ser1!=''){ $bsec .= $ser1->total;}

                 $csec = '';
                 $ser1 = info_fetch_countunserviables('Arctic Tent Medium',$ninfo); 
                 $ser2 = info_fetch_countunserviablesdep('Arctic Tent Medium',$ninfo); 
                  $csec.= $ser1->recqut /*+ $ser2->quantity*/;
                 echo $t =  $asec + $bsec + $csec;
                 ?></td>
                <td><?php   $i = '';
                ...
                <td><?php /*$asec = '';
                 ...
                 $ser1 = info_fetch_countunserviables('Arctic Tent Medium',$ninfo); 
                 $ser2 = info_fetch_countunserviablesdep('Arctic Tent Medium',$ninfo); 
                 $ser3 = info_fetch_countunserviablesdepoo('Arctic Tent Medium',$ninfo); 
               ...
               <td><?php 
                ...
                <td>-</td>
                  ...
                  <tr>
                <td>12</td>
                <td>Tent 4mm Unit with Mild Steel Joints Flooring TPO and FMUB</td>
                 <td><?php $sans = info_fetch_msksan('Tent 4mm Unit with Mild Steel Joints Flooring TPO and FMUB',$ninfo); if($sans!=''){echo $sans->san;}else{echo "-";} ?></td>
                <td><?php $hold = info_fetch_countmskitemii('Tent 4mm Unit with Mild Steel Joints Flooring TPO and FMUB',$ninfo); 
                $holds = info_fetch_countmskitemiis('Tent 4mm Unit with Mild Steel Joints Flooring TPO and FMUB',$ninfo);
                 //if($hold!='' && $holds!=''){//echo $hold->qty + $holds->issued;}else{echo "-";}
                $asec = '';
                 $ser1 = info_fetch_countserviable('Tent 4mm Unit with Mild Steel Joints Flooring TPO and FMUB',$ninfo); 
                 if($ser1!=''){ $asec .= $ser1->recqut;}
                  $bsec = '';
                  $ser1 = info_fetch_countunserviable('Tent 4mm Unit with Mild Steel Joints Flooring TPO and FMUB',$ninfo); 
                 if($ser1!=''){ $bsec .= $ser1->total;}

                 $csec = '';
                 $ser1 = info_fetch_countunserviables('Tent 4mm Unit with Mild Steel Joints Flooring TPO and FMUB',$ninfo); 
                 $ser2 = info_fetch_countunserviablesdep('Tent 4mm Unit with Mild Steel Joints Flooring TPO and FMUB',$ninfo); 
                  $csec.= $ser1->recqut /*+ $ser2->quantity*/;
                 echo $t =  $asec + $bsec + $csec;
                 ?></td>
                <td><?php   $i = '';
                ...
                <td><?php /*$asec = '';
                 ...
                 $ser1 = info_fetch_countunserviables('Tent 4mm Unit with Mild Steel Joints Flooring TPO and FMUB',$ninfo); 
                 $ser2 = info_fetch_countunserviablesdep('Tent 4mm Unit with Mild Steel Joints Flooring TPO and FMUB',$ninfo); 
                 $ser3 = info_fetch_countunserviablesdepoo('Tent 4mm Unit with Mild Steel Joints Flooring TPO and FMUB',$ninfo); 
