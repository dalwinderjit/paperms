        ...
        <div class="panel-body"> 
          <div class="table-responsive">
            <table class="table  table-fixedheader"  id="table">
              ...
              <tbody>
                <?php  if($msk!=''){ foreach($msk as $value): ?>
                 <tr class="odd gradeX">
                    <td><?php echo $value->typeofitem;  ?></td>
                    <td><?php $hold = info_fetch_countmsk($value->typeofitem,$ninfo); echo $hold; ?></td>
                    <td><?php  $issued = info_fetch_countmskissued($value->typeofitem,$ninfo); echo  $hold - $issued; ?></td>
                    <td><?php  echo $issued; ?></td>
                <?php endforeach; } ?>
              </tbody>
               <tfoot>
                <tr>
                  <td colspan="4">Report genrated by: <strong><?php echo $this->session->userdata('username'); ?></strong> <span class="pull-right">Date: <strong><?php echo date('d-m-Y h:i:A'); ?></strong></span></td>
                </tr>
              </tfoot>
           </table>
