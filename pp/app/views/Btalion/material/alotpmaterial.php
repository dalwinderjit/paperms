...
/*----End newarea Textfield----*/
 ?>
                 ...
                 <div class="form-group" id="MudDuties1"  style="display:none">
                  ...
                  <div class="col-sm-9">
 <?php  
$MudDuties = array('' => '--Select--', 'Reserve Inspector' => 'Reserve Inspector', 'Line Officer' => 'Line Officer', 'BHM' => 'BHM','A-BHM'=> 'A-BHM','A/BHM'=> 'A/BHM', 'MHC' => 'MHC', 'A/MHC' => 'A/MHC',  'Orderly to RI' => 'Orderly to RI','CDI' => 'CDI','CDO' => 'CDO','A/CDO' => 'A/CDO', 'Quarter Master INSP' => 'Quarter Master INSP','KHC' => 'KHC','A/KHC' => 'A/KHC','MSK' => 'MSK','A/MSK' => 'A/MSK',  'Armourer ' => 'Armourer','A/Armourer' => 'A/Armourer', 'I/C Class-IV' => 'I/C Class-IV','Quarter Munshi  Asstt.' => 'Quarter Munshi Asstt.','Quarter Munshi' => 'Quarter Munshi','I/C Mess' => 'I/C Mess','I/C Mess Asstt.' => 'I/C Mess Asstt.','I/C Canteen' => 'I/C Canteen','Grossary Shop' => 'Grossary Shop', 'Incharge' => 'Incharge', 'Incharge Asstt'=> 'Incharge Asstt','CHC' => 'CHC','I/C Training Store' => 'I/C Training Store','I/C Sets & I Fats' => 'I/C Sets & I Fats','I/C Gas Agency' => 'I/C Gas Agency','I/C CHC' => 'I/C CHC','I/C Beautification' => 'I/C Beautification','I/C Electrician' => 'I/C Electrician','I/C Cafe' => 'I/C Cafe');
...
$OtherAttachmentDuties = array('' => '--Select--', 'District' => 'District', 'Police security wing under 13th Bn' => 'Police security wing under 13th Bn','CPO Punjab chg under 13th Bn' => 'CPO Punjab chg under 13th Bn','CPL reserve under 13th Bn' => 'CPL reserve under 13th Bn','VIP security under 82th Bn' => 'VIP security under 82th Bn','Special Protection Unit ( CM Security)' => 'Special Protection Unit ( CM Security)','Intelligence wing' =>'Intelligence wing','Vigilance wing' => 'Vigilance wing','NRI Wing' => 'NRI Wing','Bureau of Investigation' =>'Bureau of Investigation','State Narcotic Bureau' => 'State Narcotic Bureau','Airport Immigration' => 'Airport Immigration','Passport Office' => 'Passport Office','State Crime Record Bureau' => 'State Crime Record Bureau','National Crime Record Bureau' => 'National Crime Record Bureau', 'Counter Intelligence' => 'Counter Intelligence','State Human Rights Commission' => 'State Human Rights Commission','RTC' => 'RTC','ISTC' => 'ISTC','CTC BHG' => 'CTC BHG','PPA Phillaur' => 'PPA Phillaur','PRTC Jahankhelan' => 'PRTC Jahankhelan', 'Ladda Kothi Sangrur' => 'Ladda Kothi Sangrur','Other Armed Battalion' => 'Other Armed Battalion','Other' => 'Other');
 ...
 ?>
                 ...
                 <div class="form-group"  id="admblock1"  style="display:none">
                  ...
                  <div class="col-sm-9">
 <?php  
$admblock = array('' => '--Select--', 'Office SPL. DG, SAP' => 'Office SPL. DG, SAP','Office ADGP' => 'Office ADGP', 'Office IGP PAP' => 'Office IGP PAP', 'Office IGP PAP-II' => 'Office IGP PAP-II', 'Office IGP Training' => 'Office IGP Training', 'Office IGP Operations' => 'Office IGP Operations','Office DIG Admn' => 'Office DIG Admn','Office AIG PAP' => 'Office AIG PAP','Office AIG PAP-II' => 'Office AIG PAP-II','Office AIG L&O' => 'Office AIG AIG L&O','Office SP Admn' => 'Office SP Admn','Confidential Branch' => 'Confidential Branch','SO Audit' => 'SO Audit','DA Legal' => 'DA Legal','EO Armed Bns' => 'EO Armed Bns','Supdt Admn' => 'Supdt Admn','Supdt Acctt' => 'Supdt Acctt','Supdt Training' => 'Supdt Training','Line Officer Admn Block' => 'Line Officer Admn Block','ERMS office' => 'ERMS Office','PAP House' => 'PAP House','Govt Resi IGP PAP' => 'Govt Resi IGP PAP','Govt Resi IGP PAP-II' => 'Govt Resi IGP PAP-II','Govt Resi DIG Admn' => 'Govt Resi DIG Admn','Govt Resi IGP Training' => 'Govt Resi IGP Training','Govt Resi IGP Operation' => 'Govt Resi IGP Operation','AIG ARP' => 'AIG ARP','Govt Resi AIG PAP' => 'Govt Resi AIG PAP','Control Room PAP' => 'Control Room PAP','Photostate Cell' => 'Photostate Cell','Photography Cell' => 'Photography Cell','PAP Cricket Academy' => 'PAP Cricket Academy','Guest Room Admn Block' => 'Guest Room Admn Block','MSK Admn Block'=>'MSK Admn Block');
 ...
 ?>
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label">Issued RC/ORDER No.</label>
                  <div class="col-sm-9">
<?php
$ircn = array('type' => 'text','name' => 'ircn','id' => 'ircn','class' => 'form-control','placeholder' =>'Issued RC/ORDER No.','value' => set_value('ircn'));
...
?>
                 ...
                 <div class="form-group">
                  <label class="col-sm-3 control-label"> Issued RC/ORDER Date</label>
                  <div class="col-sm-9">
             <div class="input-group">
              <?php 
$ircd = array('type' => 'text','name' => 'ircd','id' => 'ircd','class' => 'form-control','placeholder' =>'Issued RC/ORDER Date','value' => set_value('ircd'));
