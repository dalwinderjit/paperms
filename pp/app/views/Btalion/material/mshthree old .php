...
<body>  
            <h3 class="text-center">DETAIL OF MISCELLANEOUS ARTICLES <?php $val = explode(' ', $this->session->userdata('nick')); echo $val[0];  ?> BATTALION,PAP JRC FOR THE MONTH OF <?php echo strtoupper(date('M-Y')); ?></h3>
                    <div class="row">
          <div class="col-sm-10 col-xs-offset-1">
            <table class="table table-bordered"  id="table">
              ...
              <tr>
               ...
               <td><?php 
                 $ser1 = info_fetch_countunserviables('Steel Bed Wooden',$ninfo); 
                 if($ser1!=''){ echo $ser1->recqut;}else{echo'-';} ?></td>
                <td>-</td>
                <td>-</td>
              </tr>
              <tr>
