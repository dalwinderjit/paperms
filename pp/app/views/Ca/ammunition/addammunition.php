...
<?php $this->load->view(F_CA.'html/headbar'); ?>
    <div class="pageheader">
      <h2><i class="fa fa-building-o"></i>Add Ammunition</h2>
      <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
          <li class="active"><a href="<?php echo base_url();?>ca-dashboard">Dashboard</a></li>
          <li class="active">Add Ammunition</li>
        </ol>
      </div>
    </div>
...
?>
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Add New Ammunition</h4>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                 <?php 
                 $tow = array('Rounds' => 'Rounds','Cartridges' => 'Cartridges','Others' =>'Others','Grnades' => 'Grnades'); 
...
/*----End newarea Textfield----*/
 ?> <label for="bodyno" class="error"></label>
             ...
             <?php 
                 $now = array();
                  $now[''] = 'Select Ammunition weapon'; 
                 foreach ($weapon as $value) {
                   $now[$value->weapon_name.','.$value->ammunition_bore] = 'Weapon Name:&nbsp; '. $value->weapon_name.' &nbsp; Bore: &nbsp; '.$value->ammunition_bore;
                 }
/*newarea Textfield*/
