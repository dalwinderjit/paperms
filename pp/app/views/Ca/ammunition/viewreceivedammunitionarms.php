...
<head>
    ...
    <title>CA::View Recieve Ammunition List </title>
...
<?php $this->load->view(F_CA.'html/headbar'); ?>
    <div class="pageheader">
      <h2><i class="fa fa-building-o"></i> View Recieve Ammunition List </h2>
      <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
          <li class="active"><a href="<?php echo base_url();?>ca-dashboard">Dashboard</a></li>
          <li class="active">View Recieve Ammunition List </li>
        </ol>
      </div>
    </div>
  ...
  <strong>Success!</strong> <?php echo $this->session->flashdata('success_msg'); ?>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h3 class="panel-title">View Recieve Ammunition List </h3>
          </div>
          ...
          <div class="table-responsive">
            <table class="table"  id="table">
              <thead>
                 <tr>
                    <th>S.No</th>
                    <th>Ammunition/Accessories</th>
                    <th>Ammunition Details</th>
                    <th>Quantity</th>
                    <th>Mode</th>
                 </tr>
              </thead>
              <tbody>
                <?php  $count = 0; foreach($arms as $value): $count = $count+1; ?>
                 <tr class="odd gradeX">
                    ...
                    <td><?php echo $value->am_ac; ?></td>
                    <td><?php echo $value->ammu_details; ?></td>
                    <td><?php echo $value->qunty; ?></td>
