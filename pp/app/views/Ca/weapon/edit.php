		...
		<div class="panel-body">
			<div class="row">
				...
				<?php 	/*Create HTML form*/
					...
					echo form_open_multipart("ca-khc-weapon-edit/".$weapon->nwep_id, $attributes); 
				...
				<div class="col-md-12">
					...
					$arm = [
						...
						'class' => 'form-control',
						'disabled'=>'true',
						'value' => set_value('arm',$weapon->arm),
					];
					echo form_input($arm);
					echo form_error('arm');
					?>
				...
				<div class="col-md-12">
					...
					<?php //var_dump($weapon_main_categories); 
						echo form_dropdown('weapon_main_category', $categories, set_value('weapon_main_category',$weapon->main_category_id),'id="weapon_main_category" data-placeholder="Select Weapon main category" title="Please select Weapon main category)" class="select2" onChange="get_sub_categories()"');
				...
				<div class="col-md-12">
					...
					<?php //var_dump($weapon_main_categories); 
						echo form_dropdown('weapon_sub_category', $subCategories, set_value('weapon_sub_category',$weapon->sub_category_id),'id="weapon_sub_category" data-placeholder="Select Weapon Sub category" title="Please select Weapon Sub category)" class="select2"');
