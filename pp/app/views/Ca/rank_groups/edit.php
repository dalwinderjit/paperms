		...
		<div class="panel-body">
			<div class="row">
				...
				<?php 	/*Create HTML form*/
					...
					echo form_open_multipart("ca-rank-groups-edit/".$rank_group->id, $attributes); 
				...
				<?php
					...
					$title = [
						...
						'class' => 'form-control',
						//'disabled'=>'true',
						'value' => set_value('title',$rank_group->title),
					];
				...
				<?php
					...
					$description = [
						...
						'class' => 'form-control',
						//'disabled'=>'true',
						'value' => set_value('description',$rank_group->description),
					];
