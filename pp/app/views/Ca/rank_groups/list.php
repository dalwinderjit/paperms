...
<head>
  ...
  <title>Rank Groups Management</title>
			...
			<div class="panel-heading">
				<table style="width:100%;">
					<tr>
						...
						<td class="text-right"><a href="<?php echo base_url().'ca-rank-groups-add';?>" class="btn btn-primary">Add new Rank Group</a></td>
					</tr>
				</table>
			</div>
...
$(document).ready(function(){
	var dataTable = $('#rank_groups').DataTable({
		...
		"order":[],
		"ajax":{
			url:"<?php echo base_url() .'ca-rank-groups-ajax';?>",
			type:"POST",
			"data":function(data){
