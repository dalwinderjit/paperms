...
<?php $this->load->view(F_CA.'html/navbar');  ?>
	...
	<?php $this->load->view(F_CA.'/html/headbar'); ?>
		<div class="pageheader">
			<h3> &nbsp;  &nbsp; Weapon Main Category Management</h3>
		</div>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<table style="width:100%;">
					<tr>
						<td><h3>Weapons Main Categories</h3></td>
						<td class="text-right"><a href="<?php echo base_url().'ca-khc-weapon-main-category-add';?>" class="btn btn-primary">Add new Main Weapon Category</a></td>
					</tr>
				</table>
			</div>
			...
			<div class="row">
				<?php 
					...
					echo form_open_multipart("ca-khc-weapon-main-category-list", $attributes);?>
...
$(document).ready(function(){
	var dataTable = $('#user_data').DataTable({
		...
		"order":[],
		"ajax":{
			url:"<?php echo base_url() .'ca-khc-ajax-weapon-main-category-list';?>",
			type:"POST",
			"data":function(data){
				data.name = $('#name').val()
			},
