		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<table style="width:100%;">
					<tbody>
						<tr>
							<td><h3>Edit Weapon Main Category</h3></td>
							<td class="text-right"><a href="<?php echo base_url().'ca-khc-weapon-main-category-list';?>" class="btn btn-primary">Weapon main category list</a></td>
						</tr>
					</tbody>
				</table>
				<style>
		...
		<div class="panel-body">
			<div class="row">
				...
				<?php 	/*Create HTML form*/
					...
					echo form_open_multipart("ca-khc-weapon-main-category-edit/".$category->id, $attributes); 
				...
				<div class="col-md-12">
					...
					$name = [
						...
						'id'        => 'name',
						'class' => 'form-control',
						'value' => set_value('arm',$category->name),
					];
