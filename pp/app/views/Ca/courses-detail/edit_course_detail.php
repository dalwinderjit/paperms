		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<table style="width:100%;">
					<tbody>
						<tr>
							<td><h3>Edit Course Detail Name</h3></td>
							<td class="text-right"><a href="<?php echo base_url().'course-detail/list';?>" class="btn btn-primary">Course Detail list</a></td>
						</tr>
					</tbody>
				</table>
				<style>
		...
		<div class="panel-body">
			<div class="row">
				...
				<?php 	/*Create HTML form*/
					...
					echo form_open_multipart("course-detail/edit-course-detail/".$course_detail->id, $attributes); 
				...
				<?php
					...
					$title = [
						...
						'id'        => 'title',
						'class' => 'form-control',
						'value' => set_value('title',$course_detail->title),
					];
				...
				<?php
					...
					echo form_dropdown('training_institute_id', $training_institutes, set_value('training_institute_id',$course_detail->training_institute_id),'id="training_institute_id" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
				...
				<?php
					...
					echo form_dropdown('course_id', $courses, set_value('course_id',$course_detail->course_id),'id="course_id" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
				...
				<?php
					...
					$order_no = [
						...
						'id'        => 'order_no',
						'class' => 'form-control',
						'value' => set_value('order_no',$course_detail->order_no),
					];
				...
				<?php
					...
					$course_order_date = [
						...
						'class' => 'form-control',
						'value' => set_value('course_order_date',$course_detail->order_date),
					];
				...
				<?php
					...
					$course_start_date = [
						...
						'class' => 'form-control',
						//'disabled'=>'true',
						'value' => set_value('course_start_date',$course_detail->start_date),
					];
				...
				<?php
					...
					$course_end_date = [
						...
						'class' => 'form-control',
						//'disabled'=>'true',
						'value' => set_value('course_end_date',$course_detail->end_date),
					];
				...
				<?php 
					...
					echo form_dropdown('enabled', $enabled, set_value('enabled',$course_detail->enabled),'id="enabled" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
				...
				<?php 
					...
					echo form_dropdown('deleted', $deleted, set_value('deleted',$course_detail->deleted),'id="deleted" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
