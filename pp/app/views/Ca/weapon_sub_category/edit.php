		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<table style="width:100%;">
					<tbody>
						<tr>
							<td><h3>Edit Weapon Sub Category</h3></td>
							<td class="text-right"><a href="<?php echo base_url().'ca-khc-weapon-sub-category-list';?>" class="btn btn-primary">Weapon main category list</a></td>
						</tr>
					</tbody>
				</table>
				<style>
		...
		<div class="panel-body">
			<div class="row">
				...
				<?php 	/*Create HTML form*/
					...
					echo form_open_multipart("ca-khc-weapon-sub-category-edit/".$sub_category->id, $attributes); 
				...
				<div class="col-md-12">
					...
					$name = [
						...
						'id'        => 'name',
						'class' => 'form-control',
						'value' => set_value('name',$sub_category->name),
					];
				...
				<div class="col-md-12">
					...
					<?php //var_dump($weapon_main_categories); 
						echo form_dropdown('weapon_main_category', $categories, set_value('weapon_main_category',$sub_category->weapon_category_id),'id="weapon_main_category" data-placeholder="Select Weapon main category" title="Please select Weapon main category)" class="select2"');
