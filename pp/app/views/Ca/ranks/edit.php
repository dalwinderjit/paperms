		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<table style="width:100%;">
					<tbody>
						<tr>
							<td><h3>Edit Rank</h3></td>
							<td class="text-right"><a href="<?php echo base_url().'ca-ranks';?>" class="btn btn-primary">Rank list</a></td>
						</tr>
					</tbody>
				</table>
				<style>
		...
		<div class="panel-body">
			<div class="row">
				...
				<?php 	/*Create HTML form*/
					...
					echo form_open_multipart("ca-ranks-edit/".$rank->id, $attributes); 
				...
				<?php
					...
					$name = [
						...
						'class' => 'form-control',
						//'disabled'=>'true',
						'value' => set_value('name',$rank->name),
					];
				...
				<?php
					...
					$description = [
						...
						'class' => 'form-control',
						//'disabled'=>'true',
						'value' => set_value('description',$rank->description),
					];
				...
				<?php
					...
					$short_name = [
						...
						'class' => 'form-control',
						//'disabled'=>'true',
						'value' => set_value('short_name',$rank->short_name),
					];
				...
				<?php
					...
					echo form_dropdown('rank_group_id',$rank_groups,set_value('rank_group_id',$rank->rank_group_id),'name="rank_group_id" class="select2" id="rank_group_id"');
