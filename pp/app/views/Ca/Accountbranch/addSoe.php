...
?>
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Add New SOE</h4>
              ...
              <div class="panel-body">
				  <div class="form-group">
					  ...
					  <div class="col-sm-9">
					 <?php 
						$title = array('type' => 'text','name' => 'title','id' => 'title','class' => 'form-control','placeholder' =>'Enter Wage Title','value' => set_value('title'));
              ...
              <div class="panel-footer">
                <div class="row">
                  <div class="col-sm-9 col-sm-offset-3">
                    <button type="submit" class="btn btn-primary" name="submit" value="1">Add SOE</button>
