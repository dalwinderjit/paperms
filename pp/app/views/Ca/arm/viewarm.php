...
<?php $this->load->view(F_CA.'html/headbar'); ?>
    <div class="pageheader">
      <h2><i class="fa fa-building-o"></i> View Arms list</h2>
      <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
          <li class="active"><a href="<?php echo base_url();?>ca-dashboard">Dashboard</a></li>
          <li class="active">View Arms list</li>
        </ol>
      </div>
    </div>
  ...
  <strong>Success!</strong> <?php echo $this->session->flashdata('success_msg'); ?>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h3 class="panel-title">View Arms list </h3>
          </div>
              ...
              <tbody>
                <?php  $count = 0; foreach($weapon as $value): $count = $count+1; ?>
                 <tr class="odd gradeX">
                    ...
                    <td><?php echo $value->weapon_body_no ; ?></td>
                    <td><?php echo $value->weapon_butt_no; ?></td>
                    <td><?php echo $value->rec_date; ?></td>
                    <td><?php echo $value->magazine_qty; ?></td>
                    <td><?php echo $value->vocher_no; ?></td>
                    <td><?php echo $value->voucher_date; ?></td>
                   <!--  <td><a href="<?php //echo base_url();?>ca-update-arm/<?php //echo $value->weapon_id; ?>" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</a></td> -->
                  </tr>
                <?php endforeach; ?>
              </tbody>
           </table>
