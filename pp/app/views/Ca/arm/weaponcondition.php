...
<?php $this->load->view(F_CA.'html/headbar'); ?>
    <div class="pageheader">
      <h2><i class="fa fa-building-o"></i>Weapon Condition</h2>
...
?>
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Weapon Condition</h4>
              </div>
              <div class="panel-body">

                  <div class="form-group">
                  <label class="col-sm-3 control-label">Name of Weapon</label>
                  <div class="col-sm-9">
                 <?php  
$now = array('1','2');
/*newarea Textfield*/
 echo form_dropdown('now', $now, set_value('now',1),'id="now" data-placeholder="Choose One" title="Please select at least 1 area" class="select2" required'); 
 echo form_error('now');
/*----End newarea Textfield----*/
 ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
<?php
$bodyno = array('type' => 'text','name' => 'bodyno','id' => 'bodyno','class' => 'form-control','placeholder' =>'Body No','required' => 'required','value' => set_value('bodyno'));
echo form_input($bodyno);
...
?>
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label">Butt No</label>
                  <div class="col-sm-9">
<?php 
$buttno = array('type' => 'text','name' => 'buttno','id' => 'buttno','class' => 'form-control','placeholder' =>'Butt No','required' => 'required','value' => set_value('buttno'));
echo form_input($buttno);
echo form_error('buttno');
?>
                    <label for="buttno" class="error"></label>
                  </div>
                </div>
                <!-- form-group --><!--*** Text field-->

                <div class="form-group">
                  <label class="col-sm-3 control-label">Condition of Weapon</label>
                  <div class="col-sm-9">
<?php 
$cow = array('type' => 'text','name' => 'cow','id' => 'cow','class' => 'form-control','placeholder' =>'Condition of Weapon','required' => 'required','value' => set_value('cow'));
echo form_input($cow);
echo form_error('cow');
?>
...
/*----End newarea Textfield----*/
 ?>
                  ...
                  <div class="form-group">
                  <label class="col-sm-3 control-label">Status of Un-Serviceable Weapon in Kot</label>
                  <div class="col-sm-9">
                 <?php  
$suw = array('1','2');
/*newarea Textfield*/
