...
<head>
    ...
    <title>CA::View Issue Arms List</title>
              ...
              <tbody>
                ...
                ?>
                 <tr class="odd gradeX">
                    ...
                    <td><?php $wep = explode(',', $value->weapon_master_id); $weapon = info_fetch_rec($wep); $prefix = '';  foreach ($weapon as  $val) {
      
                     echo $prefix . '' . $val['weapon_body_no']. '';
                      $prefix = ', ';
                    } ?></td>
                    <td><?php echo $value->issue_date; ?></td>
                    <td><?php echo $value->rc_no; ?></td>
                    <td><?php echo $value->megqty; ?></td>
                    <td><?php echo $value->user_name; ?></td>
                    <!-- <td><a href="<?php //echo base_url(); ?>ca-update-issue/<?php //echo $value->issue_arm_id ?>" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</a></td> -->
                  </tr>
                <?php endforeach; ?>
              </tbody>
           </table>
