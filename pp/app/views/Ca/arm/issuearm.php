...
?>
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Issue Arms To Battalion</h4>
              </div>
              <div class="panel-body">
                 ...
                 foreach ($bodys as $value) {
                   $tow[$value->old_weapon_id] = 'Weapon Type: '.$value->tow.'&nbsp; - Butt No: '.$value->buno.'&nbsp; - Body No: '.$value->bono;
                 }
/*newarea Textfield*/
 echo form_dropdown('bodyno[]', $tow, set_value('bodyno',''),'id="bodyno" data-placeholder="Choose One Body No" title="Please select at least 1 value" class="select2" multiple required'); 
...
<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                  ...
                  <div class="form-group">
                  <label class="col-sm-3 control-label">Issued to battalion/unit</label>
                  <div class="col-sm-9">
                 <?php  
                 $ito = array(); 
