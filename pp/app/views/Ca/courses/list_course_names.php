		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<table style="width:100%;">
					<tr>
						<td><h3>Course Name List</h3></td>
						<td class="text-right"><a href="<?php echo base_url().'course/add-course-name';?>" class="btn btn-primary">Add new Course Name</a></td>
					</tr>
				</table>
			</div>
...
$(document).ready(function(){
	var dataTable = $('#course_names').DataTable({
		...
		"order":[],
		"ajax":{
			url:"<?php echo base_url() .'course/ajax-list-course-names';?>",
			type:"POST",
			"data":function(data){
