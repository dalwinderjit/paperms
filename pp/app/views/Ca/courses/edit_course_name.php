...
<head>
  ...
  <title>Course Name Management</title>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<table style="width:100%;">
					<tbody>
						<tr>
							<td><h3>Edit Course Name</h3></td>
							<td class="text-right"><a href="<?php echo base_url().'course/list-course-names';?>" class="btn btn-primary">Course Name list</a></td>
						</tr>
					</tbody>
				</table>
				<style>
		...
		<div class="panel-body">
			<div class="row">
				<?php 	/*Create HTML form*/
					...
					echo form_open_multipart("course/edit-course-name//".$course->id, $attributes); 
				...
				<BR>
				<?php 
					echo form_dropdown('enabled', $enabled, set_value('enabled',$course->enabled),'id="enabled" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
				...
				<BR>
				<?php 
					echo form_dropdown('deleted', $deleted, set_value('deleted',$course->deleted),'id="deleted" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
