		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<table style="width:100%;">
					<tr>
						<td><h3>Training Institute List</h3></td>
						<td class="text-right"><a href="<?php echo base_url().'training-institute/add-institute';?>" class="btn btn-primary">Add new Training Institute</a></td>
					</tr>
				</table>
			</div>
...
$(document).ready(function(){
	var dataTable = $('#course_names').DataTable({
		"processing":true,
		"serverSide":true,
		"order":[],
		"ajax":{
			url:"<?php echo base_url() .'training-institute/ajax-institute-list';?>",
			type:"POST",
			"data":function(data){
