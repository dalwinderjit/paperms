		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<table style="width:100%;">
					<tbody>
						<tr>
							<td><h3>Add Training Institute Name</h3></td>
		...
		<div class="panel-body">
			<div class="row">
				...
				<?php 	/*Create HTML form*/
					...
					echo form_open_multipart("training-institute/add-institute", $attributes); 
				...
				<div class="col-md-12">
				<?php
					echo form_label('Enter Institute Name','institute_name');
					$institute_name = [
						'name'      => 'institute_name',
						'id'        => 'institute_name',
						'class' => 'form-control',
				...
				<?php
					...
					$institute_address = [
						...
						'class' => 'form-control',
						//'disabled'=>'true',
						'value' => set_value('institute_address'),
					];
