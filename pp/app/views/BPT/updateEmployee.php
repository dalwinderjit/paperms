            ...
            <div class="contentpanel">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        $apiError->set_error_delimiters('<div class="text-danger">', '</div>');
                        /*----End Form Validation----*/
                                ...
                                <div class="tab-content" style="border:1px solid #d8dbde;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            echo $apiError->showError('category');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            echo $apiError->showError('c1_cert');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            echo $apiError->showError('c2_cert');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            echo $apiError->showError('c3_cert');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            echo $apiError->showError('roll_number');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            echo $apiError->showError('dateofenlistment');
                                            ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            echo $apiError->showError('battalion_dis_code');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            echo $apiError->showError('Deputation');
                                            ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            echo $apiError->showError('maritialstatus');
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            echo $apiError->showError('rtc_pass');
                                        ...
                                        <div class="col-sm-9">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $sno = 1;
                                                    foreach ($bad_entries as $k => $bad_entry) {
                                                        if($bad_entry->deleted==0){
                                                            $deleted = '<span class="success">Available</span>';
                                                        }else{
                                                            $deleted = '<span class="error">Deleted</span>';
                                                        }
                                                        echo "
                                                            <tr>
                                                                <td>{$sno}</td>
                                                                <td>{$bad_entry->title}</td>
                                                                <td>{$bad_entry->entry_date}</td>
                                                                <td>{$deleted}</td>
                                                                <td><span onclick='toggleBadEntryRow($k)' class='fa fa-edit'></span></td>
                                                            </tr>
                                                        ";
                                                        echo "<tr id='bad_entry_row_{$k}' style='display:none;'><td colspan='4'>";
                                                        //var_dump($bad_entry);
                                                        echo form_label("Bad Entry Text");
                                                        $title[$k] = array('type' => 'text', 'name' => "title[{$k}]", 'id' => "title_{$k}", 'class' => 'form-control', 'placeholder' => 'Enter Bad Entry', 'value' => set_value("title[{$k}]",$bad_entry->title));
                                                        echo form_input($title[$k]);
                                                        echo form_error("title_[{$k}]");
                                                        $id[$k] = array('type' => 'hidden', 'name' => "Id[{$k}]", 'id' => "Id_{$k}", 'value' => set_value("Id_[{$k}]",$bad_entry->Id));
                                                        echo form_input($id[$k]);
                                                        echo form_label("Bad Entry Date");
                                                        $entry_date[$k] = array('type' => 'text', 'name' => "entry_date[{$k}]", 'id' => "entry_date_{$k}",'class'=>'form-control', 'value' => set_value("entry_date_[{$k}]",$bad_entry->entry_date));
                                                        echo form_input($entry_date[$k]);
                                                        echo form_label("Delete");
                                                        $deleted = array('' => '--Select--',  '0' => 'Available', '1' => 'DELETED');
                                                        /*newarea Textfield*/
                                                        echo form_dropdown("deleted[{$k}]", $deleted, set_value("deleted[{$k}]", $bad_entry->deleted), "id='deleted_{$k}' data-placeholder='Set Status' title='Please select at least 1 value' class='select2'");
                                                        echo form_error("deleted[{$k}]");
                                                        echo '</td></tr>';
                                                        $sno++;
                                                    }
                                                    $k = $sno-1;
                                                    echo '<div>';
                                                        //var_dump($bad_entry);
                                                    echo form_label("New Bad Entry Text");
                                                    $title[$k] = array('type' => 'text', 'name' => "title[{$k}]", 'id' => "title_{$k}", 'class' => 'form-control', 'placeholder' => 'Enter Bad Entry', 'value' => set_value("title[{$k}]"));
                                                    echo form_input($title[$k]);
                                                    echo form_error("title_[{$k}]");
                                                    echo form_label("Bad Entry Date {$sno}");
                                                    $entry_date[$k] = array('type' => 'text', 'name' => "entry_date[{$k}]", 'id' => "entry_date_{$k}",'class'=>'form-control', 'value' => set_value("entry_date_[{$k}]"));
                                                    echo form_input($entry_date[$k]);
                                                    echo form_error("entry_date_[{$k}]");
                                                    echo '</div>';
                                                    ?>
                                                </tbody>
                                            </table>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            echo $apiError->showError('remarks1');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            echo $apiError->showError('remarks2');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <?php
                                            $PRO_CHK = array('' => '--Select--',  '1' => 'YES', '0' => 'NO');
                                            /*newarea Textfield*/
                                            ...
                                            echo $apiError->showError('PRO_CHK');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <?php
                                            $NDL_CHK = array('' => '--Select--',  '1' => 'YES', '0' => 'NO');
                                            /*newarea Textfield*/
                                            ...
                                            echo $apiError->showError('NDL_CHK');
                                            ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <img src="<?php echo API_PUBLIC_URL; ?>profile_pic/<?php echo $employee->profile_pic; ?>" class="profile_pic" height="300" />
                                            <input type="file" name="profile_pic" />
                                            <?php echo $apiError->showError('profile_pic'); ?>
                                        </div>
                                    </div>
                                    <!--div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            echo $apiError->showError('phone1');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            echo $apiError->showError('phone2');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            echo $apiError->showError('bloodgroup');
                                            ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            echo $apiError->showError('Identificationmark');
                                            ?>
