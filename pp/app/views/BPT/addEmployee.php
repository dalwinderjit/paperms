                            ...
                            <div class="panel-body">
                                <div class="tab-content" style="border:1px solid #d8dbde;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <?php
                                            $rcnum = array('type' => 'text', 'name' => 'selectedEmployees', 'id' => 'selectedEmployees', 'class' => '', 'placeholder' => 'Dept No.', 'value' => set_value('selectedEmployees'));
                                            echo form_input($rcnum);
                                            /*newarea Textfield*/
                                            echo form_error('selectedEmployees');
                                            /*----End newarea Textfield----*/
                                            ?>
                                ...
                                <div class="tab-content" style="border:1px solid #d8dbde; display:none;">
                                    <div class="form-group">
