	...
	<div class="panel-heading">
		<div class="row">
			<div class="col-md-3">
				...
				<?php  
                                    echo form_dropdown('battalions[]', $battalions, set_value('battalions'),'id="battalions" data-placeholder="Select Battalions" title="Please select at least 1 value" class="select2" required multiple'); 
