...
<div class="row">
        <div class="col-md-12">
          <?php if($updateNewEmployee==true){ ?>
          <div class="alert alert-danger alert-dismissible" id="warning" role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <strong>Warning!</strong> This is a new employee. Please udpate the employees belt no!
            <br/>
            <input type="checkbox" id="newEmployeeInfoUpdated"/> <label for="newEmployeeInfoUpdated">Tick this checkbox, udpate the new details, and click Submit Button</label>
          </div>
          <?php } ?>
          ...
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <ul class="nav nav-tabs nav-justified mynavbar" id="scroll">
                  <li class="<?php if($page=='personal_detail'){echo 'active';} ?> anchor" onClick="setPage('personal_detail');"><a data-toggle="tab" href="#one" onClick="setPage('personal_detail');"><strong>Personal Detail</strong><?php echo (isset($pageErrorCounter))?getBadge('personal_detail',$pageErrorCounter):'';?></a></li>
                  <li class="<?php if($page=='address'){echo 'active';} ?> anchor" onClick="setPage('address');"><a data-toggle="tab" href="#two"><strong>Address</strong><?php echo (isset($pageErrorCounter))?getBadge('address',$pageErrorCounter):'';?></a></li>
		              <li class="<?php if($page=='education_detail'){echo 'active';} ?> anchor" onClick="setPage('education_detail');"><a data-toggle="tab" href="#three"><strong>Educational Details</strong><?php echo (isset($pageErrorCounter))?getBadge('education_detail',$pageErrorCounter):'';?></a></li>
                  <li class="<?php if($page=='enlistment_detail'){echo 'active';} ?> anchor" onClick="setPage('enlistment_detail');"><a data-toggle="tab" href="#four"><strong>Enlistment Details</strong><?php echo (isset($pageErrorCounter))?getBadge('enlistment_detail',$pageErrorCounter):'';?></a></li>
                	<li class="<?php if($page=='present_service_detail'){echo 'active';} ?> anchor" onClick="setPage('present_service_detail');"><a data-toggle="tab" href="#five"><strong>Present Service Details</strong><?php echo (isset($pageErrorCounter))?getBadge('present_service_detail',$pageErrorCounter):'';?></a></li>
                  <li class="<?php if($page=='basic_training_course_detail'){echo 'active';} ?> anchor"  onClick="setPage('basic_training_course_detail');"><a data-toggle="tab" href="#six"><strong>Basic Training Course</strong><?php echo (isset($pageErrorCounter))?getBadge('basic_training_course_detail',$pageErrorCounter):'';?></a></li>
              		<li class="<?php if($page=='professional_course_detail'){echo 'active';} ?> anchor" onClick="setPage('professional_course_detail');"><a data-toggle="tab" href="#seven"><strong>Professional Course Details</strong><?php echo (isset($pageErrorCounter))?getBadge('professional_course_detail',$pageErrorCounter):'';?></a></li>
                  <li class="<?php if($page=='annual_firing_practice'){echo 'active';} ?> anchor"  onClick="setPage('annual_firing_practice');"><a data-toggle="tab" href="#eight"><strong>Annual Firing Practice</strong><?php echo (isset($pageErrorCounter))?getBadge('annual_firing_practice',$pageErrorCounter):'';?></a></li>
                  <?php if(false){ ?>
                ...
                <div class="tab-content">
			            <input type="hidden" name="page_name" id="page_name" value="<?php echo $selected_page; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="hidden" id="newDetailUpdated" name="newDetailUpdated" value="0"/>
                      <?php
...
/*----End newarea Textfield----*/
 ?>
                ...
                <div class="form-group">
                 <label class="col-sm-3 control-label">Date of birth (DD/MM/YYYY)(<span class="mandatory red">*</span>)</label>
                  <div class="col-sm-9">
...
?>
                ...
                <h4 class="page-header">Physical Details</h4>
                  ...
                  <div class="col-sm-9">
<?php
$bloodgps = [''=>'--Select blood group--'];
foreach($bloodgroups as $k=>$v){
	$bloodgps[$k] = $v;
}

/*newarea Textfield*/
 echo form_dropdown('bloodgroup', $bloodgps, set_value('bloodgroup',$body->bloodgroup),'id="bloodgroup" data-placeholder="Choose One" class="select2"'); 
...
?></div>
          ...
          <div id="two" class="tab-pane <?php if($page=='address'){echo 'active';} ?>">
			...
			<div class="form-group">
                  ...
                  <div class="col-sm-9">
<?php
$hno = array('type' => 'text','name' => 'hno','id' => 'hno','class' => 'form-control','placeholder' =>'House No.','value' => set_value('hno',$body->houseno));
echo form_input($hno);
echo form_error('hno');
?>
                  ...
                  <div class="col-sm-9">
<?php
$sno = array('type' => 'text','name' => 'sno','id' => 'sno','class' => 'form-control','placeholder' =>'Street No.','value' =>	set_value('sno',$body->streetno));
echo form_input($sno);
echo form_error('sno');
?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
<?php
$vm = array('type' => 'text','name' => 'vm','id' => 'vm','class' => 'form-control','placeholder' =>'Village/Mohalla','value' => set_value('vm',$body->villmohala));
echo form_input($vm);
echo form_error('vm');
?>
...
?>
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label">Post (<span class="mandatory red">*</span>)</label>   
                  <div class="col-sm-9">
<?php
$po = array('type' => 'text','name' => 'po','id' => 'po','class' => 'form-control','placeholder' =>'Post Office','value' => set_value('po',$body->postoffice));
echo form_input($po);
echo form_error('po');
?>
                  ...
                  <div class="col-sm-9">
<?php
$ps = array('type' => 'text','name' => 'ps','id' => 'ps','class' => 'form-control','placeholder' =>'Police Station','value' => set_value('ps',$body->policestation));
echo form_input($ps);
echo form_error('ps');
?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
<?php
$tl = array('type' => 'text','name' => 'tl','id' => 'tl','class' => 'form-control','placeholder' =>'Tehsil','value' => set_value('tl',$body->teshil));
echo form_input($tl);
echo form_error('tl');
?>
...
/*newarea Textfield*/
 echo form_dropdown('dis', $city, set_value('dis',$body->district),'id="dis" data-placeholder="Choose One" title="Please select at least 1 area" class="select2"'); 
 echo form_error('dis');
/*----End newarea Textfield----*/
 ?>
             ...
             <h4 class="page-header"> Present Address</h4>
                ...
                <div class="form-group" id="pfpart1">
                  ...
                  <div class="col-sm-9">
<?php
$phouseno = array('type' => 'text','name' => 'phouseno','id' => 'phouseno','class' => 'form-control','placeholder' =>'House No.','value' => set_value('phouseno',$body->phouse));
...
?>
                ...
                <div class="form-group" id="pfpart2">
                  ...
                  <div class="col-sm-9">
<?php
$pstreetno = array('type' => 'text','name' => 'pstreetno','id' => 'pstreetno','class' => 'form-control','placeholder' =>'Street No.','value' => set_value('pstreetno',$body->pstreet));
...
?>
                ...
                <div class="form-group" id="pfpart3">
                  ...
                  <div class="col-sm-9">
<?php
$pvillmoh = array('type' => 'text','name' => 'pvillmoh','id' => 'pvillmoh','class' => 'form-control','placeholder' =>'Village/Mohalla','value' => set_value('pvillmoh',$body->pvillmohala));
...
?>
                  ...
                  <div class="col-sm-9">
<?php
$ppolicestation = array('type' => 'text','name' => 'ppolicestation','id' => 'ppolicestation','class' => 'form-control','placeholder' =>'Police Station','value' => set_value('ppolicestation',$body->ppolicestation));
...
?>
                  ...
                  <div class="col-sm-9">
<?php
$ptehsil = array('type' => 'text','name' => 'ptehsil','id' => 'ptehsil','class' => 'form-control','placeholder' =>'Tehsil','value' => set_value('ptehsil',$body->ptehsil));
...
/*----End newarea Textfield----*/
 ...
 ?>
                 <?php  
/*newarea Textfield*/
 echo form_dropdown('pdistrict', $pcity, set_value('pdistrict',$body->pdistrict),'id="pdistrict" data-placeholder="Choose One" title="Please select at least 1 area" class="select2"'); 
...
/*----End newarea Textfield----*/
 ?>
                 ...
                 <div class="form-group"  id="docOther1" style="display:none;">
                  ...
                  <div class="col-sm-9">
<?php
$docOther = array('type' => 'text','name' => 'docOther','id' => 'docOther','class' => 'form-control','placeholder' =>'Other','value' => set_value('docOther',$body->Doctorateother));
...
$InductionModeim = array('' => '--Select--', 'Yes' => 'Yes', 'No' => 'No');
 echo form_dropdown('clit', $InductionModeim, set_value('clit',$body->comlit),'id="clit" data-placeholder="Choose One" class="select2" '); 
...
/*----End newarea Textfield----*/
 ?>
                  ...
                  <div class="form-group">
                  <label class="col-sm-3 control-label">Mode of Enlistment(<span class="mandatory red">*</span>)</label>
                  <div class="col-sm-9">
                 <?php  
...
?>
                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                ...
                                <div class="form-group">
                  <label class="col-sm-3 control-label">Enlistment of Rank(<span class="mandatory red">*</span>)</label>
                  <div class="col-sm-9">
            <?php  
$eor = array('' => '--Select--', 'Executive Staff' => 'Executive Staff', 'Ministerial Staff' => 'Ministerial Staff', 'Medical Staff' => 'Medical Staff', 'Class-IV (P)' => 'Class-IV (P)', 'Class-IV (C)' => 'Class-IV (C)');
 ...
 ?>
                ...
                <div class="form-group" id="eors1">
                  <label class="col-sm-3 control-label">Rank(<span class="mandatory red">*</span>)</label>
                  <div class="col-sm-9">
            <?php  
//$eor1 = array('' => '--Select--', 'CT' => 'CT','HC' => 'HC', 'ASI' => 'ASI', 'SI' => 'SI', 'INSP' => 'INSP', 'DSP' =>'DSP', 'SP' => 'SP', 'Asst. Commandant' =>'Asst. Commandant');
 ...
 ?>
                ...
                <?php } ?>
                 ...
                 <div class="form-group" id="eors2">
                  ...
                  <div class="col-sm-9">
            <?php  
$eor2 = array('' => '--Select--')+osi_getMinisterialRanks();//, 'Senior Asstt.' => 'Senior Asstt.', 'Junior Asstt.' => 'Junior Asstt.', 'Clerk' => 'Clerk', 'Peon' => 'Peon', 'Daftari' => 'Daftari','Supdt Grade-I' => 'Supdt Grade-I','SubSupdt Grade-II' => 'Supdt Grade-II');
 ...
 ?>
                ...
                <?php }else{ ?>
                  ...
                  <div class="col-sm-9">
            <?php  
$eor2 = array('' => '--Select--')+osi_getMinisterialRanks();//, 'Senior Asstt.' => 'Senior Asstt.', 'Junior Asstt.' => 'Junior Asstt.','Senior Scale Stenographer' => 'Senior Scale Stenographer','Junior Scale Stenographer' => 'Junior Scale Stenographer','Clerk' => 'Clerk', 'Peon' => 'Peon', 'Daftari' => 'Daftari','Supdt Grade-I' => 'Supdt Grade-I','SubSupdt Grade-II' => 'Supdt Grade-II');
 echo form_dropdown('eor2', $eor2, set_value('eor2',$body->eminirank),'id="eor2" data-placeholder="Choose One" class="select2"'); 
 echo form_error('eor2');
 ?>
                    <label for="eor2" class="error"></label>
                ...
                <?php if($body->rankofenlistment == 'Medical Staff'){ ?>
                 <div class="form-group" id="eors3">
                  <label class="col-sm-3 control-label">Nature of duty(<span class="mandatory red">*</span>)</label>
                  <div class="col-sm-9">
            <?php  
...
$eor3 = array('' => '--Select--')+osi_getMedicalRanks();//, 'Doctor' => 'Doctor', 'Pharmacist' => 'Pharmacist', 'Physiotherapist' => 'Physiotherapist', 'Lab Technician' => 'Lab Technician', 'Nursing Asstt.' => 'Nursing Asstt.');
 ...
 ?>
                ...
                <div class="form-group" id="eors4">
                  <label class="col-sm-3 control-label">Trade(<span class="mandatory red">*</span>)</label>
                  <div class="col-sm-9">
            <?php  
$eor4 = array('' => '--Select--')+osi_getCLASS_IV_P_Ranks();//, 'Cook' => 'Cook', 'Water Carrier' => 'Water Carrier', 'Sweeper' => 'Sweeper', 'Dhobi' => 'Dhobi', 'Mochi' => 'Mochi', 'Barber' => 'Barber', 'Tailor' => 'Tailor', 'Carpenter' => 'Carpenter','Mason' => 'Mason','Mali' => 'Mali', 'Electrician' => 'Electrician', 'Painter' => 'Painter','Plumber'=>'Plumber');
...
$eor4 = array('' => '--Select--')+osi_getCLASS_IV_P_Ranks();//, 'Cook' => 'Cook', 'Water Carrier' => 'Water Carrier', 'Sweeper' => 'Sweeper', 'Dhobi' => 'Dhobi', 'Mochi' => 'Mochi', 'Barber' => 'Barber', 'Tailor' => 'Tailor', 'Carpenter' => 'Carpenter','Mason' => 'Mason','Mali' => 'Mali', 'Electrician' => 'Electrician', 'Painter' => 'Painter','Plumber'=>'Plumber');
 ...
 ?>
                ...
                <?php if($body->rankofenlistment == 'Class-IV (C)'){ ?>
                  ...
                  <div class="col-sm-9">
            <?php  
$eor5 = array('' => '--Select--')+osi_getCLASS_IV_C_Ranks();//, 'Cook' => 'Cook', 'Water Carrier' => 'Water Carrier', 'Sweeper' => 'Sweeper', 'Dhobi' => 'Dhobi', 'Mochi' => 'Mochi', 'Barber' => 'Barber', 'Tailor' => 'Tailor', 'Carpenter' => 'Carpenter','Mason' => 'Mason','Mali' => 'Mali', 'Electrician' => 'Electrician', 'Painter' => 'Painter');
...
$eor5 = array('' => '--Select--')+osi_getCLASS_IV_C_Ranks();//, 'Cook' => 'Cook', 'Water Carrier' => 'Water Carrier', 'Sweeper' => 'Sweeper', 'Dhobi' => 'Dhobi', 'Mochi' => 'Mochi', 'Barber' => 'Barber', 'Tailor' => 'Tailor', 'Carpenter' => 'Carpenter','Mason' => 'Mason','Mali' => 'Mali', 'Electrician' => 'Electrician', 'Painter' => 'Painter');
 ...
 ?>
                ...
                <?php } ?>
                  ...
                  <div class="form-group">
                  <label class="col-sm-3 control-label">Enlistment Category(<span class="mandatory red">*</span>)</label>
                  <div class="col-sm-9">
                 <?php  
...
?>
              ...
              ?>
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label">Date of Retirement(dd/mm/yyyy)</label>
                  <div class="col-sm-9">
                  <div class="input-group">
<?php
$DateofRetirementdor = array('type' => 'text','name' => 'DateofRetirementdor','id' => 'DateofRetirementdor','class' => 'form-control','placeholder' =>'Date of Retirement (DD/MM/YYYY)','value' =>set_value('DateofRetirementdor',$body->dateofretirment));
...
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label">Extension Retirement Date(dd/mm/yyyy)</label>
                  <div class="col-sm-9">
                  <div class="input-group">
<?php
$DateofRetirementdor = array('type' => 'text','name' => 'DateofRetirementdori','id' => 'eDateofRetirementdor','class' => 'form-control','placeholder' =>'
Extension Retirement Date (DD/MM/YYYY)','value' => set_value('DateofRetirementdori',$body->dateofretirment2));
echo form_input($DateofRetirementdor);
...
?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
<?php
$hrms_code = array('type' => 'text','name' => 'hrms_code','id' => 'hrms_code','class' => 'form-control','placeholder' =>'HRMS Code','value' => set_value('hrms_code',$body->hrms_code));
...
?>
			...
			<?php  
                /*newarea Textfield*/
                echo form_dropdown('bunitdistrict', $districts, set_value('bunitdistrict',$body->bunitdistrict),'id="state" data-placeholder="Choose One" title="Please select at least 1 area" class="select2"'); 
                echo form_error('state');
                /*----End newarea Textfield----*/
			?>
                  <label for="gpfPRAN" class="error"></label>
...
$RankRankre = array('' => '--Select--')+get_present_ranks();//, 'CT' => 'CT', 'Sr.Const' => 'Sr.Const', 'C-II' => 'C-II', 'HC/PR' => 'HC/PR', 'HC' => 'HC', 'ASI/LR' => 'ASI/LR','ASI/CR' => 'ASI/CR',  'ASI' => 'ASI','ASI/ORP' => 'ASI/ORP',  'SI/CR' => 'SI/CR','SI/LR' => 'SI/LR', 'SI' => 'SI', 'INSP/CR' => 'INSP/CR','INSP/LR' => 'INSP/LR', 'INSP' => 'INSP', 'DSP/CR' =>'DSP/CR','DSP' =>'DSP','HC/LR' => 'HC/LR','HC/CR' => 'HC/CR','AIG' => 'AIG', 'SP/CR' => 'SP/CR', 'SP' => 'SP','Asst. Commandant' =>'Asst. Commandant','Commandant' => 'Commandant','DIG'=>'DIG', 'IG'=>'IG',  'ADGP'=>"ADGP",'DGP'=>'DGP');
 ...
 ?>
				 ...
				 <div class="form-group" id="permanentRank">
                  <label class="col-sm-3 control-label">Permanent Rank(<span class="mandatory red">*</span>)</label>
                  <div class="col-sm-9">
            <?php  
			
$permanent_ranks = array('' => '--Select--')+get_permanent_ranks();//, 'CT' => 'CT', 'Sr.Const' => 'Sr. Const', 'C-II' => 'C-II', 'HC/PR' => 'HC/PR', 'HC' => 'HC', 'ASI/LR' => 'ASI/LR','ASI/CR' => 'ASI/CR',  'ASI' => 'ASI','ASI/ORP' => 'ASI/ORP',  'SI/CR' => 'SI/CR','SI/LR' => 'SI/LR', 'SI' => 'SI', 'INSP/CR' => 'INSP/CR','INSP/LR' => 'INSP/LR', 'INSP' => 'INSP', 'DSP/CR' =>'DSP/CR','DSP' =>'DSP','HC/LR' => 'HC/LR','HC/CR' => 'HC/CR','AIG' => 'AIG', 'SP/CR' => 'SP/CR', 'SP' => 'SP','Asst. Commandant' =>'Asst. Commandant','Commandant' => 'Commandant','DIG'=>'DIG', 'IG'=>'IG',  'ADGP'=>"ADGP",'DGP'=>'DGP');
 echo form_dropdown('permanent_rank', $permanent_ranks, set_value('permanent_rank',$body->permanent_rank),'id="permanent_rank" data-placeholder="Choose One" class="select2"'); 
 ...
 ?>
                ...
                <?php } ?>
                 ...
                 <div class="form-group" id="MinisterialStaff1">
                  ...
                  <div class="col-sm-9">
            <?php  
$Ministerial = array('' => '--Select--')+osi_getMinisterialRanks();//,  'Senior Asstt.' => 'Senior Asstt.', 'Junior Asstt.' => 'Junior Asstt.', 'Clerk' => 'Clerk','Steno' => 'Steno', 'Peon' => 'Peon', 'Daftari' => 'Daftari','Supdt Grade-I' => 'Supdt Grade-I','SubSupdt Grade-II' => 'Supdt Grade-II');
...
<div class="form-group" id="MinisterialStaff1" style="display: none;">
                  ...
                  <div class="col-sm-9">
            <?php  
$Ministerial = array('' => '--Select--')+osi_getMinisterialRanks();//, 'Senior Asstt.' => 'Senior Asstt.', 'Junior Asstt.' => 'Junior Asstt.', 'Clerk' => 'Clerk', 'Peon' => 'Peon', 'Daftari' => 'Daftari','Supdt Grade-I' => 'Supdt Grade-I','SubSupdt Grade-II' => 'Supdt Grade-II');
 echo form_dropdown('catop2', $Ministerial, set_value('catop2',$body->cminirank),'id="Ministerial" data-placeholder="Choose One" class="select2"'); 
 echo form_error('catop2');
 ?>
                    <label for="Ministerial" class="error"></label>
...
$Medical = array('' => '--Select--')+osi_getMedicalRanks();//, 'Doctor' => 'Doctor', 'Pharmacist' => 'Pharmacist', 'Physiotherapist' => 'Physiotherapist', 'Lab Technician' => 'Lab Technician', 'Nursing Asstt.' => 'Nursing Asstt.');
 ...
 ?>
                ...
                <div class="form-group" id="cl4" >
                  ...
                  <div class="col-sm-9">
            <?php  
$cf1 = array('' => '--Select--')+osi_getCLASS_IV_P_Ranks();//, 'Cook' => 'Cook', 'Water Carrier' => 'Water Carrier', 'Sweeper' => 'Sweeper', 'Dhobi' => 'Dhobi', 'Mochi' => 'Mochi', 'Barber' => 'Barber', 'Tailor' => 'Tailor', 'Carpenter' => 'Carpenter','Mason' => 'Mason','Mali' => 'Mali','Mechanic' => 'Mechanic', 'Electrician' => 'Electrician','Painter' => 'Painter','Syce' => 'Syce');
 ...
 ?>
                ...
                <div class="form-group" id="cl4" style="display: none;">
                  ...
                  <div class="col-sm-9">
            <?php  
$cf1 = array('' => '--Select--')+osi_getCLASS_IV_P_Ranks();//, 'Cook' => 'Cook', 'Water Carrier' => 'Water Carrier', 'Sweeper' => 'Sweeper', 'Dhobi' => 'Dhobi', 'Mochi' => 'Mochi', 'Barber' => 'Barber', 'Tailor' => 'Tailor', 'Carpenter' => 'Carpenter','Mason' => 'Mason','Mali' => 'Mali');
 ...
 ?>
                ...
                <?php if($body->presentrank == 'Class-IV (C)'){ ?>
                  ...
                  <div class="col-sm-9">
            <?php  
$cf2 = array('' => '--Select--')+osi_getCLASS_IV_C_Ranks();//, 'Cook' => 'Cook', 'Water Carrier' => 'Water Carrier', 'Sweeper' => 'Sweeper', 'Dhobi' => 'Dhobi', 'Mochi' => 'Mochi', 'Barber' => 'Barber', 'Tailor' => 'Tailor', 'Carpenter' => 'Carpenter','Mason' => 'Mason','Mali' => 'Mali');
 ...
 ?>
              ...
              <?php if($body->presentrank == 'Class-IV (P)' || $body->presentrank == 'Class-IV (C)'){ ?>
                ...
                <div class="form-group" id="cl6">
                  <label class="col-sm-3 control-label">Nature of Duty Not used</label>
                  <div class="col-sm-9">
<?php
...
?>
                    <label for="cnody" class="error"></label>
                  </div>
                </div>
...
$InductionModeim = array('' => '--Select--', 'Transfer' => 'Transfer', 'Transfer(Promotion)' => 'Transfer(Promotion)', 'Transfer(Excess)' => 'Transfer(Excess)', 'Attachment' => 'Attachment','Transfer Pay Purpose' => 'Transfer Pay Purpose','Since Enlistment' => 'Since Enlistment','Transfer (On regular)' => 'Transfer (On regular)','On deputation' => 'On deputation','Formal Order Not Issued' => 'Formal Order Not Issued','Not Reported' => 'Not Reported');
 ...
 ?>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
<?php
$indictiondate = array('type' => 'text','name' => 'indictiondate','id' => 'indictiondate','class' => 'form-control','placeholder' =>'Induction Date','value' => set_value('indictiondate',$body->inductiondate));
...
?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
<?php
$PreviousNoprn = array('type' => 'text','name' => 'PreviousNoprn','id' => 'PreviousNoprn','class' => 'form-control','placeholder' =>'Previous No.','value' => set_value('PreviousNoprn',$body->prebattno));
...
?>
          ...
          <div class="form-group">
                  <label class="col-sm-3 control-label">Good Entries1</label>
                  <div class="col-sm-9">
<?php
$PreviousNoprn = array('type' => 'text','name' => 'gd1','id' => 'gd1','class' => 'form-control','value' => set_value('gd1',$body->gd1));
echo form_input($PreviousNoprn);
echo form_error('PreviousNoprn');
?>
                    <label for="PreviousNoprn" class="error"></label>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
<?php
$PreviousNoprn = array('type' => 'text','name' => 'bd1','id' => 'bd1','class' => 'form-control','value' => set_value('bd1',$body->bd1));
echo form_input($PreviousNoprn);
echo form_error('PreviousNoprn');
?>
                    <label for="PreviousNoprn" class="error"></label>
                  ...
                  <div class="input-group">
<?php
$doppp = array('type' => 'text','name' => 'dateblockm1','id' => 'dateblockm11','class' => 'form-control','placeholder' =>'Placement as Junior Asst. Date','value' => set_value('dateblockm1',$body->dateblockm1));
...
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                ...
                <div class="form-group"  id="dateblockm2" style="display: none;">
                  ...
                  <div class="input-group">
<?php
$doppp = array('type' => 'text','name' => 'dateblockm2','id' => 'dateblockm12','class' => 'form-control','placeholder' =>'Promotion as Sr. Asst. Date','value' => set_value('dateblockm2',$body->dateblockm2));
echo form_input($doppp);
echo form_error('doppp');
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
</div>
                  ...
                  <div class="input-group">
<?php
$doppp = array('type' => 'text','name' => 'dateblockm3','id' => 'dateblockm13','class' => 'form-control','placeholder' =>'Promotion as Supdt Grade-I','value' => set_value('dateblockm3', $body->dateblockm3));
echo form_input($doppp);
echo form_error('doppp');
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
</div>
                ...
                <div class="form-group"  id="dateblockm4" style="display: none;">
                  ...
                  <div class="input-group">
<?php
$doppp = array('type' => 'text','name' => 'dateblockm4','id' => 'dateblockm14','class' => 'form-control','placeholder' =>'Promotion as Supdt Grade-II','value' => set_value('dateblockm4',$body->dateblockm4));
echo form_input($doppp);
echo form_error('doppp');
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
</div>
                ...
                <div class="form-group" id="exdateblock1">
                  ...
                  <div class="input-group">
<?php
$DateOFPromotionDetails21 = array('type' => 'text','name' => 'DateOFPromotionDetails21','id' => 'DateOFPromotionDetails21','class' => 'form-control','placeholder' =>'Date OF Promotion Details','value' => set_value('DateOFPromotionDetails21',$body->loweschoolcdate));
...
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                ...
                <div class="form-group" id="exdateblock2">
                  ...
                  <div class="input-group">
<?php
$DateOFPromotionDetails23 = array('type' => 'text','name' => 'DateOFPromotionDetails23','id' => 'DateOFPromotionDetails23','class' => 'form-control','placeholder' =>'Date OF Promotion Details','value' => set_value('DateOFPromotionDetails23',$body->doc1));
...
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                ...
                <div class="form-group"  id="exdateblock3">
                  ...
                  <div class="input-group">
<?php
$DateOFPromotionDetails24 = array('type' => 'text','name' => 'DateOFPromotionDetails24','id' => 'DateOFPromotionDetails24','class' => 'form-control','placeholder' =>'Date OF Promotion Details','value' => set_value('DateOFPromotionDetails24',$body->doc2));
...
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                ...
                <div class="form-group" id="exdateblock4">
                  ...
                  <div class="input-group">
<?php
$DateOFPromotionDetails25 = array('type' => 'text','name' => 'DateOFPromotionDetails25','id' => 'DateOFPromotionDetails25','class' => 'form-control','placeholder' =>'Date OF Promotion Details','value' =>set_value('DateOFPromotionDetails25',$body->dofhc));
...
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                ...
                <div class="form-group"  id="exdateblock5">
                  ...
                  <div class="input-group">
<?php
$DateOFPromotionDetails26 = array('type' => 'text','name' => 'DateOFPromotionDetails26','id' => 'DateOFPromotionDetails26','class' => 'form-control','placeholder' =>'Date OF Promotion Details','value' =>set_value('DateOFPromotionDetails26', $body->intermediatescor));
...
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                ...
                <div class="form-group"  id="exdateblock6">
                  ...
                  <div class="input-group">
<?php
$DateOFPromotionDetails27 = array('type' => 'text','name' => 'DateOFPromotionDetails27','id' => 'DateOFPromotionDetails27','class' => 'form-control','placeholder' =>'Date OF Promotion Details','value' => set_value('DateOFPromotionDetails27',$body->dofld));
...
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                ...
                <div class="form-group"  id="exdateblock7">
                  ...
                  <div class="input-group">
<?php
$DateOFPromotionDetails28 = array('type' => 'text','name' => 'DateOFPromotionDetails28','id' => 'DateOFPromotionDetails28','class' => 'form-control','placeholder' =>'Date OF Promotion Details','value' =>set_value('DateOFPromotionDetails28',$body->dofld2));
...
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                ...
                <div class="form-group"  id="exdateblock8">
                  ...
                  <div class="input-group">
<?php
$DateOFPromotionDetails29 = array('type' => 'text','name' => 'DateOFPromotionDetails29','id' => 'DateOFPromotionDetails29','class' => 'form-control','placeholder' =>'Date OF Promotion Details','value' => set_value('DateOFPromotionDetails29',$body->dateofoffasi));
...
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                ...
                <div class="form-group"  id="exdateblock9">
                  ...
                  <div class="input-group">
<?php
$DateOFPromotionDetails30 = array('type' => 'text','name' => 'DateOFPromotionDetails30','id' => 'DateOFPromotionDetails30','class' => 'form-control','placeholder' =>'Date OF Promotion Details','value' => set_value('DateOFPromotionDetails30',$body->upperschool));
...
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                ...
                <div class="form-group"  id="exdateblock10">
                  ...
                  <div class="input-group">
<?php
$DateOFPromotionDetails31 = array('type' => 'text','name' => 'DateOFPromotionDetails31','id' => 'DateOFPromotionDetails31','class' => 'form-control','placeholder' =>'Date OF Promotion Details','value' => set_value('DateOFPromotionDetails31',$body->dateofliste));
...
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                ...
                <div class="form-group"  id="exdateblock11">
                  ...
                  <div class="input-group">
<?php
$DateOFPromotionDetails32 = array('type' => 'text','name' => 'DateOFPromotionDetails32','id' => 'DateOFPromotionDetails32','class' => 'form-control','placeholder' =>'Date OF Promotion Details','value' => set_value('DateOFPromotionDetails32',$body->dateofliste2));
...
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                ...
                <div class="form-group"  id="exdateblock12">
                  ...
                  <div class="input-group">
<?php
$DateOFPromotionDetails33 = array('type' => 'text','name' => 'DateOFPromotionDetails33','id' => 'DateOFPromotionDetails33','class' => 'form-control','placeholder' =>'Date OF Promotion Details','value' => set_value('DateOFPromotionDetails33',$body->dateoffsi));
...
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                ...
                <div class="form-group"  id="exdateblock13">
                  ...
                  <div class="input-group">
<?php
$DateOFPromotionDetails34 = array('type' => 'text','name' => 'DateOFPromotionDetails34','id' => 'DateOFPromotionDetails34','class' => 'form-control','placeholder' =>'Date OF Promotion Details','value' => set_value('DateOFPromotionDetails34',$body->dateoflistf));
...
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
   ...
   <div class="form-group"  id="exdateblock14">
				  ...
				  <div class="input-group">
                  <?php
$LowerSchoolCourseDate35 = array('type' => 'text','name' => 'LowerSchoolCourseDate35','id' => 'LowerSchoolCourseDate35','class' => 'form-control','placeholder' =>'Date of offg. INSP','value' => set_value('LowerSchoolCourseDate35',$body->dateoflistf2));
...
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                ...
                <div class="form-group"  id="exdateblock15">
                  ...
                  <div class="input-group">
<?php
$DateOFPromotionDetails35 = array('type' => 'text','name' => 'DateOFPromotionDetails35','id' => 'DateOFPromotionDetails35','class' => 'form-control','placeholder' =>'Date OF Promotion Details','value' => set_value('DateOFPromotionDetails35',$body->dateofinsp));
...
?><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
		 ...
		 <span style="float:right;color:red;font-size:12px;">Please fill if information is available</span>
...
?>
		   ...
		   <?php if(false){ ?>
		  <span style="float:right;color:red;font-size:12px;">Under Maintenance.</span>
		  <input type="hidden" name="form_type" value="professional_course_detail">
		  
		  <div class="form-group" id="TrainingInstitutesstiOther1">
			<label class="col-sm-3 control-label">Update Professional Course Detail </label>
              <div class="col-sm-9">
		  ...
		  <?php 
			 $pdyesChecked = '';
				  $pdnoChecked = '';
				  //var_dump($address);
				  if(null!=$this->input->post('update_professional_course')){
					  if($this->input->post('update_professional_course')=='yes'){
						  $pdyesChecked = true;
					  }else{
						  $pdnoChecked = true;
					  }
			...
			echo form_radio(['name'=>'update_professional_course','id'=>'update_professional_course_yes'],'yes',$pdyesChecked);
			echo form_label('Yes','update_professional_course_yes');
			
			echo form_radio(['name'=>'update_professional_course','id'=>'update_professional_course_no'],'no',$pdnoChecked);
			echo form_label('No','update_professional_course_no');
			?>
				</div>
			</div>
           ...
           <?php $tma = array(); $tm = explode("@", $body->TrainingInstitutessti);
                ...
                <?php
				$tmOther = array(); $tmOther_ = explode("@", $body->TrainingInstitutesstiOther);
                  foreach ($tmOther_ as $key => $value){
                    $tmOther['tmOther'][] = $value;
                  }
				  
				$noca = array(); $noc = explode("@", $body->NamesofsCourses);
                ...
                foreach ($durco as $key => $value){
					...
					//echo validation_errors();
				if(null!=$this->input->post('TrainingInstitutessti') && count($this->input->post('TrainingInstitutessti'))>0){
					$tm = $tma['tm']    = $this->input->post('TrainingInstitutessti');
					$tmOther['tmOther']  = $this->input->post('TrainingInstitutesstiOther');
					$noca['noc']    = $this->input->post('NamesofsCourses');
					$docsa['docsa']  = $this->input->post('DurationsofsCourses');
					$durcoa['durcoa'] = $this->input->post('DurationsofsCoursest');
				}
                    ?>
...
?>
                 <div class="form-group" id="TrainingInstitutesstiOther1" style="display:<?php echo $display;?>;">
                  <label class="col-sm-3 control-label">Other</label>
                  <div class="col-sm-9">
<?php
$TrainingInstitutesstiOther = array('type' => 'text','name' => 'TrainingInstitutesstiOther[]','id' => 'TrainingInstitutesstiOther','class' => 'form-control','placeholder' =>'Other','value' => set_value("TrainingInstitutesstiOther[$i]",$tmOther['tmOther'][$i]));
...
?>
		   ...
		   <?php } ?>
			 <div class="row">
				...
				<div class="form-group">
					<div class="col-md-3">
						<?php echo form_label('Select Institute','apc_training_institute_add'); ?>
					</div>
					<div class="col-md-9">
						<?php
							//apc - > add Professional Course
							echo form_dropdown('apc_training_institute_add', $apc_training_institutes, set_value('apc_training_institute_add'),'id="apc_training_institute_add" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
							echo form_error('apc_training_institute_add');
						?>
						<label class="text-danger" id="apc_training_institute_add_error"></label>
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-3">
						<?php echo form_label('Select Course','apc_courses_add'); ?>
					</div>
					<div class="col-md-9">
						<?php
							//apc - > add Professional Course
							echo form_dropdown('apc_courses_add', $apc_courses, set_value('apc_courses_add'),'id="apc_courses_add" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
							echo form_error('apc_courses_add');
						?>
						<label class="text-danger" id="apc_courses_add_error"></label>
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-3">
						<?php echo form_label('Enter Course Order Number','apc_course_order_number_add'); ?>
					</div>
					<div class="col-md-9">
						<?php
							$apc_course_order_number_add = array('type' => 'text','name' => 'apc_course_order_number_add','id' => 'apc_course_order_number_add','class' => 'form-control','placeholder' =>'Course Order Number','value' => set_value('apc_course_order_number_add'));
							echo form_input($apc_course_order_number_add);
						?>
						<label class="text-danger" id="apc_course_order_number_add_error"></label>
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-3">
						<?php echo form_label('Enter Course Order Date','apc_course_order_date_add'); ?>
					</div>
					<div class="col-md-9">
						<?php
							$apc_course_order_date_add = array('type' => 'text','name' => 'apc_course_order_date_add','id' => 'apc_course_order_date_add','class' => 'form-control','placeholder' =>'Course Order Date','value' => set_value('apc_course_order_date_add'));
							echo form_input($apc_course_order_date_add);
						?>
						<label class="text-danger" id="apc_course_order_date_add_error"></label>
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-3">
						<?php echo form_label('Enter Course Start Date','apc_course_start_date_add'); ?>
					</div>
					<div class="col-md-9">
						<?php
							$apc_course_start_date_add = array('type' => 'text','name' => 'apc_course_start_date_add','id' => 'apc_course_start_date_add','class' => 'form-control','placeholder' =>'Course Start Date','value' => set_value('apc_course_start_date_add'));
							echo form_input($apc_course_start_date_add);
						?>
						<label class="text-danger" id="apc_course_start_date_add_error"></label>
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-3">
						<?php echo form_label('Enter Course End Date','apc_course_end_date_add'); ?>
					</div>
					<div class="col-md-9">
						<?php
							$apc_course_end_date_add = array('type' => 'text','name' => 'apc_course_end_date_add','id' => 'apc_course_end_date_add','class' => 'form-control','placeholder' =>'Course End Date','value' => set_value('apc_course_end_date_add'));
							echo form_input($apc_course_end_date_add);
						?>
						<label class="text-danger" id="apc_course_end_date_add_error"></label>
					</div>
				</div>			
				<div class="form-group">
					<div class="col-md-3">
					...
					<div class="col-md-9">
						<a class="btn btn-primary" onClick="add_professional_course();return false;">Submit</a>
			 ...
			 <hr>
			 <div class="form-group" id="TrainingInstitutesstiOther1">
				<label class="col-sm-3 control-label">Add Professional Courses To Employee</label>
				<div class="col-sm-9">
			 ...
			 <div class="row">
				...
				<?php
					//apc - > add Professional Course
					echo form_dropdown('apc_training_institute', $apc_training_institutes, set_value('apc_training_institute'),'id="apc_training_institute" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
				?>
				</div>
				<div class="col-md-3">
				...
				<?php
					//apc - > add Professional Course
					echo form_dropdown('apc_courses', $apc_courses, set_value('apc_courses'),'id="apc_courses" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
				?>
				</div>
				...
				<?php
					$order_no = array('type' => 'text','name' => 'order_no','id' => 'order_no','class' => 'form-control','placeholder' =>'Title of Course Detail','value' => set_value('order_no'));
			  ...
			  <div class="row">
					...
					<div class="col-md-3">
						<input type="checkbox" id="apc_date_from_input" name="apc_date_from_input"><label for="apc_date_from_input">Select Date From</label>
						<?php 
							$apc_from_date = array('type' => 'text','name' => 'apc_from_date','id' => 'apc_from_date','class' => 'form-control','placeholder' =>'From Date','value' => set_value('apc_from_date'));
							echo form_input($apc_from_date);
						?>
					</div>
					<div class="col-md-3">
						<label for="apc_date_from_input">Select Date To</label>
						<?php 
							$apc_to_date = array('type' => 'text','name' => 'apc_to_date','id' => 'apc_to_date','class' => 'form-control','placeholder' =>'To Date','value' => set_value('apc_to_date'));
							echo form_input($apc_to_date);
						?>
					</div>
					<div class="col-md-3">
						<input type="checkbox" id="apc_date_in_bn" name="apc_date_in_bn" class=""><label for="apc_date_in_bn">Select Date In b/n Start and End Date</label>
						<?php 
							$apc_date_in_bn_input = array('type' => 'text','name' => 'apc_date_in_bn_input','id' => 'apc_date_in_bn_input','class' => 'form-control','placeholder' =>'Select Date In b/n','value' => set_value('apc_date_in_bn_input'));
							echo form_input($apc_date_in_bn_input);
						?>
					</div>
					<div class="col-md-3">
						<label for="apc_date_from_input">Search </label><br>
						<button class="btn btn-primary" name="button" onClick="search();return false;" id="apc_date_from_input">Search</button>
						<?php 
							$apc_submit = array('type' => 'button','name' => 'apc_submit','id' => 'apc_submit','class' => 'form-control btn btn-primary','placeholder' =>'Search','value' => 'Search');
							//echo form_button($apc_submit);
						?>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-12">
					<table class="table"  id="course_data_table" style="width:100%">
					  <thead>
						 <tr>
							<th>S.No</th>
							<th>Training Institute Name</th>
							<th>Course Name</th>
							<th>Course Order Number</th>
...
jQuery(document).ready(function(){
  ...
  jQuery(".select2").select2({width:"100%"}),
    // Tags Input
	jQuery('#apc_from_date').datepicker({dateFormat: "dd/mm/yy"});
	jQuery('#apc_to_date').datepicker({dateFormat: "dd/mm/yy"});
	jQuery('#apc_date_in_bn_input').datepicker({dateFormat: "dd/mm/yy"});
...
jQuery('#LowerSchoolCourseDate35').datepicker({dateFormat: "dd/mm/yy"}); 
 jQuery('#datetimepicker1').datepicker({dateFormat: "dd/mm/yy"});
 jQuery('#apc_course_start_date_add').datepicker({dateFormat: "dd/mm/yy"});
 jQuery('#apc_course_end_date_add').datepicker({dateFormat: "dd/mm/yy"});
 jQuery('#apc_course_order_date_add').datepicker({dateFormat: "dd/mm/yy"});
...
$(document).ready(function(){
	courseDataTable = $('#course_data_table').DataTable({
		...
		"order":[],
		"ajax":{
			url:"<?php echo base_url(); ?>course/ajax-get-professional-course-history",
			type:"POST",
			"data":function(data){
				data.training_institute_id = $('#apc_training_institute').val();
				data.course_id = $('#apc_courses').val();
				data.title = $('#apc_title').val();
				data.order_no = $('#order_no').val();
				data.order_date = $('#apc_course_order_date').val();
				data.apc_from_date = $('#apc_from_date').val();
				data.apc_to_date = $('#apc_to_date').val();
				data.apc_date_in_bn_input = $('#apc_date_in_bn_input').val();
				data.apc_from_to = $('#apc_date_from_input').prop('checked');
				data.apc_in_bn = $('#apc_date_in_bn').prop('checked');
				data.selected_user_id = <?php echo $user_id; ?>;
			},
		},"columns": [
                    { "data": "sno"},
					{ "data": "institute_name"},
...
//--------------------------------------------------------------------------
var editCourse = ({});
editCourse.setDataToForm = function(){
	//var fields = ['apc_training_institute_edit','apc_courses_edit','apc_course_order_number_edit','apc_course_start_date_edit','apc_course_end_date_edit','apc_course_order_date_edit'];
	
	$('#apc_course_edit_id').val(this.id).trigger('change');
	$('#apc_training_institute_edit').val(this.training_institute_id).trigger('change');
	$('#apc_courses_edit').val(this.course_id).trigger('change');
	$('#apc_course_order_number_edit').val(this.order_no).trigger('change');
	$('#apc_course_order_date_edit').val(this.order_date).trigger('change');
	$('#apc_course_start_date_edit').val(this.course_start_date).trigger('change');
	$('#apc_course_end_date_edit').val(this.course_end_date).trigger('change');
}
editCourse.clear_errors = function(){
	var errors = ['apc_training_institute_edit_error','apc_courses_edit_error','apc_course_order_number_edit_error','apc_course_start_date_edit_error','apc_course_end_date_edit_error','apc_course_order_date_edit_error'];
	for(error in errors){
		$('#'+errors[error]).html('');
	}
}
editCourse.clear_fields = function(){
	var fields = ['apc_course_edit_id','apc_training_institute_edit','apc_courses_edit','apc_course_order_number_edit','apc_course_start_date_edit','apc_course_end_date_edit','apc_course_order_date_edit'];
	for(field in fields){
		$('#'+fields[field]).val('');
	}
	$('#apc_training_institute_edit').trigger('change');
	$('#apc_courses_edit').trigger('change');
}
function getCourseHistory(course_history_id){
	console.log(course_history_id);
	$.ajax({
		url:'<?php echo base_url();?>course/ajax-get-employees-course-by-id',
		method:"POST",
		data:{
		...
		success:function(response){
			...
			if(data.success==true){
				...
				editCourse.id = data.course.id;
				editCourse.course_id = data.course.course_id;
				editCourse.training_institute_id = data.course.training_institute_id;
				editCourse.employee_id = data.course.employee_id;
				editCourse.course_start_date = data.course.course_start_date;
				editCourse.course_end_date = data.course.course_end_date;
				editCourse.order_no = data.course.order_no;
				editCourse.order_date = data.course.order_date;
				editCourse.enabled = data.course.enabled;
				editCourse.deleted = data.course.deleted;
				editCourse.setDataToForm();
				$('#courseHistoryOfEmployee').modal('show');
			}else{
				alert(data.message);
			}
		}
...
editCourse.getFormData = function(){
	this.course_id = $('#apc_courses_edit').val();
	this.training_institute_id = $('#apc_training_institute_edit').val();
	this.order_no = $('#apc_course_order_number_edit').val();
	this.order_date = $('#apc_course_order_date_edit').val();
	this.course_start_date = $('#apc_course_start_date_edit').val();
	this.course_end_date = $('#apc_course_end_date_edit').val();
}
editCourse.updateCourseData = function(){
	editCourse.clear_errors();
	$.ajax({
		url:'<?php echo base_url();?>course/ajaxUpdateProfessionalCourseDetail',
		method:'POST',
		async:true,
		data:{
			id:editCourse.id,
			course_id:editCourse.course_id,
			training_institute_id:editCourse.training_institute_id,
			course_start_date:editCourse.course_start_date,
			course_end_date:editCourse.course_end_date,
			order_no:editCourse.order_no,
			order_date:editCourse.order_date,
		},
		success:function(response){
			//console.log(response);
			var data = JSON.parse(response);
			if(data.success==true){
				...
				$('#courseHistoryOfEmployee').modal('hide');
			}else{
...
function update_professional_course_detail(){
	editCourse.getFormData();
	editCourse.updateCourseData();
}
$(document).ready(function(){
	//getCourseHistory(12);
});
...
function addCourseToEmployee(course_detail_id,selected_user_id){ 
	
	$.ajax({
		url:'<?php echo base_url(); ?>/course-detail/ajax-add-course-to-employee',
		method:"POST",
		data:{
			course_detail_id : course_detail_id,
			selected_user_id : selected_user_id,
			order_no : $('#emp_order_no'+course_detail_id).val(),
		...
		success:function(response){
			...
			if(obj.success ==false){
				...
				if(obj.errors!=undefined){
					if(obj.errors['order_no']!=undefined){
						error = error+obj.errors['order_no'];
					}
				}
				$('#order_no'+course_detail_id).html(error);
			}else{
...
course_detail.setData = function(){
	$('#courseEmployeeCourseTitle').html(this.title);
	$('#courseEmployeeTrainingInstituteName').html(this.institute_name);
	$('#courseEmployeeCourseName').html(this.course_name);
	$('#courseEmployeeCourseOrderNo').html(this.order_no);
	$('#courseEmployeeCourseOrderDate').html(this.order_date);
	$('#courseEmployeeCourseStartDate').html(this.start_date);
	$('#courseEmployeeCourseEndDate').html(this.end_date);
	
}
course_detail.getData = function(){
	$.ajax({
		url:"<?php echo base_url(); ?>/course-detail/ajax-get-course-detail-by-id",
		method: "POST",
		data:{
			id:course_detail.course_detail_id
		},
		success:function(response){
			var data = JSON.parse(response);
			if(data.success==true){
				var obj = data.data;
				course_detail.title = obj.title;
				course_detail.start_date = obj.start_date;
				course_detail.end_date = obj.end_date;
				course_detail.order_no = obj.order_no;
				course_detail.order_date = obj.order_date;
				course_detail.course_name = obj.course_name;
				course_detail.institute_name = obj.institute_name;
				course_detail.setData();
			}else{
				course_detail.
				alert('Course Detail Do not Exist/Accessible');
			}
		}
	});
}
course_detail.addCourseToEmployee=function(){
	course_detail.employee_order_number = $('#course_detail_order_no').val();
	course_detail.employee_order_date = $('#course_detail_order_date').val();
	$.ajax({
		url:"<?php echo base_url(); ?>/course-detail/ajax-add-course-to-employee",
		method: "POST",
		data:{
			course_detail_id:course_detail.course_detail_id,
			order_number:course_detail.employee_order_number,
			order_date:course_detail.employee_order_date,
			employee_id:<?php echo $user_id; ?>,
		},
		success:function(response){
			var data = JSON.parse(response);
			if(data.success==true){
				//alert(data.message);
				$('#addCourseToEmployeeDialog').modal('hide');
				courseDataTable.draw();
			}else{
				for(error in data.errors){
					//alert(error+' '+data.errors[error]);
					$('#'+error+'_error').html(data.errors[error]);
				}
			}
		}
	});
}
course_detail.add_new_course_detail = function(){
	//course_detail.title = $('#apc_title_add').val();
	course_detail.training_institute_id = $('#apc_training_institute_add').val();
	course_detail.course_id = $('#apc_courses_add').val();
	course_detail.order_no = $('#apc_course_order_number_add').val();
	course_detail.course_order_date = $('#apc_course_order_date_add').val();
	course_detail.course_start_date = $('#apc_course_start_date_add').val();
	course_detail.course_end_date = $('#apc_course_end_date_add').val();
	this.clear_errors();
	$.ajax({
		url:"<?php echo base_url(); ?>/course-detail/ajax-add-course-to-employee",
		method: "POST",
		data:{
			...
			training_institute_id:course_detail.training_institute_id,
			course_id:course_detail.course_id,
			employee_id:<?php echo $user_id; ?>,
			order_no:course_detail.order_no,
			course_order_date:course_detail.course_order_date,
		...
		success:function(response){
			...
			var obj = JSON.parse(response);
			console.log(obj);
			//alert(obj.success+' '+obj.message);
			if(obj.success==true){
				courseDataTable.draw();
				course_detail.clear_fields();
				alert(obj.message);
			}else{
				if(obj.errors!=undefined){
					for(error in obj.errors){
						//alert(error);
						$('#'+error).html(obj.errors[error]);
					}
				}
			}
		}
...
course_detail.clear_errors = function(){
	var errors = ['apc_title_add_error','apc_training_institute_add_error','apc_courses_add_error','apc_course_order_number_add_error','apc_course_start_date_add_error','apc_course_end_date_add_error','apc_course_order_date_add_error'];
	for(error in errors){
		$('#'+errors[error]).html('');
	}
}
course_detail.clear_fields = function(){
	var fields = ['apc_title_add','apc_training_institute_add','apc_courses_add','apc_course_order_number_add','apc_course_start_date_add','apc_course_end_date_add','apc_course_order_date_add'];
	for(field in fields){
		$('#'+fields[field]).val('');
	}
	$('#apc_training_institute_add').trigger('change');
	$('#apc_courses_add').trigger('change');
}
function showAddCourseToEmployeeDialog(course_detail_id){
	//get the detail of course
	//set the detail on dialog box
	course_detail.course_detail_id = course_detail_id;
	course_detail.getData();
	$('#addCourseToEmployeeDialog').modal('show');
}
function add_professional_course(){
	//	alert('adding course');
	course_detail.add_new_course_detail();
	return false;
}
</script>
 
<script type="text/javascript">
$('#course_detail_order_date').datepicker({dateFormat: "dd/mm/yy"});
</script>
<div class="modal fade modal-posting" id="courseHistoryOfEmployee" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit Course History </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
	 
      <div class="modal-body" id="course_history">
		<div class="row">
				<h3>Update Professional Course</h3>
				<div class="form-group">
					<div class="col-md-3">
						<?php echo form_label('Select Institute','apc_training_institute_edit'); ?>
					</div>
					<div class="col-md-9">
						
						<?php
							//apc - > add Professional Course
							echo form_dropdown('apc_training_institute_edit', $apc_training_institutes, set_value('apc_training_institute_edit'),'id="apc_training_institute_edit" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
							echo form_error('apc_training_institute_edit');
						?>
						<label class="text-danger" id="apc_training_institute_edit_error"></label>
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-3">
					...
					<div class="col-md-9">
						<?php
							//apc - > add Professional Course
							echo form_dropdown('apc_courses_edit', $apc_courses, set_value('apc_courses_edit'),'id="apc_courses_edit" data-placeholder="Choose One" title="Please select at least 1 value" class="select2"'); 
							echo form_error('apc_courses_edit');
						?>
						<label class="text-danger" id="apc_courses_edit_error"></label>
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-3">
						<?php echo form_label('Enter Course Order Number','apc_course_order_number_edit'); ?>
					</div>
					<div class="col-md-9">
						<?php
							$apc_course_order_number_edit = array('type' => 'text','name' => 'apc_course_order_number_edit','id' => 'apc_course_order_number_edit','class' => 'form-control','placeholder' =>'Course Order Number','value' => set_value('apc_course_order_number_edit'));
							echo form_input($apc_course_order_number_edit);
						?>
						<label class="text-danger" id="apc_course_order_number_edit_error"></label>
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-3">
						<?php echo form_label('Enter Course Order Date','apc_course_order_date_edit'); ?>
					</div>
					<div class="col-md-9">
						<?php
							$apc_course_order_date_edit = array('type' => 'text','name' => 'apc_course_order_date_edit','id' => 'apc_course_order_date_edit','class' => 'form-control','placeholder' =>'Course Order Date','value' => set_value('apc_course_order_date_edit'));
							echo form_input($apc_course_order_date_edit);
						?>
						<label class="text-danger" id="apc_course_order_date_edit_error"></label>
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-3">
						<?php echo form_label('Enter Course Start Date','apc_course_start_date_edit'); ?>
					</div>
					<div class="col-md-9">
						<?php
							$apc_course_start_date_edit = array('type' => 'text','name' => 'apc_course_start_date_edit','id' => 'apc_course_start_date_edit','class' => 'form-control','placeholder' =>'Course Start Date','value' => set_value('apc_course_start_date_edit'));
							echo form_input($apc_course_start_date_edit);
						?>
						<label class="text-danger" id="apc_course_start_date_edit_error"></label>
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-3">
						<?php echo form_label('Enter Course End Date','apc_course_end_date_edit'); ?>
					</div>
					<div class="col-md-9">
						<?php
							$apc_course_end_date_edit = array('type' => 'text','name' => 'apc_course_end_date_edit','id' => 'apc_course_end_date_edit','class' => 'form-control','placeholder' =>'Course End Date','value' => set_value('apc_course_end_date_edit'));
							echo form_input($apc_course_end_date_edit);
						?>
						<label class="text-danger" id="apc_course_end_date_edit_error"></label>
					</div>
				</div>			
				<div class="form-group">
					<div class="col-md-3">
					...
					<div class="col-md-9">
						<a class="btn btn-primary" onClick="update_professional_course_detail();return false;">Update Course</a>
						<label class="text-danger" id="edit_course_id"></label>
					</div>
				</div>
			 </div>
...
<script type="text/javascript">
$('#course_detail_order_date').datepicker({dateFormat: "dd/mm/yy"});
$('#apc_course_start_date_edit').datepicker({dateFormat: "dd/mm/yy"});
$('#apc_course_end_date_edit').datepicker({dateFormat: "dd/mm/yy"});
$('#apc_course_order_date_edit').datepicker({dateFormat: "dd/mm/yy"});
$('#BattalionUnitito>option[value=92]').attr('disabled','disabled');
$('#BattalionUnitito>option[value=94]').attr('disabled','disabled');

$('#newEmployeeInfoUpdated').on('change',(e)=>{
  var checked_dalwinder = e.target.checked;
  if(checked_dalwinder===true){
    $('#newDetailUpdated').val(1);
  }else{
    $('#newDetailUpdated').val(0);
  }
})
</script>
</body>
