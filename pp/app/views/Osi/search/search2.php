              ...
              <div class="panel-heading">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      <?php
                      $rcnum = array('type' => 'text', 'name' => 'rcnum', 'id' => 'rcnum', 'class' => '', 'placeholder' => 'Dept No.', 'value' => set_value('rcnum'));
                ...
                <div class="row">
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <?php
                      /*newarea Textfield*/
                      echo form_dropdown('postate', $postate, set_value('postate'), 'id="postate" data-placeholder="Choose One" title="Please select at least 1 area" class="select2" multiple');
